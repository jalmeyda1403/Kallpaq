...
CREATE TABLE IF NOT EXISTS `acciones` (
  ...
  `accion_riesgo_id` bigint(20) unsigned DEFAULT NULL,
  `accion_hallazgo_id` bigint(20) unsigned DEFAULT NULL,
  `accion_obligacion_id` bigint(20) unsigned DEFAULT NULL,
  `accion_hallazgo_proceso_id` bigint(20) unsigned DEFAULT NULL,
  ...
  `accion_estado` enum('programada','reprogramada','desestimada','en proceso','implementada') DEFAULT NULL,
  `accion_es_control_permanente` tinyint(1) NOT NULL DEFAULT 0,
  `accion_ciclo` int(10) unsigned DEFAULT 1,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_acciones_hallazgos` (`accion_hallazgo_id`),
  KEY `FK_acciones_hallazgo_proceso` (`accion_hallazgo_proceso_id`) USING BTREE,
  KEY `acciones_accion_riesgo_id_foreign` (`accion_riesgo_id`),
  KEY `acciones_accion_obligacion_id_foreign` (`accion_obligacion_id`),
  CONSTRAINT `FK_acciones_hallazgo_proceso_id` FOREIGN KEY (`accion_hallazgo_proceso_id`) REFERENCES `hallazgo_proceso` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION,
  CONSTRAINT `FK_acciones_hallazgos` FOREIGN KEY (`accion_hallazgo_id`) REFERENCES `hallazgos` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION,
  CONSTRAINT `acciones_accion_hallazgo_id_foreign` FOREIGN KEY (`accion_hallazgo_id`) REFERENCES `hallazgos` (`id`) ON DELETE CASCADE,
  CONSTRAINT `acciones_accion_obligacion_id_foreign` FOREIGN KEY (`accion_obligacion_id`) REFERENCES `obligaciones` (`id`) ON DELETE CASCADE,
  CONSTRAINT `acciones_accion_riesgo_id_foreign` FOREIGN KEY (`accion_riesgo_id`) REFERENCES `riesgos` (`id`) ON DELETE CASCADE,
  CONSTRAINT `acciones_obligacion_id_foreign` FOREIGN KEY (`accion_obligacion_id`) REFERENCES `obligaciones` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Volcando datos para la tabla kallpaq.acciones: ~11 rows (aproximadamente)
REPLACE INTO `acciones` (`id`, `accion_riesgo_id`, `accion_hallazgo_id`, `accion_obligacion_id`, `accion_hallazgo_proceso_id`, `accion_cod`, `accion_tipo`, `accion_descripcion`, `accion_fecha_inicio`, `accion_fecha_fin_planificada`, `accion_fecha_fin_reprogramada`, `accion_fecha_cancelada`, `accion_fecha_fin_real`, `accion_justificacion`, `accion_responsable`, `accion_responsable_correo`, `accion_estado`, `accion_es_control_permanente`, `accion_ciclo`, `created_at`, `updated_at`) VALUES
	(1, NULL, 55, NULL, NULL, 'H-87920-001', 'corrección', 'Juan Almeyda', '2025-11-12', '2025-12-25', NULL, NULL, NULL, NULL, 'dasdsad', NULL, 'programada', 0, 1, '2025-11-12 21:45:26', '2026-01-19 06:54:22'),
	(3, NULL, 55, NULL, NULL, 'H-87920-002', 'acción correctiva', 'dsadsd', '2025-11-18', '2025-11-29', NULL, NULL, NULL, NULL, 'Juan Almeyda Requejo', NULL, 'programada', 0, 1, '2025-11-18 15:49:02', '2026-01-19 06:54:22'),
	(4, NULL, 55, NULL, NULL, 'H-87920-003', 'acción correctiva', 'Test Action Plan', '2025-11-21', '2025-11-22', NULL, NULL, NULL, NULL, 'Test User', NULL, 'programada', 0, 1, '2025-11-21 20:53:22', '2026-01-19 06:54:22'),
	(5, NULL, 55, NULL, NULL, 'H-87920-004', 'acción correctiva', 'dsadsad', '2025-11-21', '2025-11-29', NULL, NULL, NULL, NULL, 'dsadsad', NULL, 'programada', 0, 1, '2025-11-21 21:24:30', '2026-01-19 06:54:22'),
	(6, NULL, 55, NULL, NULL, 'H-87920-005', 'acción correctiva', 'Acción de prueba final', '2025-11-21', '2025-11-22', '2026-02-06', NULL, NULL, 'dsadsadasd prueba nueva', 'Usuario de Prueba', NULL, 'reprogramada', 0, 1, '2025-11-21 21:38:22', '2026-01-26 23:03:11'),
	(7, NULL, 56, NULL, 93, 'H-73160-001', 'corrección', 'ccsdd', '2026-01-26', '2026-02-26', NULL, NULL, NULL, NULL, 'dsadsad', 'dsdsad@dsadd.com', 'programada', 0, 3, '2026-01-26 15:53:06', '2026-01-26 15:53:06'),
	(8, 1, NULL, NULL, NULL, 'RA-1', NULL, 'DSADSADSADSADSDSDAS', '2025-12-01', '2025-12-19', '2025-12-31', NULL, '2025-12-04', 'RWERWER', 'dsadsad', 'dsadsad@dsasd.com', 'implementada', 0, 1, '2025-12-01 21:38:50', '2025-12-04 16:26:49'),
	(9, 1, NULL, NULL, NULL, 'RA-2', NULL, 'Nueva accion 2 (actualizado)', '2025-12-10', '2025-12-09', '2025-12-02', NULL, '2025-12-04', 'sasasas', 'juan almeyda', 'jalmeyda1403@gmail.com', 'implementada', 0, 1, '2025-12-02 16:48:58', '2025-12-04 16:30:34'),
	(10, 1, NULL, NULL, NULL, 'RA-3', NULL, 'Acciones 3', '2025-12-02', '2025-12-31', '2026-01-09', NULL, '2025-12-04', 'wsasaS', 'Juan Almeyda', 'jalmeyda1403@gmail.com', 'implementada', 0, 1, '2025-12-02 17:11:29', '2025-12-04 16:32:40'),
	(11, 32, NULL, NULL, NULL, 'RA-4', NULL, 'dsadsadsad', '2025-12-02', '2025-12-31', '2026-01-08', NULL, NULL, 'ddadsadsadads', 'adsdasdsad', 'jalmeyda1403@gmail.com', 'programada', 0, 1, '2025-12-02 21:33:50', '2025-12-02 21:35:09'),
	(12, 1, NULL, NULL, NULL, 'RA-5', NULL, 'Riesgo nuevo', '2025-12-03', '2025-12-25', NULL, NULL, NULL, NULL, 'dsadad', 'jalmeyda1403@gmail.com', 'desestimada', 0, 1, '2025-12-02 22:43:22', '2025-12-04 16:56:44');

-- Volcando estructura para tabla kallpaq.accion_avances
CREATE TABLE IF NOT EXISTS `accion_avances` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `accion_id` bigint(20) unsigned NOT NULL,
  `accion_avance_porcentaje` int(11) NOT NULL DEFAULT 0,
  `accion_avance_comentario` text DEFAULT NULL,
  `accion_avance_estado` varchar(255) DEFAULT NULL,
  `accion_avance_evidencia` text DEFAULT NULL,
  `user_id` bigint(20) unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `accion_avances_accion_id_foreign` (`accion_id`),
  KEY `accion_avances_user_id_foreign` (`user_id`),
  CONSTRAINT `accion_avances_accion_id_foreign` FOREIGN KEY (`accion_id`) REFERENCES `acciones` (`id`) ON DELETE CASCADE,
  CONSTRAINT `accion_avances_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Volcando datos para la tabla kallpaq.accion_avances: ~6 rows (aproximadamente)
REPLACE INTO `accion_avances` (`id`, `accion_id`, `accion_avance_porcentaje`, `accion_avance_comentario`, `accion_avance_estado`, `accion_avance_evidencia`, `user_id`, `created_at`, `updated_at`) VALUES
	(3, 6, 10, 'sasASas', 'en proceso', NULL, 1, '2026-01-26 22:41:36', '2026-01-26 22:41:36'),
	(4, 6, 35, 'nuevo avance', 'en proceso', NULL, 1, '2026-01-26 22:43:10', '2026-01-26 22:43:10'),
	(5, 6, 45, 'dsadsad', 'en proceso', NULL, 1, '2026-01-26 22:46:01', '2026-01-26 22:46:01'),
	(6, 8, 100, 'cxzcxcxczxcvcvcxvcxvcvcxvcx', 'implementada', NULL, NULL, '2025-12-04 16:26:49', '2025-12-04 16:26:49'),
	(7, 9, 100, 'dsdsadsddaas', 'implementada', NULL, NULL, '2025-12-04 16:30:34', '2025-12-04 16:30:34'),
	(8, 10, 100, 'sasasssasasasassas', 'implementada', NULL, NULL, '2025-12-04 16:32:40', '2025-12-04 16:32:40');
...
-- Volcando datos para la tabla kallpaq.accion_movimientos: ~8 rows (aproximadamente)
REPLACE INTO `accion_movimientos` (`id`, `accion_id`, `user_id`, `estado`, `comentario`, `created_at`, `updated_at`) VALUES
	(1, 6, 1, 'programada', 'Solicitud de Reprogramación: Reprogramar debido a sasasas', '2026-01-26 19:49:42', '2026-01-26 19:49:42'),
	(2, 6, 1, 'reprogramada', 'Reprogramación aprobada. Nueva fecha: 27/01/2026', '2026-01-26 20:59:38', '2026-01-26 20:59:38'),
	(3, 6, 1, 'reprogramada', 'Reprogramación aprobada. Nueva fecha: 27/01/2026', '2026-01-26 21:04:27', '2026-01-26 21:04:27'),
	(4, 6, 1, 'en proceso', 'dsasadsad (10%)', '2026-01-26 22:21:50', '2026-01-26 22:21:50'),
	(5, 6, 1, 'en proceso', 'sasASas (0%)', '2026-01-26 22:41:36', '2026-01-26 22:41:36'),
	(6, 6, 1, 'en proceso', 'nuevo avance (35%)', '2026-01-26 22:43:10', '2026-01-26 22:43:10'),
	(7, 6, 1, 'en proceso', 'dsadsad (45%)', '2026-01-26 22:46:01', '2026-01-26 22:46:01'),
	(8, 6, 1, 'en proceso', 'Solicitud de Reprogramación: aaSs', '2026-01-26 23:01:21', '2026-01-26 23:01:21'),
	(9, 6, 1, 'reprogramada', 'Reprogramación aprobada. Nueva fecha: 06/02/2026', '2026-01-26 23:03:11', '2026-01-26 23:03:11');
...
CREATE TABLE IF NOT EXISTS `accion_reprogramaciones` (
  ...
  `ar_estado` enum('solicitado','aprobado','rechazado') DEFAULT 'solicitado',
...
-- Volcando datos para la tabla kallpaq.accion_reprogramaciones: ~5 rows (aproximadamente)
REPLACE INTO `accion_reprogramaciones` (`id`, `accion_id`, `ar_fecha_anterior`, `ar_fecha_nueva`, `ar_justificacion`, `ar_estado`, `ar_usuario_id`, `created_at`, `updated_at`) VALUES
	(1, 6, '2025-11-22', '2026-01-27', 'Reprogramar debido a sasasas', 'aprobado', 1, '2026-01-26 19:49:42', '2026-01-26 21:04:27'),
	(2, 6, '2026-01-27', '2026-02-06', 'aaSs', 'aprobado', 1, '2026-01-26 23:01:21', '2026-01-26 23:03:11'),
	(3, 9, '2025-12-09', '2025-12-02', 'sasasas', 'aprobado', 1, '2025-12-02 16:49:28', '2025-12-02 17:09:40'),
	(4, 10, '2025-12-31', '2026-01-09', 'wsasaS', 'aprobado', 1, '2025-12-02 17:12:06', '2025-12-02 17:12:26'),
	(5, 11, '2025-12-31', '2026-01-08', 'ddadsadsadads', 'aprobado', 1, '2025-12-02 21:34:17', '2025-12-02 21:35:09');
...
CREATE TABLE IF NOT EXISTS `auditoria_agenda` (
  ...
  `aea_requisito` longtext DEFAULT NULL,
  ...
  KEY `auditoria_agenda_observador_id_foreign` (`observador_id`),
  ...
  CONSTRAINT `auditoria_agenda_observador_id_foreign` FOREIGN KEY (`observador_id`) REFERENCES `auditores` (`id`) ON DELETE SET NULL,
...
-- Volcando datos para la tabla kallpaq.auditoria_agenda: ~6 rows (aproximadamente)
REPLACE INTO `auditoria_agenda` (`id`, `ae_id`, `proceso_id`, `aea_fecha`, `aea_hora_inicio`, `aea_hora_fin`, `aea_actividad`, `aea_tipo`, `estado`, `aea_archivo`, `aea_ouo`, `aea_auditado`, `aea_auditor`, `auditor_id`, `observador_id`, `aea_requisito`, `aea_lugar`, `created_at`, `updated_at`) VALUES
	(6, 1, NULL, '2026-01-16', '08:00:00', '09:00:00', 'Reunión de Apertura', 'apertura', 'Programada', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-01-16 23:34:55', '2026-02-10 21:15:10'),
	(7, 1, 5, '2026-01-16', '09:30:00', '17:30:00', 'GESTIÓN ESTRATÉGICA', 'ejecucion', 'En Curso', NULL, NULL, NULL, NULL, 1, 6, '[{"id":61,"norma_id":3,"numeral":"4.1"},{"id":62,"norma_id":3,"numeral":"4.2"},{"id":73,"norma_id":3,"numeral":"7.1"},{"id":2,"norma_id":1,"numeral":"4.2"},{"id":3,"norma_id":1,"numeral":"4.3"},{"id":4,"norma_id":1,"numeral":"4.4"},{"id":5,"norma_id":1,"numeral":"5.1"},{"id":6,"norma_id":1,"numeral":"5.2"},{"id":7,"norma_id":1,"numeral":"5.3"},{"id":8,"norma_id":1,"numeral":"6.1"},{"id":9,"norma_id":1,"numeral":"6.2"},{"id":10,"norma_id":1,"numeral":"6.3"},{"id":11,"norma_id":1,"numeral":"7.1"},{"id":12,"norma_id":1,"numeral":"7.2"},{"id":13,"norma_id":1,"numeral":"7.3"},{"id":14,"norma_id":1,"numeral":"7.4"},{"id":15,"norma_id":1,"numeral":"7.5"},{"id":16,"norma_id":1,"numeral":"8.1"},{"id":17,"norma_id":1,"numeral":"8.2"},{"id":18,"norma_id":1,"numeral":"8.3"},{"id":19,"norma_id":1,"numeral":"8.4"},{"id":20,"norma_id":1,"numeral":"8.5"},{"id":21,"norma_id":1,"numeral":"8.6"},{"id":22,"norma_id":1,"numeral":"8.7"},{"id":23,"norma_id":1,"numeral":"9.1"},{"id":24,"norma_id":1,"numeral":"9.2"},{"id":25,"norma_id":1,"numeral":"9.3"},{"id":26,"norma_id":1,"numeral":"10.1"},{"id":27,"norma_id":1,"numeral":"10.2"},{"id":28,"norma_id":1,"numeral":"10.3"},{"id":63,"norma_id":3,"numeral":"4.3"},{"id":64,"norma_id":3,"numeral":"4.4"},{"id":65,"norma_id":3,"numeral":"4.5"},{"id":66,"norma_id":3,"numeral":"4.6"},{"id":67,"norma_id":3,"numeral":"5.1"},{"id":68,"norma_id":3,"numeral":"5.2"},{"id":69,"norma_id":3,"numeral":"5.3"},{"id":70,"norma_id":3,"numeral":"6.1"},{"id":71,"norma_id":3,"numeral":"6.2"},{"id":72,"norma_id":3,"numeral":"6.3"},{"id":74,"norma_id":3,"numeral":"7.2"},{"id":75,"norma_id":3,"numeral":"7.3"},{"id":76,"norma_id":3,"numeral":"7.4"},{"id":77,"norma_id":3,"numeral":"7.5"},{"id":78,"norma_id":3,"numeral":"8.1"},{"id":79,"norma_id":3,"numeral":"8.2"},{"id":80,"norma_id":3,"numeral":"8.3"},{"id":81,"norma_id":3,"numeral":"8.4"},{"id":82,"norma_id":3,"numeral":"9.1"},{"id":83,"norma_id":3,"numeral":"9.2"},{"id":84,"norma_id":3,"numeral":"9.3"},{"id":85,"norma_id":3,"numeral":"10.1"},{"id":86,"norma_id":3,"numeral":"10.2"}]', NULL, '2026-01-16 23:34:55', '2026-02-10 21:15:10'),
	(8, 1, 8, '2026-01-19', '08:30:00', '17:30:00', 'GESTIÓN DE LA COMUNICACIÓN', 'ejecucion', 'En Curso', NULL, NULL, NULL, NULL, 2, 6, '[{"id":2,"norma_id":1,"numeral":"4.2","norma":"ISO 9001:2025"},{"id":3,"norma_id":1,"numeral":"4.3","norma":"ISO 9001:2025"}]', NULL, '2026-01-16 23:34:55', '2026-02-10 21:15:10'),
	(9, 1, 7, '2026-01-20', '08:30:00', '16:30:00', 'GESTIÓN DE LA INVERSIÓN', 'ejecucion', 'Programada', NULL, NULL, NULL, NULL, 7, 6, NULL, NULL, '2026-01-16 23:34:55', '2026-02-10 21:15:10'),
	(11, 1, 45, '2026-01-21', '08:30:00', '17:30:00', 'GESTIÓN DE PROCESOS', 'ejecucion', 'Programada', NULL, NULL, NULL, NULL, 1, 6, NULL, NULL, '2026-02-04 21:01:30', '2026-02-10 21:15:10'),
	(21, 1, NULL, '2026-01-22', '17:00:00', '18:00:00', 'Reunión de Cierre', 'cierre', 'Programada', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-02-10 21:03:47', '2026-02-10 21:15:10');
...
-- Volcando datos para la tabla kallpaq.auditoria_checklists: ~54 rows (aproximadamente)
REPLACE INTO `auditoria_checklists` (`id`, `agenda_id`, `norma_referencia`, `requisito_referencia`, `requisito_contenido`, `pregunta`, `criterio_auditoria`, `evidencia_esperada`, `estado_cumplimiento`, `hallazgo_clasificacion`, `evidencia_registrada`, `hallazgo_detectado`, `hallazgo_redaccion`, `hallazgo_resumen`, `criterio_redaccion`, `evidencia_redaccion`, `tipo_hallazgo`, `comentarios`, `ai_generated`, `created_at`, `updated_at`) VALUES
	(466, 7, 'ISO 9001:2025', '4.2', 'Determinar quiénes son las partes interesadas pertinentes y cuáles son sus requisitos para el sistema de gestión de la calidad.', '¿Cómo se determina quiénes son las partes interesadas pertinentes y cuáles son sus requisitos para el sistema de gestión de la calidad?', 'Identificación y comprensión de las partes interesadas y sus expectativas.', 'Registro de identificación de partes interesadas y sus requisitos.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:00', '2026-02-10 19:54:32'),
	(467, 7, 'ISO 9001:2025', '4.3', 'Establecer los límites y la aplicabilidad del sistema, considerando productos, servicios y el contexto de la organización.', '¿Cómo se establecen los límites y la aplicabilidad del sistema de gestión de la calidad considerando los productos, servicios y el contexto de la organización?', 'Claridad en el alcance y aplicabilidad del sistema de gestión de la calidad.', 'Documento que defina el alcance del sistema de gestión de la calidad.', 'No Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:00', '2026-02-05 02:40:56'),
	(468, 7, 'ISO 9001:2025', '4.4', 'Establecer, implementar, mantener y mejorar el sistema, identificando entradas, salidas y la interacción entre procesos.', '¿Cómo se establecen, implementan, mantienen y mejoran el sistema de gestión de la calidad, identificando entradas, salidas y la interacción entre procesos?', 'Evidencia de la gestión efectiva de los procesos del sistema.', 'Diagrama de procesos y registros de mejora continua.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:00', '2026-02-05 02:41:00'),
	(469, 7, 'ISO 9001:2025', '5.1', 'La alta dirección debe demostrar liderazgo asegurando que la política y objetivos de calidad se integren en el negocio.', '¿Cómo demuestra la alta dirección su liderazgo asegurando que la política y objetivos de calidad se integren en el negocio?', 'Compromiso visible de la alta dirección con la calidad.', 'Actas de reuniones de la alta dirección y documentos de política de calidad.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:00', '2026-02-05 02:41:01'),
	(470, 7, 'ISO 9001:2025', '5.2', 'Establecer una política que sea apropiada al propósito, incluya compromiso de mejora y esté disponible para las partes interesadas.', '¿Cómo se establece una política de calidad que sea apropiada al propósito y que incluya un compromiso de mejora?', 'Política de calidad alineada con los objetivos organizacionales.', 'Documento de política de calidad y registros de comunicación.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:00', '2026-02-05 02:41:03'),
	(471, 7, 'ISO 9001:2025', '5.3', 'Asignar y comunicar las responsabilidades para asegurar que el sistema cumple los requisitos y los procesos entregan resultados.', '¿Cómo se asignan y comunican las responsabilidades para asegurar que el sistema cumple los requisitos y los procesos entregan resultados?', 'Claridad en roles y responsabilidades dentro del sistema.', 'Organigrama y descripciones de puestos.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:00', '2026-02-05 02:41:05'),
	(472, 7, 'ISO 9001:2025', '6.1', 'Planificar acciones para abordar los riesgos y oportunidades identificados con el fin de asegurar el logro de resultados y la mejora.', '¿Cómo se planifican las acciones para abordar los riesgos y oportunidades identificados?', 'Evidencia de un enfoque proactivo hacia la gestión de riesgos.', 'Registro de riesgos y oportunidades y plan de acción asociado.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:00', '2026-02-05 02:41:07'),
	(473, 7, 'ISO 9001:2025', '6.2', 'Establecer objetivos medibles y coherentes con la política en todos los niveles pertinentes de la organización.', '¿Cómo se establecen los objetivos de calidad medibles y coherentes con la política en todos los niveles pertinentes de la organización?', 'Objetivos de calidad alineados y medibles.', 'Documentación de objetivos de calidad y métricas de seguimiento.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:01', '2026-02-05 02:41:09'),
	(474, 7, 'ISO 9001:2025', '6.3', 'Cuando se requieran cambios en el sistema, estos deben llevarse a cabo de forma planificada y controlada.', '¿Cómo se planifican y controlan los cambios en el sistema de gestión de la calidad?', 'Control adecuado de los cambios en el sistema.', 'Registros de cambios y procedimientos de gestión de cambios.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:01', '2026-02-05 02:41:10'),
	(475, 7, 'ISO 9001:2025', '7.1', 'Determinar y proporcionar los recursos necesarios (personas, infraestructura, ambiente, seguimiento y medición) para el sistema.', '¿Cómo se determinan y proporcionan los recursos necesarios para el sistema de gestión de la calidad?', 'Disponibilidad de recursos adecuados para el sistema.', 'Plan de recursos y registros de asignación de recursos.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:01', '2026-02-05 02:41:12'),
	(476, 7, 'ISO 9001:2025', '7.2', 'Asegurar que el personal que realiza trabajos bajo su control sea competente basándose en su educación, formación o experiencia.', '¿Cómo se asegura que el personal que realiza trabajos bajo su control sea competente basándose en su educación, formación o experiencia?', 'Competencia del personal documentada y verificada.', 'Registros de formación y evaluaciones de competencia.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:01', '2026-02-05 02:41:18'),
	(477, 7, 'ISO 9001:2025', '7.3', 'Garantizar que las personas comprendan la política de calidad, los objetivos y su contribución a la eficacia del sistema.', '¿Cómo se garantiza que las personas comprendan la política de calidad, los objetivos y su contribución a la eficacia del sistema?', 'Conciencia del personal sobre la política de calidad.', 'Registros de comunicación y formación sobre la política de calidad.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:01', '2026-02-05 02:41:19'),
	(478, 7, 'ISO 9001:2025', '7.4', 'Establecer las comunicaciones internas y externas pertinentes (qué, cuándo, a quién, cómo y quién comunica).', '¿Cómo se establecen las comunicaciones internas y externas pertinentes?', 'Efectividad de la comunicación interna y externa.', 'Plan de comunicación y registros de comunicaciones realizadas.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:01', '2026-02-05 02:41:21'),
	(479, 7, 'ISO 9001:2025', '7.5', 'Controlar la creación, actualización y conservación de los documentos y registros requeridos por la norma.', '¿Cómo se controla la creación, actualización y conservación de los documentos y registros requeridos por la norma?', 'Control efectivo de la documentación del sistema.', 'Procedimiento de control de documentos y registros actualizados.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:01', '2026-02-05 02:41:23'),
	(480, 7, 'ISO 9001:2025', '8.1', 'Planificar, implementar y controlar los procesos necesarios para cumplir los requisitos de productos y servicios.', '¿Cómo se planifican, implementan y controlan los procesos necesarios para cumplir los requisitos de productos y servicios?', 'Gestión efectiva de los procesos operacionales.', 'Documentación de planificación de procesos y registros de control.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:01', '2026-02-05 02:41:24'),
	(481, 7, 'ISO 9001:2025', '8.2', 'Gestionar la comunicación con clientes y determinar/revisar los requisitos antes de comprometerse con la entrega.', '¿Cómo se gestiona la comunicación con clientes y se determinan/revisan los requisitos antes de comprometerse con la entrega?', 'Evidencia de gestión adecuada de requisitos del cliente.', 'Registros de comunicación con clientes y revisión de requisitos.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:01', '2026-02-05 02:41:26'),
	(482, 7, 'ISO 9001:2025', '8.3', 'Establecer un proceso para el diseño que incluya planificación, entradas, controles, salidas y gestión de cambios.', '¿Cómo se establece un proceso para el diseño que incluya planificación, entradas, controles, salidas y gestión de cambios?', 'Proceso de diseño y desarrollo bien definido y controlado.', 'Documentación del proceso de diseño y desarrollo.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:01', '2026-02-05 02:41:29'),
	(483, 7, 'ISO 9001:2025', '8.4', 'Asegurar que los productos o servicios de proveedores externos cumplen con los requisitos definidos por la organización.', '¿Cómo se asegura que los productos o servicios de proveedores externos cumplen con los requisitos definidos por la organización?', 'Control efectivo de productos y servicios suministrados externamente.', 'Registros de evaluación y control de proveedores.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:01', '2026-02-05 02:41:31'),
	(484, 7, 'ISO 9001:2025', '8.5', 'Realizar la producción bajo condiciones controladas (identificación, trazabilidad, preservación y actividades posentrega).', '¿Cómo se realiza la producción bajo condiciones controladas, incluyendo identificación, trazabilidad, preservación y actividades posentrega?', 'Producción controlada y trazabilidad asegurada.', 'Registros de producción y control de calidad.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:01', '2026-02-05 02:41:33'),
	(485, 7, 'ISO 9001:2025', '8.6', 'Verificar en las etapas adecuadas que se han cumplido los requisitos antes de entregar el producto o servicio al cliente.', '¿Cómo se verifica en las etapas adecuadas que se han cumplido los requisitos antes de entregar el producto o servicio al cliente?', 'Verificación adecuada antes de la entrega al cliente.', 'Registros de verificación y validación de productos y servicios.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:01', '2026-02-05 02:41:34'),
	(486, 7, 'ISO 9001:2025', '8.7', 'Identificar y controlar los productos o servicios que no cumplen los requisitos para prevenir su uso o entrega no intencionada.', '¿Cómo se identifican y controlan los productos o servicios que no cumplen los requisitos para prevenir su uso o entrega no intencionada?', 'Control efectivo de salidas no conformes.', 'Registros de control de no conformidades.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:01', '2026-02-05 02:41:36'),
	(487, 7, 'ISO 9001:2025', '9.1', 'Determinar qué necesita seguimiento, medir la satisfacción del cliente y analizar los datos obtenidos del desempeño.', '¿Cómo se determina qué necesita seguimiento, se mide la satisfacción del cliente y se analizan los datos obtenidos del desempeño?', 'Análisis adecuado de datos de desempeño y satisfacción del cliente.', 'Registros de seguimiento y análisis de satisfacción del cliente.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:01', '2026-02-05 02:41:38'),
	(488, 7, 'ISO 9001:2025', '9.2', 'Realizar auditorías internas a intervalos planificados para asegurar que el sistema es conforme y se mantiene eficazmente.', '¿Cómo se realizan auditorías internas a intervalos planificados para asegurar que el sistema es conforme y se mantiene eficazmente?', 'Evidencia de auditorías internas efectivas y programadas.', 'Plan de auditoría interna y registros de auditorías realizadas.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:01', '2026-02-05 02:41:39'),
	(489, 7, 'ISO 9001:2025', '9.3', 'La alta dirección debe revisar el sistema periódicamente para asegurar su conveniencia, adecuación, eficacia y alineación.', '¿Cómo revisa la alta dirección el sistema periódicamente para asegurar su conveniencia, adecuación, eficacia y alineación?', 'Revisiones periódicas efectivas por parte de la alta dirección.', 'Actas de revisión por la dirección y registros de decisiones.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:01', '2026-02-05 02:41:41'),
	(490, 7, 'ISO 9001:2025', '10.1', 'Determinar oportunidades de mejora e implementar acciones para aumentar la satisfacción del cliente.', '¿Cómo se determinan oportunidades de mejora e implementan acciones para aumentar la satisfacción del cliente?', 'Evidencia de un enfoque proactivo hacia la mejora continua.', 'Registros de oportunidades de mejora y acciones implementadas.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:01', '2026-02-05 02:41:43'),
	(491, 7, 'ISO 9001:2025', '10.2', 'Ante una no conformidad, tomar acciones para controlarla, evaluar la causa raíz e implementar correctivos para evitar su repetición.', '¿Cómo se toman acciones para controlar la no conformidad, evaluar la causa raíz e implementar correctivos para evitar su repetición?', 'Control efectivo de no conformidades y acciones correctivas.', 'Registros de no conformidades y acciones correctivas implementadas.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:01', '2026-02-05 02:41:45'),
	(492, 7, 'ISO 9001:2025', '10.3', 'Mejorar continuamente la idoneidad, adecuación y eficacia del sistema de gestión de la calidad.', '¿Cómo se mejora continuamente la idoneidad, adecuación y eficacia del sistema de gestión de la calidad?', 'Evidencia de mejora continua en el sistema de gestión de la calidad.', 'Registros de iniciativas de mejora y resultados obtenidos.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:25:01', '2026-02-05 02:41:48'),
	(493, 7, 'ISO 37301:2022', '4.1', 'Determinar cuestiones externas e internas relevantes para el propósito y que afectan los resultados del sistema de cumplimiento.', '¿Cómo se determinan las cuestiones externas e internas relevantes para el propósito que afectan los resultados del sistema de cumplimiento?', 'Verificar que se han identificado y analizado las cuestiones que afectan el sistema de cumplimiento.', 'Informe de análisis del contexto organizacional.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:48:53'),
	(494, 7, 'ISO 37301:2022', '4.2', 'Identificar partes interesadas relevantes y sus requisitos (legales, regulatorios o compromisos voluntarios).', '¿Cómo se identifican las partes interesadas relevantes y sus requisitos legales, regulatorios o compromisos voluntarios?', 'Confirmar que se han documentado las partes interesadas y sus expectativas.', 'Registro de partes interesadas y sus requisitos.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:49:17'),
	(495, 7, 'ISO 37301:2022', '7.1', 'Determinar y proporcionar los recursos necesarios (humanos, técnicos, financieros) para el sistema.', '¿Cómo se determinan y proporcionan los recursos necesarios (humanos, técnicos, financieros) para el sistema de cumplimiento?', 'Evaluar si se han asignado los recursos adecuados para el sistema.', 'Plan de recursos y asignación de presupuesto.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:49:31'),
	(496, 7, 'ISO 37301:2022', '4.3', 'Establecer los límites físicos y organizativos donde se aplicará el sistema de cumplimiento.', '¿Cómo se establece el alcance del sistema de gestión del cumplimiento en términos de límites físicos y organizativos?', 'Comprobar que se ha definido claramente el alcance del sistema.', 'Documentación del alcance del sistema de gestión.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:49:50'),
	(497, 7, 'ISO 37301:2022', '4.4', 'Establecer, implementar y mejorar el sistema, incluyendo procesos e interacciones bajo los principios de buen gobierno.', '¿Cómo se establece, implementa y mejora el sistema de gestión del cumplimiento, incluyendo procesos e interacciones bajo los principios de buen gobierno?', 'Verificar la implementación y mejora continua del sistema.', 'Manual del sistema de gestión del cumplimiento.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:50:02'),
	(498, 7, 'ISO 37301:2022', '4.5', 'Identificar sistemáticamente las obligaciones legales y los compromisos que la organización decide adoptar.', '¿Cómo se identifican sistemáticamente las obligaciones legales y los compromisos que la organización decide adoptar?', 'Confirmar que se han documentado las obligaciones de cumplimiento.', 'Registro de obligaciones legales y compromisos.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:51:26'),
	(499, 7, 'ISO 37301:2022', '4.6', 'Identificar, analizar y evaluar los riesgos de incumplimiento de forma periódica y ante cambios.', '¿Cómo se identifican, analizan y evalúan periódicamente los riesgos de incumplimiento y ante cambios?', 'Evaluar la periodicidad y efectividad de la evaluación de riesgos.', 'Informe de evaluación de riesgos de cumplimiento.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:54:34'),
	(500, 7, 'ISO 37301:2022', '5.1', 'La alta dirección y el órgano de gobierno deben demostrar liderazgo y asegurar los recursos para el sistema.', '¿Cómo demuestra la alta dirección y el órgano de gobierno liderazgo y aseguran los recursos para el sistema?', 'Verificar el compromiso visible de la alta dirección.', 'Actas de reuniones de la alta dirección y políticas de compromiso.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:54:47'),
	(501, 7, 'ISO 37301:2022', '5.2', 'Establecer una política escrita que prohíba el incumplimiento y fomente la comunicación de inquietudes.', '¿Cómo se establece una política escrita que prohíba el incumplimiento y fomente la comunicación de inquietudes?', 'Confirmar la existencia y difusión de la política de cumplimiento.', 'Copia de la política de cumplimiento.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:54:50'),
	(502, 7, 'ISO 37301:2022', '5.3', 'Asignar responsabilidades en toda la organización, incluyendo la función de cumplimiento independiente.', '¿Cómo se asignan responsabilidades en toda la organización, incluyendo la función de cumplimiento independiente?', 'Verificar la claridad en la asignación de responsabilidades.', 'Organigrama y descripciones de puestos.', 'No Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:59:40'),
	(503, 7, 'ISO 37301:2022', '6.1', 'Planificar acciones para prevenir efectos no deseados y asegurar que el sistema logre sus objetivos.', '¿Cómo se planifican acciones para prevenir efectos no deseados y asegurar que el sistema logre sus objetivos?', 'Evaluar la efectividad de las acciones planificadas.', 'Plan de acción para la gestión de riesgos.', 'No Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:59:43'),
	(504, 7, 'ISO 37301:2022', '6.2', 'Establecer objetivos medibles en funciones y niveles pertinentes, coherentes con la política.', '¿Cómo se establecen objetivos medibles en funciones y niveles pertinentes, coherentes con la política?', 'Confirmar que los objetivos son medibles y alineados con la política.', 'Documentación de objetivos de cumplimiento.', 'Sin Evaluar', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:27:53'),
	(505, 7, 'ISO 37301:2022', '6.3', 'Realizar cambios al sistema de forma planificada para mantener su integridad.', '¿Cómo se realizan cambios al sistema de forma planificada para mantener su integridad?', 'Verificar la planificación y control de cambios en el sistema.', 'Registro de cambios y evaluaciones de impacto.', 'No Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:59:45'),
	(506, 7, 'ISO 37301:2022', '7.2', 'Asegurar que el personal sea competente basándose en educación, formación o experiencia.', '¿Cómo se asegura que el personal sea competente basándose en educación, formación o experiencia?', 'Evaluar la competencia del personal en relación al sistema.', 'Registros de formación y competencias del personal.', 'Conforme', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-10 19:22:21'),
	(507, 7, 'ISO 37301:2022', '7.3', 'Lograr que el personal conozca la política de cumplimiento y las consecuencias de no cumplirla.', '¿Cómo se logra que el personal conozca la política de cumplimiento y las consecuencias de no cumplirla?', 'Confirmar que el personal está informado sobre la política de cumplimiento.', 'Registros de comunicación y formación sobre la política.', 'Sin Evaluar', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:27:53'),
	(508, 7, 'ISO 37301:2022', '7.4', 'Determinar las comunicaciones internas y externas pertinentes al sistema de gestión.', '¿Cómo se determinan las comunicaciones internas y externas pertinentes al sistema de gestión?', 'Verificar la efectividad de las comunicaciones relacionadas con el sistema.', 'Plan de comunicación del sistema de gestión.', 'Sin Evaluar', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:27:53'),
	(509, 7, 'ISO 37301:2022', '7.5', 'Crear, actualizar y controlar los documentos y registros requeridos por la norma.', '¿Cómo se crean, actualizan y controlan los documentos y registros requeridos por la norma?', 'Evaluar la gestión de la documentación del sistema.', 'Procedimientos de control de documentos y registros.', 'Sin Evaluar', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:27:53'),
	(510, 7, 'ISO 37301:2022', '8.1', 'Implementar procesos para cumplir los requisitos y realizar las acciones planificadas en el capítulo 6.', '¿Cómo se implementan procesos para cumplir los requisitos y realizar las acciones planificadas en el capítulo 6?', 'Verificar la efectividad de los procesos implementados.', 'Registros de implementación de procesos operacionales.', 'Sin Evaluar', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:27:53'),
	(511, 7, 'ISO 37301:2022', '8.2', 'Establecer controles para asegurar que se cumplen las obligaciones y se mitigan los riesgos de cumplimiento.', '¿Cómo se establecen controles para asegurar que se cumplen las obligaciones y se mitigan los riesgos de cumplimiento?', 'Confirmar la existencia y efectividad de los controles establecidos.', 'Documentación de controles y procedimientos establecidos.', 'Sin Evaluar', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:27:53'),
	(512, 7, 'ISO 37301:2022', '8.3', 'Establecer procesos para reportar sospechas de incumplimiento (canales de denuncia) con protección al informante.', '¿Cómo se establecen procesos para reportar sospechas de incumplimiento (canales de denuncia) con protección al informante?', 'Verificar la existencia y accesibilidad de los canales de denuncia.', 'Documentación de los canales de denuncia y políticas de protección.', 'Sin Evaluar', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:27:53'),
	(513, 7, 'ISO 37301:2022', '8.4', 'Establecer mecanismos para investigar y evaluar posibles incumplimientos de forma objetiva.', '¿Cómo se establecen mecanismos para investigar y evaluar posibles incumplimientos de forma objetiva?', 'Evaluar la objetividad y efectividad de los mecanismos de investigación.', 'Procedimientos de investigación de incumplimientos.', 'Sin Evaluar', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:27:53'),
	(514, 7, 'ISO 37301:2022', '9.1', 'Evaluar el desempeño del cumplimiento y la eficacia del sistema mediante indicadores.', '¿Cómo se evalúa el desempeño del cumplimiento y la eficacia del sistema mediante indicadores?', 'Verificar la medición y análisis del desempeño del cumplimiento.', 'Informes de indicadores de desempeño del sistema.', 'Sin Evaluar', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:27:53'),
	(515, 7, 'ISO 37301:2022', '9.2', 'Realizar auditorías a intervalos planificados para verificar que el sistema es conforme y eficaz.', '¿Cómo se realizan auditorías a intervalos planificados para verificar que el sistema es conforme y eficaz?', 'Confirmar la ejecución de auditorías internas planificadas.', 'Plan de auditorías internas y registros de auditorías realizadas.', 'Sin Evaluar', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:27:53'),
	(516, 7, 'ISO 37301:2022', '9.3', 'La alta dirección debe revisar el sistema para asegurar su conveniencia, adecuación y eficacia.', '¿Cómo revisa la alta dirección el sistema para asegurar su conveniencia, adecuación y eficacia?', 'Evaluar la efectividad de las revisiones realizadas por la alta dirección.', 'Actas de reuniones de revisión por la dirección.', 'Sin Evaluar', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:27:53'),
	(517, 7, 'ISO 37301:2022', '10.1', 'Reaccionar ante incumplimientos, tomar medidas para controlarlos y eliminar las causas para que no vuelvan a ocurrir.', '¿Cómo se reaccionan ante incumplimientos, tomando medidas para controlarlos y eliminar las causas para que no vuelvan a ocurrir?', 'Verificar la efectividad de las acciones tomadas ante incumplimientos.', 'Registros de acciones correctivas y preventivas.', 'Sin Evaluar', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:27:53'),
	(518, 7, 'ISO 37301:2022', '10.2', 'Mejorar continuamente la idoneidad y eficacia del sistema de gestión del cumplimiento.', '¿Cómo se mejora continuamente la idoneidad y eficacia del sistema de gestión del cumplimiento?', 'Evaluar el proceso de mejora continua del sistema de gestión.', 'Informes de mejora continua y acciones implementadas.', 'Sin Evaluar', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:27:53', '2026-02-05 02:27:53'),
	(519, 8, 'ISO 9001:2025', '4.2', 'Determinar quiénes son las partes interesadas pertinentes y cuáles son sus requisitos para el sistema de gestión de la calidad.', '¿Cómo se determina quiénes son las partes interesadas pertinentes para el sistema de gestión de la calidad?', 'Verificar que se ha realizado un análisis adecuado de las partes interesadas y sus expectativas en relación al sistema de gestión de la calidad.', 'Documentación que identifique las partes interesadas y sus requisitos, como un registro de partes interesadas o un análisis de necesidades.', 'Conforme', NULL, 'No ha y evidencia del analisis de partes interesadas', 'Hallazgo: Se ha identificado la ausencia de documentación que respalde el análisis de las partes interesadas, lo cual constituye un incumplimiento de los requisitos establecidos en la norma ISO correspondiente. Esta falta de evidencia limita la capacidad de la organización para identificar y gestionar adecuadamente las expectativas y necesidades de las partes interesadas, lo que podría afectar el desempeño y la eficacia del sistema de gestión implementado. Se recomienda llevar a cabo este análisis y documentar los resultados de manera formal.', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-05 02:57:24', '2026-02-10 20:23:52'),
	(520, 8, 'ISO 9001:2025', '4.3', 'Establecer los límites y la aplicabilidad del sistema, considerando productos, servicios y el contexto de la organización.', '¿Cómo se establece el alcance del sistema de gestión de la calidad considerando los productos, servicios y el contexto de la organización?', 'Evaluar si se han definido claramente los límites y la aplicabilidad del sistema de gestión de la calidad en función de los productos y servicios ofrecidos.', 'Documentación que defina el alcance del sistema de gestión de la calidad, como un documento de alcance o un análisis del contexto organizacional.', 'No Conforme', 'NCM', 'No se tiene definido el alcance en el manual', 'Hallazgo de Auditoría: Se ha identificado que el Manual 001, aprobado el 12 de mayo de 2025, carece de una definición clara de su alcance. Esta omisión representa un incumplimiento de los requisitos establecidos en la norma ISO correspondiente, lo que puede afectar la comprensión y aplicación de los procesos y procedimientos documentados. Se recomienda la revisión y actualización del manual para incluir una descripción precisa del alcance que garantice su correcta implementación y alineación con los objetivos del sistema de gestión.', 'Hallazgo de Auditoría: Se ha identificado que el Manual 001, aprobado el 12 de mayo de 2025, carece de una definición clara de su alcance. Esta omisión representa un incumplimiento de los requisitos establecidos en la norma ISO correspondiente, lo que puede afectar la comprensión y aplicación de los procesos y procedimientos documentados. Se recomienda la revisión y actualización del manual para incluir una descripción precisa del alcance que garantice su correcta implementación y alineación con los objetivos del sistema de gestión.', NULL, '4.3', 'No se tiene definido el alcance en el manual', NULL, NULL, 1, '2026-02-05 02:57:24', '2026-02-10 15:19:15');
...
CREATE TABLE IF NOT EXISTS `auditoria_equipo` (
  ...
  `aeq_horas_programadas` decimal(8,2) NOT NULL DEFAULT 0.00,
...
REPLACE INTO `auditoria_equipo` (`id`, `ae_id`, `auditor_id`, `aeq_rol`, `aeq_horas_programadas`, `aeq_horas_ejecutadas`, `created_at`, `updated_at`) VALUES
	(45, 1, 1, 'Auditor Líder', 19.00, 6.04, '2026-01-16 23:06:57', '2026-02-10 21:06:07'),
	(46, 1, 2, 'Auditor Interno', 11.00, 9.00, '2026-01-16 23:06:57', '2026-02-10 21:06:07'),
	(48, 1, 7, 'Auditor Interno', 10.00, 0.00, '2026-01-16 23:35:13', '2026-02-10 21:06:07'),
	(49, 1, 6, 'Observador', 36.00, 15.04, '2026-02-10 18:27:55', '2026-02-10 21:09:51');
...
CREATE TABLE IF NOT EXISTS `auditoria_especifica` (
  ...
  `ae_avance` decimal(5,2) NOT NULL DEFAULT 0.00,
...
REPLACE INTO `auditoria_especifica` (`id`, `pa_id`, `ae_codigo`, `ae_objetivo`, `ae_criterios`, `ae_alcance`, `ae_tipo`, `ae_sistema`, `ae_lugar`, `ae_direccion`, `ae_estado`, `ae_avance`, `ae_fecha_inicio`, `ae_fecha_fin`, `created_at`, `updated_at`, `ae_cantidad_auditores`, `ae_horas_hombre`, `ae_ciclo`) VALUES
	(1, 1, '2026 - 001 - IN', 'Objetivo', 'ISO 9001, ISO 37001', 'Alcance', 'Interna', '["sgc","sgcm"]', NULL, 'Calle Camilo Carrillo 114, Jesus María', 'Programada', 29.25, '2026-01-16', '2026-12-31', '2026-01-16 19:07:32', '2026-02-10 21:15:11', NULL, 76.00, 1);
...
REPLACE INTO `auditoria_informes` (`id`, `ae_id`, `codigo`, `estado`, `resumen_ejecutivo`, `alcance_criterios`, `hallazgos_conformidad`, `hallazgos_no_conformidad`, `oportunidades_mejora`, `procesos_auditados`, `auditados`, `conclusiones`, `recomendaciones`, `fecha_emision`, `elaborado_por`, `aprobado_por`, `created_at`, `updated_at`) VALUES
	(1, 1, '2026 - 001 - IN-INF-20260118', 'Borrador', NULL, NULL, '[]', '[]', '[]', '[]', '[]', '**Conclusiones de la Auditoría:**\n\nLa auditoría ha revelado un total de 36 conformidades y 5 no conformidades, lo que indica un cumplimiento general positivo del sistema de gestión. Sin embargo, se identificaron áreas críticas de mejora, especialmente en la gestión estratégica y la comunicación, donde se carece de definiciones claras en el manual sobre el alcance del sistema, lo que puede comprometer la efectividad de los procesos.\n\nLas fortalezas clave incluyen la existencia de un marco de gestión establecido, mientras que las vulnerabilidades críticas radican en la falta de claridad en la documentación y la asignación de responsabilidades. Se recomienda abordar las no conformidades identificadas para asegurar la alineación con los estándares ISO y mejorar la eficacia del sistema de gestión.', NULL, NULL, 1, NULL, '2026-01-19 00:50:20', '2026-02-10 20:45:49'),
	(2, 1, '2026 - 001 - IN-INF-20260204', 'Borrador', '**Resumen Ejecutivo del Informe de Auditoría ISO 9001 e ISO 37001**\n\nCódigo: 2026 - 001 - IN  \nPeríodo: 16 de enero de 2026 a 31 de diciembre de 2026\n\nLa auditoría realizada en el período mencionado tuvo como objetivo evaluar la conformidad de los sistemas de gestión de calidad (ISO 9001) y de gestión antisoborno (ISO 37001) de la organización. Se llevó a cabo un análisis exhaustivo que abarcó todos los procesos relevantes.\n\nLos resultados de la auditoría indican un nivel general de cumplimiento satisfactorio, con un total de 1 conformidad encontrada, lo que refleja el compromiso de la organización con las normativas establecidas. Sin embargo, se identificó 1 no conformidad que requiere atención inmediata para asegurar la mejora continua de los procesos. Además, se detectó 1 oportunidad de mejora que podría potenciar la eficacia del sistema de gestión.\n\nSe recomienda a la organización abordar la no conformidad de manera prioritaria y considerar la implementación de las mejoras sugeridas para fortalecer su sistema de gestión y asegurar el cumplimiento normativo en el futuro.', '### Alcance y Criterios\n\n#### Alcance\n\nLa auditoría se llevó a cabo en las instalaciones de la organización, abarcando tanto las áreas administrativas como operativas. El alcance físico incluyó todas las sedes relevantes donde se desarrollan las actividades institucionales, mientras que el alcance funcional se centró en los procesos clave que sustentan el sistema de gestión de calidad y el sistema de gestión de cumplimiento. Se consideraron todos los grupos de procesos institucionales relacionados con la planificación, ejecución y evaluación de las actividades, garantizando así una visión integral del desempeño organizacional.\n\n#### Criterios\n\nPara la realización de esta auditoría, se aplicaron los siguientes criterios normativos: \n\n- **ISO 9001:2015**: Esta norma establece los requisitos para un sistema de gestión de calidad que permite a las organizaciones demostrar su capacidad para proporcionar productos y servicios que cumplan con los requisitos del cliente y las regulaciones aplicables.\n\n- **ISO 37001:2016**: Esta norma proporciona un marco para establecer, implementar, mantener y mejorar un sistema de gestión anti-soborno, ayudando a las organizaciones a prevenir, detectar y abordar el soborno en sus operaciones.\n\nLa auditoría se realizó en conformidad con estos estándares, asegurando que se evaluaran adecuadamente los procesos institucionales en relación con los requisitos establecidos.', '[{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"items":[{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se determina qui\\u00e9nes son las partes interesadas pertinentes y cu\\u00e1les son sus requisitos para el sistema de gesti\\u00f3n de la calidad?","norma":"ISO 9001:2025","requisito":"4.2","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":466},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se establecen, implementan, mantienen y mejoran el sistema de gesti\\u00f3n de la calidad, identificando entradas, salidas y la interacci\\u00f3n entre procesos?","norma":"ISO 9001:2025","requisito":"4.4","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":468},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo demuestra la alta direcci\\u00f3n su liderazgo asegurando que la pol\\u00edtica y objetivos de calidad se integren en el negocio?","norma":"ISO 9001:2025","requisito":"5.1","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":469},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se establece una pol\\u00edtica de calidad que sea apropiada al prop\\u00f3sito y que incluya un compromiso de mejora?","norma":"ISO 9001:2025","requisito":"5.2","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":470},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se asignan y comunican las responsabilidades para asegurar que el sistema cumple los requisitos y los procesos entregan resultados?","norma":"ISO 9001:2025","requisito":"5.3","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":471},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se planifican las acciones para abordar los riesgos y oportunidades identificados?","norma":"ISO 9001:2025","requisito":"6.1","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":472},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se establecen los objetivos de calidad medibles y coherentes con la pol\\u00edtica en todos los niveles pertinentes de la organizaci\\u00f3n?","norma":"ISO 9001:2025","requisito":"6.2","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":473},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se planifican y controlan los cambios en el sistema de gesti\\u00f3n de la calidad?","norma":"ISO 9001:2025","requisito":"6.3","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":474},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se determinan y proporcionan los recursos necesarios para el sistema de gesti\\u00f3n de la calidad?","norma":"ISO 9001:2025","requisito":"7.1","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":475},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se asegura que el personal que realiza trabajos bajo su control sea competente bas\\u00e1ndose en su educaci\\u00f3n, formaci\\u00f3n o experiencia?","norma":"ISO 9001:2025","requisito":"7.2","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":476},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se garantiza que las personas comprendan la pol\\u00edtica de calidad, los objetivos y su contribuci\\u00f3n a la eficacia del sistema?","norma":"ISO 9001:2025","requisito":"7.3","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":477},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se establecen las comunicaciones internas y externas pertinentes?","norma":"ISO 9001:2025","requisito":"7.4","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":478},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se controla la creaci\\u00f3n, actualizaci\\u00f3n y conservaci\\u00f3n de los documentos y registros requeridos por la norma?","norma":"ISO 9001:2025","requisito":"7.5","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":479},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se planifican, implementan y controlan los procesos necesarios para cumplir los requisitos de productos y servicios?","norma":"ISO 9001:2025","requisito":"8.1","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":480},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se gestiona la comunicaci\\u00f3n con clientes y se determinan\\/revisan los requisitos antes de comprometerse con la entrega?","norma":"ISO 9001:2025","requisito":"8.2","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":481},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se establece un proceso para el dise\\u00f1o que incluya planificaci\\u00f3n, entradas, controles, salidas y gesti\\u00f3n de cambios?","norma":"ISO 9001:2025","requisito":"8.3","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":482},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se asegura que los productos o servicios de proveedores externos cumplen con los requisitos definidos por la organizaci\\u00f3n?","norma":"ISO 9001:2025","requisito":"8.4","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":483},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se realiza la producci\\u00f3n bajo condiciones controladas, incluyendo identificaci\\u00f3n, trazabilidad, preservaci\\u00f3n y actividades posentrega?","norma":"ISO 9001:2025","requisito":"8.5","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":484},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se verifica en las etapas adecuadas que se han cumplido los requisitos antes de entregar el producto o servicio al cliente?","norma":"ISO 9001:2025","requisito":"8.6","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":485},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se identifican y controlan los productos o servicios que no cumplen los requisitos para prevenir su uso o entrega no intencionada?","norma":"ISO 9001:2025","requisito":"8.7","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":486},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se determina qu\\u00e9 necesita seguimiento, se mide la satisfacci\\u00f3n del cliente y se analizan los datos obtenidos del desempe\\u00f1o?","norma":"ISO 9001:2025","requisito":"9.1","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":487},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se realizan auditor\\u00edas internas a intervalos planificados para asegurar que el sistema es conforme y se mantiene eficazmente?","norma":"ISO 9001:2025","requisito":"9.2","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":488},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo revisa la alta direcci\\u00f3n el sistema peri\\u00f3dicamente para asegurar su conveniencia, adecuaci\\u00f3n, eficacia y alineaci\\u00f3n?","norma":"ISO 9001:2025","requisito":"9.3","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":489},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se determinan oportunidades de mejora e implementan acciones para aumentar la satisfacci\\u00f3n del cliente?","norma":"ISO 9001:2025","requisito":"10.1","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":490},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se toman acciones para controlar la no conformidad, evaluar la causa ra\\u00edz e implementar correctivos para evitar su repetici\\u00f3n?","norma":"ISO 9001:2025","requisito":"10.2","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":491},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se mejora continuamente la idoneidad, adecuaci\\u00f3n y eficacia del sistema de gesti\\u00f3n de la calidad?","norma":"ISO 9001:2025","requisito":"10.3","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":492},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se determinan las cuestiones externas e internas relevantes para el prop\\u00f3sito que afectan los resultados del sistema de cumplimiento?","norma":"ISO 37301:2022","requisito":"4.1","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":493},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se identifican las partes interesadas relevantes y sus requisitos legales, regulatorios o compromisos voluntarios?","norma":"ISO 37301:2022","requisito":"4.2","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":494},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se determinan y proporcionan los recursos necesarios (humanos, t\\u00e9cnicos, financieros) para el sistema de cumplimiento?","norma":"ISO 37301:2022","requisito":"7.1","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":495},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se establece el alcance del sistema de gesti\\u00f3n del cumplimiento en t\\u00e9rminos de l\\u00edmites f\\u00edsicos y organizativos?","norma":"ISO 37301:2022","requisito":"4.3","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":496},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se establece, implementa y mejora el sistema de gesti\\u00f3n del cumplimiento, incluyendo procesos e interacciones bajo los principios de buen gobierno?","norma":"ISO 37301:2022","requisito":"4.4","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":497},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se identifican sistem\\u00e1ticamente las obligaciones legales y los compromisos que la organizaci\\u00f3n decide adoptar?","norma":"ISO 37301:2022","requisito":"4.5","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":498},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se identifican, analizan y eval\\u00faan peri\\u00f3dicamente los riesgos de incumplimiento y ante cambios?","norma":"ISO 37301:2022","requisito":"4.6","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":499},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo demuestra la alta direcci\\u00f3n y el \\u00f3rgano de gobierno liderazgo y aseguran los recursos para el sistema?","norma":"ISO 37301:2022","requisito":"5.1","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":500},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se establece una pol\\u00edtica escrita que proh\\u00edba el incumplimiento y fomente la comunicaci\\u00f3n de inquietudes?","norma":"ISO 37301:2022","requisito":"5.2","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":501},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se asegura que el personal sea competente bas\\u00e1ndose en educaci\\u00f3n, formaci\\u00f3n o experiencia?","norma":"ISO 37301:2022","requisito":"7.2","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":506}]},{"proceso":"GESTI\\u00d3N DE LA COMUNICACI\\u00d3N","proceso_id":8,"items":[{"proceso":"GESTI\\u00d3N DE LA COMUNICACI\\u00d3N","proceso_id":8,"pregunta":"\\u00bfC\\u00f3mo se determina qui\\u00e9nes son las partes interesadas pertinentes para el sistema de gesti\\u00f3n de la calidad?","norma":"ISO 9001:2025","requisito":"4.2","evidencia":"No ha y evidencia del analisis de partes interesadas","hallazgo":"Hallazgo: Se ha identificado la ausencia de documentaci\\u00f3n que respalde el an\\u00e1lisis de las partes interesadas, lo cual constituye un incumplimiento de los requisitos establecidos en la norma ISO correspondiente. Esta falta de evidencia limita la capacidad de la organizaci\\u00f3n para identificar y gestionar adecuadamente las expectativas y necesidades de las partes interesadas, lo que podr\\u00eda afectar el desempe\\u00f1o y la eficacia del sistema de gesti\\u00f3n implementado. Se recomienda llevar a cabo este an\\u00e1lisis y documentar los resultados de manera formal.","resumen":null,"hallazgo_clasificacion":null,"checklist_id":519}]}]', '[{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"items":[{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se establecen los l\\u00edmites y la aplicabilidad del sistema de gesti\\u00f3n de la calidad considerando los productos, servicios y el contexto de la organizaci\\u00f3n?","norma":"ISO 9001:2025","requisito":"4.3","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":467,"seleccionado":false,"clasificacion":null},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se asignan responsabilidades en toda la organizaci\\u00f3n, incluyendo la funci\\u00f3n de cumplimiento independiente?","norma":"ISO 37301:2022","requisito":"5.3","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":502,"seleccionado":false,"clasificacion":null},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se planifican acciones para prevenir efectos no deseados y asegurar que el sistema logre sus objetivos?","norma":"ISO 37301:2022","requisito":"6.1","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":503,"seleccionado":false,"clasificacion":null},{"proceso":"GESTI\\u00d3N ESTRAT\\u00c9GICA","proceso_id":5,"pregunta":"\\u00bfC\\u00f3mo se realizan cambios al sistema de forma planificada para mantener su integridad?","norma":"ISO 37301:2022","requisito":"6.3","evidencia":null,"hallazgo":null,"resumen":null,"hallazgo_clasificacion":null,"checklist_id":505,"seleccionado":false,"clasificacion":null}]},{"proceso":"GESTI\\u00d3N DE LA COMUNICACI\\u00d3N","proceso_id":8,"items":[{"proceso":"GESTI\\u00d3N DE LA COMUNICACI\\u00d3N","proceso_id":8,"pregunta":"\\u00bfC\\u00f3mo se establece el alcance del sistema de gesti\\u00f3n de la calidad considerando los productos, servicios y el contexto de la organizaci\\u00f3n?","norma":"ISO 9001:2025","requisito":"4.3","evidencia":"No se tiene definido el alcance en el manual","hallazgo":"Hallazgo de Auditor\\u00eda: Se ha identificado que el Manual 001, aprobado el 12 de mayo de 2025, carece de una definici\\u00f3n clara de su alcance. Esta omisi\\u00f3n representa un incumplimiento de los requisitos establecidos en la norma ISO correspondiente, lo que puede afectar la comprensi\\u00f3n y aplicaci\\u00f3n de los procesos y procedimientos documentados. Se recomienda la revisi\\u00f3n y actualizaci\\u00f3n del manual para incluir una descripci\\u00f3n precisa del alcance que garantice su correcta implementaci\\u00f3n y alineaci\\u00f3n con los objetivos del sistema de gesti\\u00f3n.","resumen":null,"hallazgo_clasificacion":"NCM","checklist_id":520,"seleccionado":false,"clasificacion":null}]}]', '[]', '[{"nombre":"GESTI\\u00d3N ESTRAT\\u00c9GICA","responsable":"N\\/A","fecha_auditoria":"2026-01-16","total_preguntas":53},{"nombre":"GESTI\\u00d3N DE LA COMUNICACI\\u00d3N","responsable":"N\\/A","fecha_auditoria":"2026-01-19","total_preguntas":2}]', '[]', '**Conclusiones de la Auditoría:**\n\nLa auditoría ha revelado un total de 1 no conformidad relacionada con la gestión estratégica, específicamente la falta de políticas de cumplimiento aprobadas, lo que contraviene el requisito 5.1 de la norma ISO 37001. Esta ausencia limita la capacidad de la organización para establecer directrices claras, afectando la eficacia en la implementación de procesos y procedimientos.\n\nA pesar de contar con una conformidad y una oportunidad de mejora, la vulnerabilidad crítica identificada resalta la necesidad urgente de desarrollar y aprobar políticas que respalden el cumplimiento normativo. Esta acción es esencial para fortalecer la cultura de cumplimiento y mejorar la consistencia organizacional.', '1. **Elaborar políticas de cumplimiento**: Desarrollar y aprobar políticas formales que respalden el cumplimiento normativo según ISO 37001.\n\n2. **Comunicar las políticas**: Difundir las políticas aprobadas a todos los niveles de la organización para asegurar su comprensión y aplicación.\n\n3. **Capacitar al personal**: Implementar un programa de capacitación sobre las nuevas políticas de cumplimiento y su importancia en la gestión estratégica.\n\n4. **Establecer un sistema de seguimiento**: Crear un mecanismo para monitorear la implementación de las políticas y evaluar su efectividad periódicamente.\n\n5. **Designar un responsable**: Asignar a un líder o equipo encargado de supervisar el cumplimiento de las políticas y gestionar las no conformidades.\n\n6. **Revisar y actualizar regularmente**: Programar revisiones anuales de las políticas para asegurar su relevancia y adecuación a los cambios normativos y organizacionales.', NULL, 1, NULL, '2026-02-04 21:13:32', '2026-02-10 20:30:11');
...
REPLACE INTO `auditoria_proceso` (`id`, `ae_id`, `proceso_id`, `created_at`, `updated_at`) VALUES
	...
	(5, 1, 45, '2026-02-04 21:01:10', '2026-02-04 21:01:10');
...
-- Volcando estructura para tabla kallpaq.controles
...
-- Volcando datos para la tabla kallpaq.controles: ~0 rows (aproximadamente)
...
REPLACE INTO `encuestas_satisfaccion` (`id`, `proceso_id`, `es_periodo`, `es_numero_periodo`, `es_anio`, `es_nps_score`, `es_score`, `es_cantidad`, `es_informe_path`, `created_at`, `updated_at`) VALUES
	(3, 45, 'Trimestral', 1, 2026, 89.00, 4.20, 120, '{"path":"satisfaccion\\/encuestas\\/151\\/Ilx3vXOPTjFYEl3ZmxrMR6Ctaw2E5RYZqr2oDMnZ.pdf","name":"Informe_Tecnico_Encuesta IP 2025 -IIIT[F].pdf"}', '2026-01-19 16:53:04', '2026-02-10 14:24:19');
...
REPLACE INTO `encuesta_satisfaccion_detalles` (`id`, `encuesta_id`, `esd_categoria`, `esd_puntaje`, `created_at`, `updated_at`) VALUES
	(166, 3, 'Oportunidad', 4.00, '2026-02-10 14:24:19', '2026-02-10 14:24:19'),
	(167, 3, 'Trato', 4.00, '2026-02-10 14:24:19', '2026-02-10 14:24:19'),
	(168, 3, 'Claridad', 4.00, '2026-02-10 14:24:19', '2026-02-10 14:24:19'),
	(169, 3, 'Seguridad', 4.00, '2026-02-10 14:24:19', '2026-02-10 14:24:19'),
	(170, 3, 'Calidad', 5.00, '2026-02-10 14:24:19', '2026-02-10 14:24:19');
...
CREATE TABLE IF NOT EXISTS `hallazgos` (
  ...
  `hallazgo_estado` enum('creado','evaluado','aprobado','desestimado','en proceso','concluido','cerrado') DEFAULT NULL,
...
-- Volcando datos para la tabla kallpaq.hallazgo_movimientos: ~7 rows (aproximadamente)
REPLACE INTO `hallazgo_movimientos` (`id`, `hallazgo_id`, `user_id`, `hm_estado`, `hm_comentario`, `created_at`, `updated_at`) VALUES
	...
	(6, 56, 1, 'evaluado', 'Evaluación de eficacia sin eficacia. Se requiere plan de acción actualizado. Ciclo: 3', '2026-01-26 15:53:06', '2026-01-26 15:53:06'),
	(7, 55, 1, 'en proceso', 'Estado cambiado a: en proceso', '2026-01-26 22:21:50', '2026-01-26 22:21:50');
...
-- Volcando datos para la tabla kallpaq.indicadores_seguimiento: ~7 rows (aproximadamente)
...
-- Volcando datos para la tabla kallpaq.migrations: ~199 rows (aproximadamente)
REPLACE INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(233, '2026_01_22_113549_add_force_password_change_to_users_table', 86),
	(234, '2026_01_26_143603_add_ar_estado_to_accion_reprogramaciones_table', 87),
	(235, '2026_01_26_162506_create_accion_avances_table', 88),
	(236, '2026_01_26_180000_refactor_acciones_table_remove_redundancy', 89),
	(237, '2026_01_28_102044_add_obligacion_id_to_acciones_table', 90),
	(238, '2026_01_28_104247_create_obligacion_proceso_table', 999),
	(239, '2026_01_28_165252_refactor_riesgo_controles_to_master', 1000),
	(240, '2026_01_28_173715_cleanup_obligaciones_risk_fields', 1001),
	(241, '2026_01_28_180435_remove_obligacion_controles_column', 1002),
	(242, '2026_01_28_183605_create_obligacion_control_table', 1003),
	(243, '2026_01_28_183616_add_es_control_permanente_to_acciones_table', 1003),
	(244, '2026_01_29_085719_unify_acciones_and_riesgo_acciones_tables', 1004),
	(245, '2026_01_29_094222_cleanup_obsolete_accion_tables', 1005),
	(246, '2026_02_02_100209_rename_control_riesgo_to_riesgo_control', 1006),
	(247, '2026_02_02_104917_rename_columns_in_obligaciones_table', 1007),
	(248, '2026_02_02_115816_add_identification_dates_to_riesgos_and_obligaciones_table', 1008),
	(249, '2026_02_02_122346_normalize_obligaciones_enums', 1009),
	(250, '2026_02_03_182345_create_obligacion_evaluacion_table', 1010),
	(251, '2026_02_03_182431_update_obligaciones_states_enum', 1011),
	(252, '2026_02_04_180000_change_aea_requisito_to_text_in_auditoria_agenda_table', 1012),
	(253, '2026_02_06_103326_create_sugerencia_movimientos_table', 1012),
	(254, '2026_02_06_110709_create_salida_no_conforme_movimientos_table', 1013),
	(255, '2026_02_06_110721_add_observacion_to_salidas_no_conformes_table', 1013),
	(256, '2026_02_06_162126_modify_snc_estado_in_salidas_no_conformes_table', 1014),
	(257, '2026_02_09_104425_add_cumplimiento_fields_to_obligaciones_table', 1015),
	(258, '2026_02_10_130542_add_programada_hours_to_auditoria_equipo', 1016),
	(259, '2026_02_10_132211_refactor_auditoria_equipo_agenda_tables', 1016),
	(260, '2026_02_10_141726_add_horas_ejecutadas_to_auditoria_equipo', 1017),
	(261, '2026_02_10_151150_add_avance_and_cleanup_auditoria_especifica', 1018),
	(262, '2026_02_10_160638_change_aea_requisito_to_longtext_in_auditoria_agenda', 1019),
	(264, '2026_02_10_174919_refactor_normas_auditables_table', 1020);
...
-- Volcando datos para la tabla kallpaq.model_has_roles: ~39 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `normas_auditables` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `na_sistema` varchar(255) DEFAULT NULL,
  `na_nombre` varchar(255) NOT NULL,
  `na_descripcion` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
REPLACE INTO `normas_auditables` (`id`, `na_sistema`, `na_nombre`, `na_descripcion`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 'sgc', 'ISO 9001:2025', 'Sistema de Gestión de la Calidad', '2026-01-16 19:54:10', '2026-01-16 19:54:10', NULL),
	(2, 'sgas', 'ISO 37001:2025', 'Sistema de Gestión Antisborno', '2026-01-16 19:54:55', '2026-01-16 19:54:55', NULL),
	(3, 'sgcm', 'ISO 37301:2022', 'Sistema de Gestión de Cumplimiento', '2026-01-16 19:55:46', '2026-01-16 19:55:46', NULL),
	(4, 'sgco', 'ISO 21001:2025', 'Sistema de Gestión de la Calidad en Organizaciones Educativas', '2026-01-16 19:58:37', '2026-01-16 19:58:37', NULL),
	(5, 'sgsi', 'ISO 27001:2022', 'Sistema de Seguridad de la Información', '2026-02-10 23:14:56', '2026-02-10 23:14:56', NULL);
...
-- Volcando datos para la tabla kallpaq.norma_requisitos: ~134 rows (aproximadamente)
REPLACE INTO `norma_requisitos` (`nr_id`, `nr_norma_id`, `nr_numeral`, `nr_denominacion`, `nr_detalle`, `created_at`, `updated_at`) VALUES
	...
	(114, 5, '4.1', 'Comprensión de la organización y su contexto', 'La organización debe determinar las cuestiones externas e internas que son relevantes para su propósito y que afectan su capacidad para lograr los resultados previstos de su SGSI.', '2026-02-10 23:14:56', '2026-02-10 23:14:56'),
	(115, 5, '4.2', 'Comprensión de las necesidades y expectativas de las partes interesadas', 'La organización debe determinar las partes interesadas relevantes para el SGSI y las necesidades y expectativas de estas partes interesadas.', '2026-02-10 23:14:56', '2026-02-10 23:14:56'),
	(116, 5, '4.3', 'Determinar el alcance del SGSI', 'La organización debe determinar los límites y la aplicabilidad del SGSI para establecer su alcance.', '2026-02-10 23:14:56', '2026-02-10 23:14:56'),
	(117, 5, '4.4', 'Sistema de gestión de la seguridad de la información', 'La organización debe establecer, implementar, mantener y mejorar continuamente un SGSI de acuerdo con los requisitos de esta norma.', '2026-02-10 23:14:56', '2026-02-10 23:14:56'),
	(118, 5, '5.1', 'Liderazgo y compromiso', 'La alta dirección debe demostrar liderazgo y compromiso con respecto al SGSI.', '2026-02-10 23:14:56', '2026-02-10 23:14:56'),
	(119, 5, '5.2', 'Política de seguridad de la información', 'La alta dirección debe establecer una política de seguridad de la información que sea adecuada al propósito de la organización.', '2026-02-10 23:14:56', '2026-02-10 23:14:56'),
	(120, 5, '5.3', 'Roles, responsabilidades y autoridades', 'La organización debe asegurarse de que se asignen roles, responsabilidades y autoridades para el SGSI.', '2026-02-10 23:14:56', '2026-02-10 23:14:56'),
	(121, 5, '6.1', 'Acciones para abordar riesgos y oportunidades', 'La organización debe planificar acciones para abordar los riesgos y oportunidades que puedan afectar el SGSI.', '2026-02-10 23:14:56', '2026-02-10 23:14:56'),
	(122, 5, '6.2', 'Objetivos de seguridad de la información y planificación para lograrlos', 'La organización debe establecer objetivos de seguridad de la información que sean coherentes con la política de seguridad de la información.', '2026-02-10 23:14:56', '2026-02-10 23:14:56'),
	(123, 5, '7.1', 'Recursos', 'La organización debe determinar y proporcionar los recursos necesarios para establecer, implementar, mantener y mejorar el SGSI.', '2026-02-10 23:14:56', '2026-02-10 23:14:56'),
	(124, 5, '7.2', 'Competencia', 'La organización debe asegurarse de que las personas que realizan tareas que afectan la seguridad de la información sean competentes.', '2026-02-10 23:14:56', '2026-02-10 23:14:56'),
	(125, 5, '7.3', 'Toma de conciencia', 'La organización debe asegurarse de que las personas que trabajan bajo su control sean conscientes de la política de seguridad de la información.', '2026-02-10 23:14:56', '2026-02-10 23:14:56'),
	(126, 5, '7.4', 'Comunicación', 'La organización debe determinar qué comunicar, cuándo, con quién y cómo en relación con el SGSI.', '2026-02-10 23:14:56', '2026-02-10 23:14:56'),
	(127, 5, '7.5', 'Información documentada', 'La organización debe crear y mantener la información documentada requerida por el SGSI.', '2026-02-10 23:14:56', '2026-02-10 23:14:56'),
	(128, 5, '8.1', 'Operación', 'La organización debe planificar, implementar y controlar los procesos necesarios para cumplir los requisitos del SGSI.', '2026-02-10 23:14:56', '2026-02-10 23:14:56'),
	(129, 5, '8.2', 'Evaluación de riesgos de seguridad de la información', 'La organización debe llevar a cabo evaluaciones de riesgos de seguridad de la información de manera sistemática.', '2026-02-10 23:14:56', '2026-02-10 23:14:56'),
	(130, 5, '8.3', 'Tratamiento de riesgos de seguridad de la información', 'La organización debe determinar y aplicar los tratamientos de riesgos de seguridad de la información.', '2026-02-10 23:14:56', '2026-02-10 23:14:56'),
	(131, 5, '9.1', 'Monitoreo, medición, análisis y evaluación', 'La organización debe determinar qué monitorear y medir, así como los métodos para hacerlo.', '2026-02-10 23:14:56', '2026-02-10 23:14:56'),
	(132, 5, '9.2', 'Revisión por la dirección', 'La alta dirección debe llevar a cabo revisiones periódicas del SGSI para asegurarse de su idoneidad y eficacia.', '2026-02-10 23:14:56', '2026-02-10 23:14:56'),
	(133, 5, '10.1', 'No conformidad y acción correctiva', 'La organización debe reaccionar ante las no conformidades y tomar acciones para controlarlas y corregirlas.', '2026-02-10 23:14:56', '2026-02-10 23:14:56'),
	(134, 5, '10.2', 'Mejora continua', 'La organización debe mejorar continuamente la idoneidad, adecuación y eficacia del SGSI.', '2026-02-10 23:14:56', '2026-02-10 23:14:56');
...
CREATE TABLE IF NOT EXISTS `obligaciones` (
  ...
  `obligacion_documento` text DEFAULT NULL,
  `obligacion_principal` text NOT NULL,
  `obligacion_fecha_identificacion` date DEFAULT NULL,
  `obligacion_consecuencia` text DEFAULT NULL,
  `obligacion_documento_deroga` text DEFAULT NULL,
  `obligacion_estado` enum('identificada','evaluada','en_tratamiento','controlada','no_controlada','suspendida','inactiva') DEFAULT 'identificada',
  `obligacion_tipo` enum('legal','contractual','voluntaria') DEFAULT 'legal',
  `obligacion_frecuencia` int(11) DEFAULT NULL,
  `cumplimiento` enum('pendiente','cumplida','parcialmente_cumplida','no_cumplida') NOT NULL DEFAULT 'pendiente',
  `fecha_cumplimiento` date DEFAULT NULL,
  `comentario_cumplimiento` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `obligaciones_subarea_compliance_id_foreign` (`subarea_compliance_id`),
  ...
  CONSTRAINT `obligaciones_subarea_compliance_id_foreign` FOREIGN KEY (`subarea_compliance_id`) REFERENCES `subareas_compliance` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=57 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Volcando datos para la tabla kallpaq.obligaciones: ~48 rows (aproximadamente)
REPLACE INTO `obligaciones` (`id`, `area_compliance_id`, `subarea_compliance_id`, `radar_id`, `documento_id`, `obligacion_documento`, `obligacion_principal`, `obligacion_fecha_identificacion`, `obligacion_consecuencia`, `obligacion_documento_deroga`, `obligacion_estado`, `obligacion_tipo`, `obligacion_frecuencia`, `cumplimiento`, `fecha_cumplimiento`, `comentario_cumplimiento`, `created_at`, `updated_at`) VALUES
	(2, 4, 18, NULL, NULL, 'Directiva N° 003-2024-CG/GJNC “Gestión Normativa en la Contraloría General de la República”, aprobada con Resolución de Contraloría N° 159-2024-CG.', 'Asegurar que la documentación de los procesos se realice de manera transversal y secuencial para satisfacer las necesidades y expectativas de las partes interesadas.', '2025-02-02', 'La ausencia de una documentación adecuada y estructurada de los procesos puede acarrear insatisfacción entre las partes interesadas, comprometiendo la transparencia y la eficiencia operativa, así como el cumplimiento de las normativas vigentes. Esta deficiencia puede generar riesgos significativos para la organización, tales como la erosión de la confianza, la ineficacia en la toma de decisiones y la exposición a sanciones regulatorias. Es imperativo establecer un enfoque sistemático y secuencial en la documentación de los procesos para satisfacer las expectativas de las partes interesadas y garantizar la integridad operativa y el cumplimiento normativo.', NULL, 'evaluada', 'legal', 120, 'pendiente', NULL, NULL, '2025-02-25 17:55:11', '2026-02-05 00:53:24'),
	(4, 13, NULL, NULL, NULL, 'Normas ISO 19011, ISO 9001, ISO 37001, ISO 37301.', 'Programación y ejecución de auditorías para la evaluación de la eficacia del Sistema Integrado de Gestión', '2025-02-02', 'Perdida de los certificados, daño a la reputación institucional y desconfianza de la ciudadanía', NULL, 'identificada', 'voluntaria', NULL, 'pendiente', NULL, NULL, '2025-02-25 23:13:09', '2025-03-24 20:49:01'),
	(5, 14, NULL, NULL, NULL, 'Norma ISO 9001:2015, Sistemas de gestión de la Calidad – Requisitos', 'Cumplir con los requisitos dispuestos por la norma internacional ISO 9001:2015', '2025-02-02', '"Menoscabo de la reputación institucional y erosión de la confianza pública, resultantes del incumplimiento de los requisitos establecidos por la norma internacional ISO 9001:2015."', NULL, 'identificada', 'contractual', NULL, 'pendiente', NULL, NULL, '2025-02-25 23:15:20', '2026-02-03 21:17:37'),
	(6, 14, NULL, NULL, NULL, 'Norma ISO 31000:2018, Gestión del riesgo,  \r\nDirectiva N° 017-2020 “Gestión del riesgo en la Contraloría General de la República”.', 'Planificar, identificar, analizar, evaluar e identificar los riesgos que afecten los cumplimientos de los objetivos institucionales', '2025-02-02', 'Disminución en la capacidad de la organización para cumplir con los objetivos institucionales, lo que podría comprometer el éxito de los proyectos y la satisfacción de los ciudadanos.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-02-25 23:17:01', '2025-02-26 17:58:33'),
	(7, 14, NULL, NULL, NULL, 'Norma Técnica “Implementación de la Gestión por Procesos en las Entidades de la Administración Pública”, aprobada mediante RSGP N° 002-2025-PCM/SGP.', 'Cumplir con los requisitos dispuestos por la norma internacional', '2025-02-02', 'Impacto en la calidad de los servicios prestados y consecuente pérdida de la confianza y reputación ante los ciudadanos', NULL, 'identificada', 'legal', NULL, 'pendiente', NULL, NULL, '2025-02-25 23:17:51', '2025-03-26 16:00:47'),
	(8, 14, NULL, NULL, NULL, 'Norma ISO 37301:2021, Sistemas de gestión del compliance – Requisitos con orientación para su uso.', 'Cumplir con los requisitos dispuestos por la norma internacional', '2025-02-02', 'Daño a la reputación institucional y desconfianza de la ciudadanía', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-02-25 23:18:06', '2025-03-26 15:57:21'),
	(10, 14, NULL, NULL, NULL, 'Directiva No 013-2023-CG/GAD Requerimiento,\r\notorgamiento y rendición de viáticos por comisión de servicio para la Contraloría General de la Republica.', 'Atención de los requerimientos de viáticos\r\ndentro del plazo establecido.\r\nRealización de la rendición de los viáticos\r\ndentro del plazo establecido.\r\nEvaluación de la rendición de viáticos.', '2025-02-02', 'Saldos elevados pendientes de rendir en la cuenta\r\ncontable "Otras entregas a rendir cuenta".', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-02-28 00:15:48', '2025-02-28 00:17:03'),
	(11, 14, NULL, NULL, NULL, 'Ley No 27619, Ley que regula la autorización de viajes al exterior de servidores y funcionarios públicos y modificatorias.', 'Atención de los requerimientos de viáticos de viajes al exterior de acuerdo a la escala proporcionada en este decreto supremo.', '2025-02-02', 'Atención fuera de tiempo del requerimiento de viáticos al exterior y reclamos por parte de los comisionados.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-02-28 00:26:02', '2025-02-28 00:26:02'),
	(12, 14, NULL, NULL, NULL, 'Resolución Directoral N.º 004-2009-EF/77.15 que aprueba la Modificación del art. 40 de la Directiva de Tesorería N.º 001-2007-EF/77.15.', 'Autorización el requerimiento de anticipos mediante Resolución de la Gerencia de\r\nAdministración.\r\nRegistro de la rendición de cuentas del anticipo\r\nen el SIAF.\r\nPlazos para rendición del anticipo de 03 días hábiles, luego de concluida la ejecución del gasto.', '2025-02-02', 'Incumplimiento de las actividades programadas por parte del usuario y posibles reclamos.', NULL, 'identificada', 'legal', NULL, 'pendiente', NULL, NULL, '2025-02-28 00:48:46', '2025-02-28 00:48:46'),
	(13, 14, NULL, NULL, NULL, 'Resolución Directoral N.º 040-2011-EF/52.03, que ha\r\nestablecido el monto máximo para el otorgamiento de Encargos al Personal de la Institución.', 'Establece monto máximo para el otorgamiento\r\nde anticipos.', '2025-04-02', 'Observaciones en las auditorías anuales a la cuenta.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-02-28 18:58:57', '2025-02-28 18:58:57'),
	(14, 14, NULL, NULL, NULL, '-Resolución de Superintendencia No 007-99-SUNAT, Reglamento de comprobantes de Pago y sus modificatorias.\r\n-Resolución de Superintendencia N.º 037-2002/SUNAT, que aprueba el Régimen de Retenciones del IGV aplicables a los proveedores y designación de agentes de retención y sus modificatorias.\r\n-Resolución de Superintendencia N.º 183-2004/SUNAT, que aprueba normas para la aplicación del Sistema de Pago de Obligaciones Tributarias con el Gobierno Central al que se refiere el Decreto Legislativo N.º 940 y sus modificatorias.\r\n-Resolución de Superintendencia N.º 287-2014/SUNAT, que modifica la Resolución de Superintendencia Nº182- 2014/SUNAT y modificatoria que implementó la emisión electrónica de recibo de honorarios.', '-Verificar que los comprobantes de pagos cuenten con las especificaciones determinadas por SUNAT.\r\n-Verificación de la aplicación de retenciones a\r\nlos comprobantes de pago, en los casos correspondientes.\r\n-Verificación de la aplicación de detracciones a\r\nlos comprobantes de pago, en los casos correspondientes.\r\n-Verificar que los recibos por honorarios que\r\nforman parte de la rendición de cuentas sean electrónicos.', '2025-04-02', 'El incumplimiento de las obligaciones tributarias puede generar responsabilidades administrativas, sanciones y afectar la reputación de la institución.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-02-28 19:43:36', '2025-02-28 19:46:11'),
	(15, 14, NULL, NULL, NULL, 'Resolución Directoral N°008-2024-EF/52.01 que aprueba la Directiva N°003-2024-EF/52.06 "Directiva para el manejo de la Caja Chica".\r\n-Directiva N°001-2025-CG/GAD "Normas para la Apertura, Gestión y Liquidación de la Caja Chica" (periodicidad anual).', 'Apertura de Caja Chica de manera oportuna', '2025-04-02', 'No se pueden ejecutar gastos por caja chica.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-02-28 19:53:23', '2025-02-28 19:53:23'),
	(16, 14, NULL, NULL, NULL, 'Resolución Directoral N°008-2024-EF/52.01 que aprueba la Directiva N°003-2024-EF/52.06 "Directiva para el manejo de la Caja Chica". -Directiva N°001-2025-CG/GAD "Normas para la Apertura, Gestión y Liquidación de la Caja Chica" (periodicidad anual).', 'Pago por caja chica de gastos que cumplan con\r\nlos requisitos establecidos', '2025-02-02', 'No reconocimiento de gastos ejecutados que incumplan la normativa.\r\nFalta de disponibilidad de efectivo por la demora en la subsanación de observaciones del expediente de rendición de cuentas.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-02-28 20:43:37', '2025-02-28 20:43:37'),
	(17, 14, NULL, NULL, NULL, 'Resolución Directoral N°008-2024-EF/52.01 que aprueba la Directiva N°003-2024-EF/52.06 "Directiva para el manejo de la Caja Chica". -Directiva N°001-2025-CG/GAD "Normas para la Apertura, Gestión y Liquidación de la Caja Chica" (periodicidad anual).', 'Validar que el expediente de rendición de caja chica cumpla con las especificaciones establecidas en la normativa para la reposición correspondiente.', '2025-04-02', 'No atención de gastos urgentes, debido a la falta de liquidez por la demora de la reposición.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-02-28 20:46:25', '2025-02-28 20:46:25'),
	(18, 14, NULL, NULL, NULL, 'Resolución Directoral N°008-2024-EF/52.01 que aprueba la Directiva N°003-2024-EF/52.06 "Directiva para el manejo de la Caja Chica". -Directiva N°001-2025-CG/GAD "Normas para la Apertura, Gestión y Liquidación de la Caja Chica" (periodicidad anual).', 'Liquidación final de Caja Chica dentro del plazo\r\nestablecido.', '2025-04-02', 'Emisión de los estados financieros y presupuestarios con observaciones', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-02-28 20:49:40', '2025-02-28 20:49:40'),
	(19, 14, NULL, NULL, NULL, 'Decreto Legislativo Nº 1439, Decreto Legislativo del Sistema Nacional de Abastecimiento.', 'Decreto Legislativo que genera obligación de: Revisar y/o validar el Acta de Conciliación de Bienes y Suministros de manera mensual con la\r\nSubgerencia de Abastecimiento, con las \r\n suscripciones de las áreas usuarias\r\n(Abastecimiento y Contabilidad).', '2025-04-02', 'Observación en la auditoría financiera.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-02-28 20:58:53', '2025-02-28 20:58:53'),
	(20, 14, NULL, NULL, NULL, 'Decreto Legislativo Nº 1440, Decreto Legislativo del Sistema Nacional de Presupuesto Público.', 'Decreto Legislativo que genera obligación de:\r\n- Revisar y/o validar el Acta de Conciliación del\r\nMarco Legal y Ejecución del Presupuesto, con\r\nlas suscripciones de Contabilidad y Presupuesto', '2025-02-02', 'Observación en la auditoría financiera.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-02-28 21:00:00', '2025-02-28 21:00:00'),
	(21, 14, NULL, NULL, NULL, 'Decreto Legislativo Nº 1441, Decreto Legislativo del Sistema Nacional de Tesorería.', 'Decreto Legislativo que genera obligación de:\r\n- Revisar y/o validar el Acta de Conciliación con\r\nUnidad de Tesorería sobre cuentas corrientes y\r\ncon la Cuenta Única del Tesoro Púbico con la\r\nfuente de financiamiento que corresponda.', '2025-02-02', 'Observación en la auditoría financiera.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-02-28 21:00:58', '2025-02-28 21:00:58'),
	(22, 14, NULL, NULL, NULL, 'Decreto Supremo N° 057-2022-EF, Aprueban Texto Único Ordenado del Decreto Legislativo N° 1438 Decreto Legislativo del Sistema Nacional de Contabilidad.\r\nInstructivo Nº003-2024-EF/51.01, Resolución Directoral Nº 007-2024-\r\nEF/51.01.Instructivo para la presentación de la información financiera e\r\ninformación presupuestaria de las entidades del sector público durante el proceso\r\nde transición al Marco de las Normas Internacionales de Contabiliad del Sector\r\nPúblico.\r\nInstructivo Nº004-2024-EF/51.01, Resolución Directoral Nº 011-2024-EF/51.01\r\n"Manual de adopción por primera vez del Marco de las Normas Internacionales de\r\nContabilidad del Sector Público"', 'Decreto Legislativo que genera obligación de:\r\nElaboración de los Estados Financieros y Estados Presupuestarios de la entidad, y los plazos de presentación.', '2025-04-02', 'La CGR puede ser considerada omisa ante la DGCP.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-02-28 21:02:22', '2025-02-28 21:04:43'),
	(23, 14, NULL, NULL, NULL, 'Resolución Jefatural N° 107-2023-AGN/JEF, que aprueba la Directiva N° 001-2023-AGN/DDPA “Norma de administración de archivos en las entidades públicas”.', 'Se establece disposiciones para la Elaboración y actualización de normativa que regule los procesos archivísticos.', '2025-04-02', 'Posibles observaciones por parte del Archivo General de la Nación a los Informes Técnicos de Evaluación de Actividades Archivísticos Ejecutadas (ITEA) anuales por ausencia y/o desactualización de normativa archivística para la CGR.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-05 23:33:53', '2025-03-05 23:33:53'),
	(24, 14, NULL, NULL, NULL, 'Resolución Jefatural N°010-2020-AGN/J, que aprueba la Directiva N° 001-2020-AGN/DDPA “Norma para Servicios Archivísticos en la Entidad Pública".', 'Se establece el cumplimiento de brindar acceso a los documentos archivados considerando las restricciones por confidencialidad, datos personales y grado de deterioro del documento solicitado.', '2025-02-02', 'Violación de la confidencialidad, posibles sanciones por filtración de información, pérdida de confianza y reputación de la entidad, y afectación a los derechos de los involucrados. Denuncias por incidentes en uso de documentación que custodia los archivos de la CGR con carácter confidencial.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-05 23:36:53', '2025-03-05 23:36:53'),
	(25, 14, NULL, NULL, NULL, 'Resolución Jefatural N° 304-2019-AGN/J, que aprueba la Directiva N° 001-2019-AGN/DC “Norma para la conservación de documentos en los archivos administrativos Sector Público Nacional”', 'Se establece los cumplimientos para adoptar medidas de conservación en lo referente a la sede o local, contenedores y mobiliario, conservación del soporte o medio físico, control de condiciones medioambientales y biológicos y preservación digital.', '2025-02-02', 'Perdida o deterioro de documentos en el archivo.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-05 23:39:51', '2025-03-05 23:39:51'),
	(26, 14, NULL, NULL, NULL, 'Resolución de Contraloría N" 220-2024-CG, que aprueba el Programa de Control de Documentos Archivísticos (PCDA) de la Contraloría General de la República.', 'Se establece obligaciones para custodiar la documentación remitida por las unidades de organización al cumplirse el plazo de retención en el archivo de gestión y por series documentales.', '2025-04-02', 'Dificultades en el proceso de eliminación de \r\ndocumentos con valor temporal y la gestión a realizar ante el Archivo General de la Nación. Resguardo deficiente en el archivo de los documentos con valor permanente.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-05 23:40:55', '2025-03-05 23:40:55'),
	(27, 14, NULL, NULL, NULL, 'Resolución Jefatural N°242-2018-AGN/J, que aprueba la Directiva N° 001-2018-AGN/DAI “Norma para la eliminación de documentos de archivo del sector público".', 'Se establece la obligación de presentar cronograma de eliminación de documentos en el Plan Anual de Trabajo Archivístico. - Solicitar al AGN o AR la autorización de eliminación a través del PCDA o Comité Evaluador de Documentos.', '2025-02-02', 'Observaciones del Archivo General de la Nación por la inadecuada conservación de los documentos y mantenimiento de documentación fuera del plazo de retención establecido en el Programa de Control de Documentos Archivísticos de CGR.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-05 23:42:16', '2025-03-05 23:42:16'),
	(28, 14, NULL, NULL, NULL, 'Contrato de préstamo N° 4724/OC-PE', 'Establece los mecanismos, procedimientos, instancias, responsabilidades y nomas que debe impartirse para la ejecución del proyecto, en al cual es de obligatorio el cumplimiento', '2025-02-02', 'Posible retraso en la ejecucion del proyecto', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-06 14:02:40', '2025-03-06 14:02:40'),
	(29, 14, NULL, NULL, NULL, 'Contrato de préstamo N° 4724/OC-PE', 'Establece los acuerdos contractuales del préstamo para la ejecución del proyecto BID 3.', '2025-02-02', 'Posible suspensión en la ejecucion del proyecto', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-06 14:03:38', '2025-03-06 14:03:38'),
	(30, 14, NULL, NULL, NULL, 'Políticas BID para la Selección y Contratación de Consultores Financiados por el Banco Interamericano de Desarrollo. GN-2350-15', 'Establece las políticas de selección y contratación de consultores Financiados por el BID, en el marco del desarrollo del proyecto BID 3.', '2025-04-02', 'Posible retraso en la ejecucion del proyecto', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-06 14:04:20', '2025-03-24 22:28:43'),
	(31, 14, NULL, NULL, NULL, 'Políticas BID para la Adquisición de Bienes y Obras financiadas por el Banco Interamericano de Desarrollo. GN-2349-15', 'Establece las políticas para la adquisición de bienes y obras financiadas por el BID, en el marco del desarrollo del proyecto BID', '2025-04-02', 'Posible retraso en la ejecucion del proyecto', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-06 14:04:57', '2025-03-06 14:04:57'),
	(32, 14, NULL, NULL, NULL, 'Normas Técnicas de CEPLAN, Procedimiento PR-PEI-01', 'Alinear el planeamiento estratégico de la CGR al Plan Nacional de Desarrollo e implementar las políticas institucionales de la CGR', '2025-04-02', 'Falta de implementación de la Política Institucional', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-24 21:34:46', '2025-03-24 21:34:46'),
	(33, 14, NULL, NULL, NULL, 'Directiva N° 001-2024 - CEPLAN/PCD Directiva General de Planeamiento Estrtaégico\r\nComunicado de CEPLAN-Dirección General de Abastecimiento del MEF', 'Alcanzar a la Subgerencia de Abastecimiento el archivo "TXT" con la programación operativa para el siguiente año, en el plazo establecido por CEPLAN-DGA del MEF (primera quincena del mes de marzo del año anterior)', '2025-04-02', 'Incumplimiento de la elaboración oportuna del Cuadro de Necesidades antes de la quincena del mes de marzo del año anterior. Percepción inadecuada de transparencia e integridad al no tomar en cuenta la Directiva de CEPLAN', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-24 21:38:41', '2025-03-24 21:38:41'),
	(34, 14, NULL, NULL, NULL, 'Guía para el seguimiento y evaluación de políticas nacionales y planes del SINAPLAN\r\n(PR-POI-02) Procedimiento Seguimiento y evaluación del Plan Operativo Institucional y del Plan Nacional de Control', 'Aprobar el Plan Operativo Institucional Multianual dentro del plazo establecido, antes del 30 de abril del año anterior', '2025-02-02', 'Afectación del prestigio y transparencia de la Contraloría General', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-24 21:40:12', '2025-03-24 21:40:12'),
	(35, 14, NULL, NULL, NULL, 'Guía para el seguimiento y evaluación de políticas nacionales y planes del SINAPLAN (PR-POI-02) Procedimiento Seguimiento y evaluación del Plan Operativo Institucional y del Plan Nacional de Control', 'Efectuar el Seguimiento del Plan Operativo Institucional en el aplicativo CEPLAN antes del día 20 del mes del siguiente mes', '2025-02-02', 'Instancias competentes no cuenten con información oportuna para la toma de decisiones', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-24 21:41:07', '2025-03-24 21:41:07'),
	(36, 14, NULL, NULL, NULL, 'Guía para el seguimiento y evaluación de políticas nacionales y planes del SINAPLAN (PR-POI-02) Procedimiento Seguimiento y evaluación del Plan Operativo Institucional y del Plan Nacional de Control', 'Efectuar la Evaluación Trimestral del Plan Operativo Institucional Anual', '2025-08-02', 'Incumplimiento de elaborar la Evaluación del Plan Operativo Institucional a más tardar el siguiente mes de concluido el trimestre', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-24 21:42:01', '2025-03-24 21:42:01'),
	(37, 13, NULL, NULL, NULL, 'Resolución de Contraloría N° 229-2022-CG que actualiza la Política de Gestión Antisoborno de la Contraloría General de la República', 'Cumplir con la Política y Objetivos de Gestión Antisoborno de la Contraloría General de la República', '2025-08-02', 'Incumplimiento de la norma ISO 37001:2016 y tener no conformidades.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-24 21:45:41', '2025-03-24 21:45:41'),
	(38, 13, NULL, NULL, NULL, 'Norma ISO 37001:2016, Sistemas de gestión antisoborno – Requisitos con orientación para su uso.', 'Cumplir con los requisitos dispuestos por la norma internacional ISO 37001:2016', '2025-08-02', 'Incumplimiento de la norma ISO 37001:2016 y tener no conformidades.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-24 21:47:12', '2025-03-24 21:47:12'),
	(39, 13, NULL, NULL, NULL, 'Política Nacional de Integridad y Lucha contra la Corrupción, aprobado mediante Decreto Supremo 092-2017-PCM.\r\nResolución de Contraloría N° 287-2021-CG, aprueba la Política de Integridad y ética Pública para los funcionarios y servidores públicos de la Contraloría General de la República y de los Órganos de Control Institucional.', 'Cumplir con las orientaciones vigentes descritas en la Política Nacional de Integridad y Lucha contra la Corrupción.\r\nCumplir con las orientaciones vigentes descritas en la Política de Integridad y ética Pública para los funcionarios y servidores públicos de la Contraloría General de la República y de los Órganos de Control Institucional.', '2025-08-02', 'Nivel del Índice de Capacidad Preventiva (ICP) frente a la corrupción disminuido.\r\nNo obtener premio de ICP el próximo año.\r\nNivel de confianza en la labor de la Contraloría disminuido.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-24 22:38:53', '2025-03-24 22:38:53'),
	(40, 13, NULL, NULL, NULL, 'Decreto Supremo N° 044-2018-PCM, Aprueba el Plan Nacional de Integridad y Lucha contra la Corrupción 2018-2021.\r\nResolución de secretaría de integridad pública 002-2021-PCM-SIP que aprueba la Directiva N 002-2021-PCM-SIP Lineamiento para establecer una cultura de integridad en las entidades del sector publico.\r\nDecreto Supremo N° 180-2021-PCM, Decreto Supremo que aprueba la Estrategia de Integridad del Poder Ejecutivo al 2022 para la Prevención de Actos de Corrupción.\r\nDecreto Supremo N° 148-2024-PCM, Decreto Supremo que aprueba el Modelo de Integridad para fortalecer la capacidad de prevención y respuesta frente a la corrupción en las entidades del sector público.', 'Cumplir y realizar el seguimiento de las orientaciones vigentes de cada uno de los nueve componentes del Modelo de Integridad, así como su supervisión.\r\nImpulsar actividades estratégicas de los componentes establecidos en el DS.', '2025-08-02', 'Nivel del Índice de Capacidad Preventiva (ICP) frente a la corrupción disminuido.\r\nNo obtener premio de ICP el próximo año.\r\nNivel de confianza en la labor de la Contraloría disminuido.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-24 22:40:20', '2025-03-24 22:40:20'),
	(41, 14, NULL, NULL, NULL, 'Decreto Legislativo N° 1327, que establece medidas de protección para el denunciante de actos de corrupción y sanciona las denuncias realizadas de mala fe.', 'Evaluar preliminarmente las denuncias, verificando el cumplimiento de los requisitos establecidos en las normas, y derivarlas a las instancias respectivas, según corresponda.', '2025-08-02', 'Afectación de la gestión de denuncias.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-24 22:53:53', '2025-03-24 22:53:53'),
	(42, 14, NULL, NULL, NULL, 'Decreto Supremo N° 010-2017-JUS, que aprueba el Reglamento del Decreto Legislativo N° 1327 que establece medidas de protección al denunciante de actos de corrupción y sanciona las denuncias realizadas de mala fe.', 'Evaluar preliminarmente las denuncias, verificando el cumplimiento de los requisitos establecidos en las normas, y derivarlas a las instancias respectivas, según corresponda.', '2025-04-02', 'Afectación y pérdida de confianza de la gestión de denuncias.\r\nRiesgo en la seguridad, salud y vida del denunciante o de su familia.\r\nRiesgo de impunidad en el caso que amenazas contra el denunciante causen el retiro o el desistimiento de la denuncia.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-24 22:55:00', '2025-03-24 22:55:00'),
	(43, 14, NULL, NULL, NULL, 'Decreto Supremo N° 002-2020-JUS, que modifica el Reglamento del Decreto Legislativo Nº 1327 que establece medidas de protección al denunciante de actos de corrupción y sanciona las denuncias realizadas de mala fe.', 'Evaluar las solicitudes de medidas de protección, y otorgarlas según las normas establecidas y según corresponda.', '2025-04-02', 'Afectación de la gestión de denuncias.\r\nRiesgo en la seguridad personal y/o laboral, salud y vida del denunciante o de su familia', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-24 22:55:50', '2025-03-24 23:05:35'),
	(44, 14, NULL, NULL, NULL, 'Directiva N° 002-2023-PCM-SIP, Directiva para la gestión de denuncias y solicitudes de medidas de protección al denunciante de actos de corrupción recibidas a través de la plataforma digital única de denuncias al ciudadano, aprobada mediante la Resolución de Secretaría de Integridad Pública N° 005-2023-PCM-SIP.', 'Evaluar las solicitudes de medidas de protección, y otorgarlas según las normas establecidas y según corresponda.', '2025-02-02', '"Afectación y pérdida de confianza de la gestión de denuncias.\r\nRiesgo en la seguridad personal y/o laboral, salud y vida del denunciante o de su familia.\r\nRiesgo de impunidad en el caso de las amenazas contra el denunciante, que causen el retiro o desistimiento, o la ratificación de la denuncia."', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-24 23:03:11', '2025-03-24 23:04:44'),
	(45, 14, NULL, NULL, NULL, 'Directiva N° 009-2022-CG/DOC “Gestión Documental de la Contraloría General de la República”, aprobado con RC N° 169-2022-CG.\r\nTUPA de la Contraloría General de la República aprobado con RC N° 237-2022-CG.\r\nTUO de la Ley N° 27444, Ley del Procedimiento Administrativo General, aprobado por DS N° 004-2019-JUS.', 'Establece los criterios de recepción, emisión de documentos presentados en la CGR.', '2025-04-02', 'Incumplimiento de los plazos legales de atención y respuesta de los documentos por parte de las unidades orgánicas responsables de la evaluación, y posibles sanciones.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-24 23:53:44', '2025-03-24 23:53:44'),
	(46, 14, NULL, NULL, NULL, 'Manual de Documentos de Acceso Restringido de la Contraloría General de la República, aprobado con Resolución de Contraloría N° 091-2004-CG y modificatoria', 'Establece los requisitos de recepción y derivación de documentos, presentados y clasificados como reservados, secretos y confidenciales.', '2025-02-02', 'Violación de la confidencialidad, posibles sanciones por filtración de información, pérdida de confianza y reputación de la entidad', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-24 23:55:25', '2025-03-24 23:55:25'),
	(47, 14, NULL, NULL, NULL, '"Manual para Mejorar la Atención a la Ciudadanía" en las entidades de la Administración Pública, aprobado mediante RM N° 186-2015-PCM\r\nRSGP Nº 001-2015-PCM-SGP que aprueban los lineamientos para el proceso de implementación progresiva del Manual para Mejorar la Atención a la Ciudadanía en las entidades de la administración pública\r\nDirectriz para el uso de la Plataforma de Mesa de Partes Virtual de la Contraloría General de la República, aprobada mediante Resolución de Secretaría General N° 090-2020-CG/SGE', 'Garantizan el proceso de atención a la ciudadanía, a través de los canales de atención.', '2025-04-02', 'Inadecuada atención y orientación a la ciudadanía.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-24 23:56:57', '2025-03-24 23:56:57'),
	(48, 14, NULL, NULL, NULL, 'Directiva N° 013-2015-CG/GPROD “Presentación, procesamiento y archivo de Las declaraciones juradas de ingresos y de bienes y rentas de los funcionarios y servidores públicos del estado”, aprobado mediante RC N° 328-2015-CG.\r\nDirectiva N° 010-2018-CG/GDET “Declaraciones Juradas para la Gestión de Conflicto de Intereses”, aprobado mediante RC N° 480-2018-CG y sus modificatoria RC N° 063-2019-CG y RC N° 095-2020-CG.', 'Establece los requisitos para una correcta presentación de las declaraciones juradas, verificado por mesa de partes.', '2026-02-02', 'Incumplimiento de los plazos legales para la atención, derivación y trámite de las Declaraciones Juradas obligatorias de los servidores públicos y entidades.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-25 00:24:11', '2025-03-25 00:24:11'),
	(49, 14, NULL, NULL, NULL, 'Ley 29542 “Ley de Protección al Denunciante en el Ámbito Administrativo y de Colaboración Eficaz en el Ámbito Penal”', 'Ejecutar los requisitos de protección al denunciante al recibir la denuncia administrativa del usuario.', '2026-02-02', 'Violación de la confidencialidad, posibles sanciones por filtración de información, pérdida de confianza y reputación de la entidad, y afectación a los derechos de los involucrados. Denuncias por incidentes en uso de documentación que custodia los archivos de la CGR con carácter confidencial.', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-25 00:25:09', '2025-03-25 00:25:09'),
	(50, 14, NULL, NULL, NULL, 'Resolución jefatural N° 386.2002-INEI, que aprueba la Directiva N°016-2002-INEI/DTNP Normas técnicas para el almacenamiento y Respaldo de la Información procesada por las entidades de la Administración Pública.', 'Tomar las medidas necesarias para proteger y salvaguardar la integridad de los respaldos de la información', '2026-02-02', 'No se logra recuperar la información requerida', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-25 00:35:57', '2025-03-25 00:35:57'),
	(51, 14, NULL, NULL, NULL, 'Contrato de servicio de correo electrónico (solución de respaldo)', 'Tomar las medidas necesarias para proteger y salvaguardar la integridad de los respaldos de la información de los correos electrónicos', '2026-02-02', 'No se logra recuperar la información requerida en un tiempo adecuado', NULL, 'identificada', NULL, NULL, 'pendiente', NULL, NULL, '2025-03-25 00:36:57', '2025-03-25 00:36:57');

-- Volcando estructura para tabla kallpaq.obligacion_control
CREATE TABLE IF NOT EXISTS `obligacion_control` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `obligacion_control_obligacion_id_foreign` (`obligacion_id`),
  KEY `obligacion_control_control_id_foreign` (`control_id`),
  CONSTRAINT `obligacion_control_control_id_foreign` FOREIGN KEY (`control_id`) REFERENCES `controles` (`id`) ON DELETE CASCADE,
  CONSTRAINT `obligacion_control_obligacion_id_foreign` FOREIGN KEY (`obligacion_id`) REFERENCES `obligaciones` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Volcando datos para la tabla kallpaq.obligacion_control: ~0 rows (aproximadamente)

-- Volcando estructura para tabla kallpaq.obligacion_evaluacion
CREATE TABLE IF NOT EXISTS `obligacion_evaluacion` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `obligacion_id` bigint(20) unsigned NOT NULL,
  `oe_puntaje_total` decimal(8,2) NOT NULL,
  `oe_nivel_criticidad` enum('baja','media','alta','muy_alta') NOT NULL,
  `oe_fecha_evaluacion` date NOT NULL,
  `oe_criterios_json` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`oe_criterios_json`)),
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `obligacion_evaluacion_obligacion_id_foreign` (`obligacion_id`),
  CONSTRAINT `obligacion_evaluacion_obligacion_id_foreign` FOREIGN KEY (`obligacion_id`) REFERENCES `obligaciones` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Volcando datos para la tabla kallpaq.obligacion_evaluacion: ~6 rows (aproximadamente)
REPLACE INTO `obligacion_evaluacion` (`id`, `obligacion_id`, `oe_puntaje_total`, `oe_nivel_criticidad`, `oe_fecha_evaluacion`, `oe_criterios_json`, `created_at`, `updated_at`) VALUES
	(1, 2, 13.00, 'alta', '2026-02-04', '{"impacto_legal":1,"impacto_institucional":1,"alcance":3,"frecuencia":3,"exigibilidad":5}', '2026-02-04 16:28:21', '2026-02-04 16:28:21'),
	(2, 2, 9.00, 'baja', '2026-02-09', '{"impacto_legal":1,"impacto_institucional":1,"alcance":3,"frecuencia":3,"exigibilidad":1}', '2026-02-09 21:14:27', '2026-02-09 21:14:27'),
	(3, 2, 13.00, 'media', '2026-02-09', '{"impacto_legal":1,"impacto_institucional":1,"alcance":3,"frecuencia":3,"exigibilidad":5}', '2026-02-09 21:14:35', '2026-02-09 21:14:35'),
	(4, 2, 9.00, 'baja', '2026-02-09', '{"impacto_legal":1,"impacto_institucional":1,"alcance":2,"frecuencia":3,"exigibilidad":2}', '2026-02-09 21:18:38', '2026-02-09 21:18:38'),
	(5, 2, 11.00, 'media', '2026-02-09', '{"impacto_legal":1,"impacto_institucional":1,"alcance":4,"frecuencia":3,"exigibilidad":2}', '2026-02-09 21:18:50', '2026-02-09 21:18:50'),
	(6, 2, 17.00, 'alta', '2026-02-09', '{"impacto_legal":1,"impacto_institucional":4,"alcance":4,"frecuencia":4,"exigibilidad":4}', '2026-02-09 21:19:13', '2026-02-09 21:19:13');

-- Volcando estructura para tabla kallpaq.obligacion_proceso
CREATE TABLE IF NOT EXISTS `obligacion_proceso` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `obligacion_proceso_obligacion_id_foreign` (`obligacion_id`),
  KEY `obligacion_proceso_proceso_id_foreign` (`proceso_id`),
  CONSTRAINT `obligacion_proceso_obligacion_id_foreign` FOREIGN KEY (`obligacion_id`) REFERENCES `obligaciones` (`id`) ON DELETE CASCADE,
  CONSTRAINT `obligacion_proceso_proceso_id_foreign` FOREIGN KEY (`proceso_id`) REFERENCES `procesos` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Volcando datos para la tabla kallpaq.obligacion_proceso: ~0 rows (aproximadamente)
REPLACE INTO `obligacion_proceso` (`id`, `obligacion_id`, `proceso_id`, `created_at`, `updated_at`) VALUES
	(1, 2, 45, NULL, NULL);
...
-- Volcando datos para la tabla kallpaq.ouo_user: ~29 rows (aproximadamente)
REPLACE INTO `ouo_user` (`id`, `ouo_id`, `user_id`, `role_in_ouo`, `activo`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(33, 36, 1, 'facilitador', 1, NULL, NULL, NULL);
...
-- Volcando datos para la tabla kallpaq.ouo_user_movimientos: ~34 rows (aproximadamente)
REPLACE INTO `ouo_user_movimientos` (`id`, `ouo_user_id`, `cambiado_por`, `tipo_anterior`, `tipo_nuevo`, `motivo`, `fecha_cambio`) VALUES
	...
	(36, 33, 1, NULL, 'facilitador', 'Asignación masiva inicial', '2026-01-26 12:58:53');
...
-- Volcando datos para la tabla kallpaq.password_reset_tokens: ~2 rows (aproximadamente)
REPLACE INTO `password_reset_tokens` (`email`, `token`, `created_at`) VALUES
	('lecheverria@contraloria.gob.pe', '$2y$10$WOqP9VX07GX6k24uOTvG0.VK./mwRnN0QYHQyz.jALeytf/pn0.L6', '2026-01-22 16:41:20'),
...
REPLACE INTO `permissions` (`id`, `name`, `description`, `guard_name`, `created_at`, `updated_at`) VALUES
	...
	(34, 'menu.obligaciones.mis_asignados', 'Ver Mis Obligaciones Asignadas', 'web', '2026-01-18 14:25:15', '2026-01-18 14:25:15'),
	...
	(37, 'menu.riesgos.mis_riesgos', 'Ver Mis Riesgos', 'web', '2026-01-18 14:25:15', '2026-01-18 14:25:15'),
	(38, 'menu.riesgos.mis_asignados', 'Ver Mis Riesgos Asignados', 'web', '2026-01-18 14:25:15', '2026-01-18 14:25:15'),
...
-- Volcando datos para la tabla kallpaq.procesos_ouo: ~26 rows (aproximadamente)
REPLACE INTO `procesos_ouo` (`id`, `id_proceso`, `id_ouo`, `propietario`, `delegado`, `ejecutor`, `sgc`, `sgas`, `sgcm`, `sgsi`, `sgco`, `created_at`, `updated_at`) VALUES
	...
	(328, 45, 36, 1, 0, 0, 1, 1, 1, 1, 1, NULL, NULL);
...
REPLACE INTO `programa_auditoria` (`id`, `pa_version`, `pa_anio`, `pa_recursos`, `pa_fecha_aprobacion`, `pa_estado`, `pa_objetivo_general`, `pa_alcance`, `pa_metodos`, `pa_criterios`, `avance`, `pa_descripcion`, `archivo_pdf`, `fecha_publicacion`, `created_at`, `updated_at`, `pa_riesgos`) VALUES
	(1, '01', '2026', '20000', '2026-01-16', 'Borrador', 'Programa Anual 2026', 'Incluye todas la Auditorias del Sistema de gestión', 'Entrevistas, muestreo, otros', 'Normas ISO, Procedimientos', 0.00, NULL, NULL, NULL, '2026-01-16 19:06:24', '2026-02-04 20:50:41', NULL);
...
-- Volcando datos para la tabla kallpaq.radar_normativo: ~52 rows (aproximadamente)
REPLACE INTO `radar_normativo` (`id`, `titulo`, `numero_norma`, `organismo_emisor`, `url_fuente`, `fecha_publicacion`, `resumen_ia`, `texto_completo`, `nivel_relevancia`, `estado`, `obligacion_principal`, `analisis_humano`, `created_at`, `updated_at`) VALUES
	...
	(164, 'RESOLUCION JEFATURAL N° 000020-2026-ANIN/JEF', 'RESOLUCION JEFATURAL N° 000020-2026-ANIN/JEF', 'PRESIDENCIA DEL CONSEJO DE MINISTROS', 'https://busquedas.elperuano.pe/dispositivo/NL/2481276-1', '2026-01-28', 'Autorizan transferencia financiera de la Autoridad Nacional de Infraestructura a favor de la Contraloría General de la República', 'Autorizan transferencia financiera de la Autoridad Nacional de Infraestructura a favor de la Contraloría General de la República', 'Baja', 'Pendiente', 'Autorizan transferencia financiera de la Autoridad Nacional de Infraestructura a favor de la Contraloría General de la República', NULL, '2026-01-28 15:31:05', '2026-01-28 15:31:05'),
	(165, 'RESOLUCION N° 015-2026-IMARPE/PE', 'RESOLUCION N° 015-2026-IMARPE/PE', 'PRODUCE', 'https://busquedas.elperuano.pe/dispositivo/NL/2481211-1', '2026-01-28', 'Autorizan transferencia financiera a favor de Pliego 019: Contraloría General de la República con cargo al Presupuesto Institucional del Pliego 240: Instituto del Mar del Perú – IMARPE para el ejercicio 2026', 'Autorizan transferencia financiera a favor de Pliego 019: Contraloría General de la República con cargo al Presupuesto Institucional del Pliego 240: Instituto del Mar del Perú – IMARPE para el ejercicio 2026', 'Baja', 'Pendiente', 'Autorizan transferencia financiera a favor de Pliego 019: Contraloría General de la República con cargo al Presupuesto Institucional del Pliego 240: Instituto del Mar del Perú – IMARPE para el ejercicio 2026', NULL, '2026-01-28 15:31:05', '2026-01-28 15:31:05'),
	(166, 'RESOLUCION DIRECTORAL N° 000001-2026-INACAL/DN', 'RESOLUCION DIRECTORAL N° 000001-2026-INACAL/DN', 'PRODUCE', 'https://busquedas.elperuano.pe/dispositivo/NL/2480482-1', '2026-01-28', 'Aprueban Normas Técnicas Peruanas sobre vehículos de carretera laboratorios clínicos requisitos de competencia para los asesores de gestión del riesgo explosivos y materiales relacionados de uso civil biológico y otros', 'Aprueban Normas Técnicas Peruanas sobre vehículos de carretera laboratorios clínicos requisitos de competencia para los asesores de gestión del riesgo explosivos y materiales relacionados de uso civil biológico y otros', 'Baja', 'Pendiente', 'Aprueban Normas Técnicas Peruanas sobre vehículos de carretera laboratorios clínicos requisitos de competencia para los asesores de gestión del riesgo explosivos y materiales relacionados de uso civil biológico y otros', NULL, '2026-01-28 15:31:05', '2026-01-28 15:31:05'),
	(167, 'RESOLUCION MINISTERIAL N° 032-2026-VIVIENDA', 'RESOLUCION MINISTERIAL N° 032-2026-VIVIENDA', 'VIVIENDA, CONSTRUCCIÓN Y SANEAMIENTO', 'https://busquedas.elperuano.pe/dispositivo/NL/2480918-1', '2026-01-28', 'Disponen publicación del proyecto de Decreto Supremo que modifica el Reglamento de la Ley N° 31056 Ley que amplía los plazos de la titulación de terrenos ocupados por posesiones informales y dicta medidas para la formalización aprobado por el Decreto Supremo N° 002-2021-VIVIENDA y de su Exposición de Motivos', 'Disponen publicación del proyecto de Decreto Supremo que modifica el Reglamento de la Ley N° 31056 Ley que amplía los plazos de la titulación de terrenos ocupados por posesiones informales y dicta medidas para la formalización aprobado por el Decreto Supremo N° 002-2021-VIVIENDA y de su Exposición de Motivos', 'Baja', 'Pendiente', 'Disponen publicación del proyecto de Decreto Supremo que modifica el Reglamento de la Ley N° 31056 Ley que amplía los plazos de la titulación de terrenos ocupados por posesiones informales y dicta medidas para la formalización aprobado por el Decreto Supremo N° 002-2021-VIVIENDA y de su Exposición de Motivos', NULL, '2026-01-28 15:31:05', '2026-01-28 15:31:05'),
	(168, 'RESOLUCION JEFATURAL N° 000024-2026-SIS/J', 'RESOLUCION JEFATURAL N° 000024-2026-SIS/J', 'SEGURO INTEGRAL DE SALUD', 'https://busquedas.elperuano.pe/dispositivo/NL/2481201-1', '2026-01-28', 'Aprueban el documento técnico denominado Anexo N° 01 -TARIFARIO DE PROCEDIMIENTOS MÉDICOS Y SANITARIOS DEL SEGURO INTEGRAL DE SALUD – 2026', 'Aprueban el documento técnico denominado Anexo N° 01 -TARIFARIO DE PROCEDIMIENTOS MÉDICOS Y SANITARIOS DEL SEGURO INTEGRAL DE SALUD – 2026', 'Media', 'Pendiente', 'Aprueban el documento técnico denominado Anexo N° 01 -TARIFARIO DE PROCEDIMIENTOS MÉDICOS Y SANITARIOS DEL SEGURO INTEGRAL DE SALUD – 2026', NULL, '2026-01-28 15:31:05', '2026-01-28 15:31:05'),
	(169, 'RESOLUCION N° 010-2026-CONCYTEC-P', 'RESOLUCION N° 010-2026-CONCYTEC-P', 'CONSEJO NACIONAL DE CIENCIA, TECNOLOGÍA E INNOVACIÓN TECNOLÓGICA', 'https://busquedas.elperuano.pe/dispositivo/NL/2481156-1', '2026-01-28', 'Aprueban transferencias financieras a entidades públicas y el otorgamiento de subvenciones a personas jurídicas privadas', 'Aprueban transferencias financieras a entidades públicas y el otorgamiento de subvenciones a personas jurídicas privadas', 'Baja', 'Pendiente', 'Aprueban transferencias financieras a entidades públicas y el otorgamiento de subvenciones a personas jurídicas privadas', NULL, '2026-01-28 15:31:05', '2026-01-28 15:31:05'),
	(170, 'RESOLUCION N° 0005-2025/CEB-INDECOPI-LOR', 'RESOLUCION N° 0005-2025/CEB-INDECOPI-LOR', 'INSTITUTO NACIONAL DE DEFENSA DE LA COMPETENCIA Y DE LA PROTECCION DE LA PROPIEDAD INTELECTUAL', 'https://busquedas.elperuano.pe/dispositivo/NL/2480500-1', '2026-01-28', 'Declaran barrera burocrática ilegal el Procedimiento N° 1 del TUPA del Gobierno Regional de Loreto aprobado por Ordenanza Regional N° 015-2019-GRL-CR', 'Declaran barrera burocrática ilegal el Procedimiento N° 1 del TUPA del Gobierno Regional de Loreto aprobado por Ordenanza Regional N° 015-2019-GRL-CR', 'Baja', 'Pendiente', 'Declaran barrera burocrática ilegal el Procedimiento N° 1 del TUPA del Gobierno Regional de Loreto aprobado por Ordenanza Regional N° 015-2019-GRL-CR', NULL, '2026-01-28 15:31:05', '2026-01-28 15:31:05'),
	(171, 'RESOLUCION N° 000012-2026/SUNAT', 'RESOLUCION N° 000012-2026/SUNAT', 'SUPERINTENDENCIA NACIONAL DE ADUANAS Y DE ADMINISTRACIÓN TRIBUTARIA', 'https://busquedas.elperuano.pe/dispositivo/NL/2480825-1', '2026-01-28', 'Modifican el procedimiento general Ejecución de acciones de control extraordinario CONTROL-PG.02 (versión 1)', 'Modifican el procedimiento general Ejecución de acciones de control extraordinario CONTROL-PG.02 (versión 1)', 'Baja', 'Pendiente', 'Modifican el procedimiento general Ejecución de acciones de control extraordinario CONTROL-PG.02 (versión 1)', NULL, '2026-01-28 15:31:05', '2026-01-28 15:31:05'),
	(172, 'RESOLUCION ADMINISTRATIVA N° 000058-2026-P-CSNJPE-PJ', 'RESOLUCION ADMINISTRATIVA N° 000058-2026-P-CSNJPE-PJ', 'CORTES SUPERIORES DE JUSTICIA', 'https://busquedas.elperuano.pe/dispositivo/NL/2480578-1', '2026-01-28', 'Aprueban Cronograma de Audiencias Públicas Extraordinarias 2026 que efectuarán la Primera Segunda y Tercera Salas Penales Superiores Nacionales Liquidadoras Transitorias y la Cuarta Sala Penal de Apelaciones Nacional de la Corte Superior Nacional de Justicia Penal Especializada', 'Aprueban Cronograma de Audiencias Públicas Extraordinarias 2026 que efectuarán la Primera Segunda y Tercera Salas Penales Superiores Nacionales Liquidadoras Transitorias y la Cuarta Sala Penal de Apelaciones Nacional de la Corte Superior Nacional de Justicia Penal Especializada', 'Media', 'Pendiente', 'Aprueban Cronograma de Audiencias Públicas Extraordinarias 2026 que efectuarán la Primera Segunda y Tercera Salas Penales Superiores Nacionales Liquidadoras Transitorias y la Cuarta Sala Penal de Apelaciones Nacional de la Corte Superior Nacional de Justicia Penal Especializada', NULL, '2026-01-28 15:31:05', '2026-01-28 15:31:05'),
	(173, 'Modifican la Circular N° 027-2018-BCRP Límites de Inversión Generales para los Fondos Administrados por las Administradoras Privadas de Fondos de P...', 'CIRCULAR N° 0004-2026-BCRP', 'BANCO CENTRAL DE RESERVA', 'https://busquedas.elperuano.pe/dispositivo/NL/2481132-1', '2026-01-28', 'Modifican la Circular N° 027-2018-BCRP Límites de Inversión Generales para los Fondos Administrados por las Administradoras Privadas de Fondos de Pensiones', 'Modifican la Circular N° 027-2018-BCRP Límites de Inversión Generales para los Fondos Administrados por las Administradoras Privadas de Fondos de Pensiones', 'Baja', 'Pendiente', 'Modifican la Circular N° 027-2018-BCRP Límites de Inversión Generales para los Fondos Administrados por las Administradoras Privadas de Fondos de Pensiones', NULL, '2026-01-28 15:31:05', '2026-01-28 15:31:05'),
	(174, 'Ordenanza Regional que aprueba la adecuación de la Comisión Ambiental Regional (CAR) de Moquegua', 'ORDENANZA N° 010-2025-CR/GRM', 'GOBIERNO REGIONAL DE MOQUEGUA', 'https://busquedas.elperuano.pe/dispositivo/NL/2473216-1', '2026-01-28', 'Ordenanza Regional que aprueba la adecuación de la Comisión Ambiental Regional (CAR) de Moquegua', 'Ordenanza Regional que aprueba la adecuación de la Comisión Ambiental Regional (CAR) de Moquegua', 'Baja', 'Pendiente', 'Ordenanza Regional que aprueba la adecuación de la Comisión Ambiental Regional (CAR) de Moquegua', NULL, '2026-01-28 15:31:05', '2026-01-28 15:31:05'),
	(175, 'RESOLUCION N° 570-2026-GTVT/MPC', 'RESOLUCION N° 570-2026-GTVT/MPC', 'MUNICIPALIDAD PROVINCIAL DEL CUSCO', 'https://busquedas.elperuano.pe/dispositivo/NL/2481299-1', '2026-01-28', 'Declaran el cumplimiento de la notificación de nueve Resoluciones Gerenciales que declaran la existencia de responsabilidad administrativa', 'Declaran el cumplimiento de la notificación de nueve Resoluciones Gerenciales que declaran la existencia de responsabilidad administrativa', 'Baja', 'Pendiente', 'Declaran el cumplimiento de la notificación de nueve Resoluciones Gerenciales que declaran la existencia de responsabilidad administrativa', NULL, '2026-01-28 15:31:05', '2026-01-28 15:31:05'),
	(176, 'RESOLUCION N° 352-2026-GTVT/MPC', 'RESOLUCION N° 352-2026-GTVT/MPC', 'MUNICIPALIDAD PROVINCIAL DEL CUSCO', 'https://busquedas.elperuano.pe/dispositivo/NL/2481304-1', '2026-01-28', 'Declaran el cumplimiento de la notificación de 21 Resoluciones Gerenciales que declaran la existencia de responsabilidad administrativa', 'Declaran el cumplimiento de la notificación de 21 Resoluciones Gerenciales que declaran la existencia de responsabilidad administrativa', 'Baja', 'Pendiente', 'Declaran el cumplimiento de la notificación de 21 Resoluciones Gerenciales que declaran la existencia de responsabilidad administrativa', NULL, '2026-01-28 15:31:05', '2026-01-28 15:31:05');
...
-- Volcando datos para la tabla kallpaq.reporte_satisfaccions: ~2 rows (aproximadamente)
REPLACE INTO `reporte_satisfaccions` (`id`, `anio`, `trimestre`, `fecha_generacion`, `proceso_id`, `resumen_encuestas`, `resumen_sugerencias`, `reclamos`, `resumen_snc`, `oportunidades_mejora`, `conclusiones`, `archivo_path`, `estado`, `archivo_firmado`, `user_id`, `created_at`, `updated_at`) VALUES
	...
	(2, 2026, 1, '2026-02-10', 45, 'Se consideró los resultados de la medición correspondiente al periodo Trimestral del año 2026. Se obtuvo un índice de satisfacción (Score Global) de 4.2% y un NPS de 89.00. La medición se realizó sobre una muestra de 120 encuestados. Los resultados por conductor fueron: Oportunidad: 4.00, Trato: 4.00, Claridad: 4.00, Seguridad: 4.00, Calidad: 5.00.', 'Durante el periodo 1 del año 2026, se recibieron un total de 1 sugerencias. El estado actual de las mismas es: identificada (1). Del total recibido, 0 han sido analizadas y cuentan con tratamiento definido.', 'No se registraron reclamos.', 'Se identificaron 1 salidas no conformes en el periodo. De las cuales, 0 se encuentran cerradas y 1 permanecen en proceso de tratamiento/cierre.', '- Implementar un programa de capacitación para el personal enfocado en mejorar el trato y la claridad en la comunicación con los ciudadanos, dado que las puntuaciones en estos aspectos fueron de 4.00, lo que indica un área de mejora.\n- Establecer un sistema de seguimiento y análisis de las sugerencias recibidas, asegurando que se les dé tratamiento adecuado y se implementen mejoras basadas en ellas, para fomentar la participación ciudadana y la confianza en la institución.\n- Realizar auditorías periódicas para identificar y cerrar las salidas no conformes de manera más eficiente, garantizando así que se mantenga un estándar de calidad en los procesos y se minimicen las incidencias futuras.', 'El índice de satisfacción global de 4.2% y un NPS de 89.00 reflejan un desempeño notable en la gestión de procesos, evidenciando una percepción positiva por parte de los ciudadanos. Sin embargo, la puntuación de 4.00 en los aspectos de oportunidad, trato y claridad sugiere que existen áreas donde se puede mejorar la experiencia del usuario, lo que podría contribuir a elevar aún más estos índices.\nA pesar de no haber reclamos reportados, la identificación de una salida no conforme indica la necesidad de fortalecer los mecanismos de control interno y respuesta ante situaciones adversas. La falta de análisis y tratamiento de las sugerencias recibidas también resalta una oportunidad para mejorar la comunicación y el compromiso con los ciudadanos, lo que podría traducirse en un aumento de la satisfacción y confianza en la institución.', NULL, 'generado', NULL, 1, '2026-02-10 14:25:32', '2026-02-10 14:25:32');
...
CREATE TABLE IF NOT EXISTS `riesgos` (
  ...
  `riesgo_fecha_identificacion` date DEFAULT NULL,
...
REPLACE INTO `riesgos` (`id`, `riesgo_cod`, `proceso_id`, `especialista_id`, `riesgo_nombre`, `riesgo_fecha_identificacion`, `riesgo_tipo`, `factor_id`, `riesgo_controles`, `riesgo_consecuencia`, `riesgo_probabilidad`, `riesgo_impacto`, `riesgo_valor`, `riesgo_nivel`, `riesgo_matriz`, `riesgo_tratamiento`, `riesgo_estado`, `riesgo_fecha_valoracion_rr`, `riesgo_probabilidad_rr`, `riesgo_impacto_rr`, `riesgo_valor_rr`, `riesgo_nivel_rr`, `riesgo_estado_rr`, `riesgo_ciclo`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, NULL, 105, 1, 'Resistencia al cambio en la implementación de mejoras, debido a la falta de respaldo activo y compromiso por parte de la alta dirección y de los OUO en la programación y ejecución de las auditorías internas.', NULL, 'Riesgo', 4, 'Sin controlessASAS', '- Opción 1: Disminución en la eficacia de los procesos, lo que puede llevar a la insatisfacción del cliente y pérdida de oportunidades de negocio.  \n- Opción 2: Aumento de no conformidades y fallos en el cumplimiento de normativas, lo que podría resultar en sanciones legales y daños a la reputación de la organización.', 10, 10, 100, 'muy alto', 'estrategica', NULL, 'proyecto', '2025-12-05', 6, 6, 36, 'medio', 'sin eficacia', 2, NULL, '2026-01-29 17:32:58', NULL),
	(23, NULL, 164, 0, 'Rendición de viáticos fuera del plazo establecido debido a la no priorización de estas actividades por parte del Comisionado.', NULL, 'Riesgo', 4, NULL, '- Opción 1: Retrasos en la disponibilidad de fondos para actividades operativas, lo que puede afectar la ejecución de proyectos y la continuidad del servicio.  \n- Opción 2: Pérdida de confianza por parte de los colaboradores y stakeholders, lo que puede resultar en una disminución de la motivación y el compromiso hacia la organización.', 6, 6, 36, 'medio', 'estrategica', NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-02-28 00:19:15', '2025-12-02 21:09:34', NULL),
	(24, NULL, 164, 0, 'Incumplimiento de plazos para la solicitud de viáticos debido al desconocimiento del procedimiento y directiva de viáticos por parte de los comisionados', NULL, 'Riesgo', 4, NULL, NULL, 4, 6, 24, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-02-28 00:21:50', '2025-03-05 18:28:48', NULL),
	(25, NULL, 164, 1, 'No atender los requerimientos de viáticos al exterior debido a la demora en la firma de la resolución administrativa.', NULL, 'Riesgo', 4, NULL, NULL, 4, 4, 16, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-02-28 00:39:54', '2025-12-02 19:55:14', NULL),
	(26, NULL, 164, 0, 'Que no se autorice el requerimiento de anticipo, debido a que no se cuenta con la opinión favorable de ABAS, a la tardía generación de requerimiento de anticipo y a la falta de disponibilidad presupuestal.', NULL, 'Riesgo', 4, NULL, NULL, 4, 4, 16, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-02-28 00:51:32', '2025-02-28 00:51:32', NULL),
	(30, NULL, 166, 0, 'Rendición de cuentas de anticipo fuera de plazo, debido a la no priorización de las\nactividades por parte del colaborador OUO.', NULL, 'Riesgo', 4, NULL, NULL, 6, 6, 36, 'medio', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-02-28 18:47:50', '2025-12-02 21:14:02', NULL),
	(31, NULL, 166, 0, 'Otorgar anticipos por un monto mayor al establecido debido a desconocimiento de la normativa relacionada a Anticipos.', NULL, 'Riesgo', 4, NULL, NULL, 4, 4, 16, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-02-28 19:00:07', '2025-02-28 19:00:07', NULL),
	(32, NULL, 166, 0, 'Rendiciones de anticipos no conformes a los criterios establecidos, debido a la falta de capacitación del colaborador OUO sobre la normativa de SUNAT.', NULL, 'Riesgo', 4, NULL, '- Opción 1: Retrasos en la aprobación de rendiciones, lo que puede afectar la disponibilidad de recursos financieros y la planificación de proyectos.  \n- Opción 2: Sanciones o multas por parte de SUNAT, lo que podría impactar negativamente en la reputación de la organización y en su capacidad para operar de manera eficiente.', 6, 6, 36, 'medio', 'tactica', 'reducir', 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-02-28 19:49:22', '2025-12-02 21:33:18', NULL),
	(33, NULL, 165, 0, 'Apertura de Caja Chica de manera oportuna', NULL, 'Riesgo', 4, NULL, NULL, 4, 4, 16, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-02-28 20:40:32', '2025-02-28 20:40:32', NULL),
	(34, NULL, 165, 0, 'Atención de gastos por caja chica que no cumplen requisitos establecidos, debido a la aplicación inadecuada de la norma o desconocimiento de la norma de parte de los colaboradores.', NULL, 'Riesgo', 4, NULL, NULL, 4, 4, 16, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-02-28 20:44:46', '2025-02-28 20:44:46', NULL),
	(35, NULL, 165, 0, 'Desembolso de la caja chica fuera del plazo, debido a demora en el levantamiento de las observaciones, problemas con los aplicativos del sistema de caja chica, SGD o SIAF.', NULL, 'Riesgo', 4, NULL, NULL, 4, 4, 16, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-02-28 20:47:25', '2025-02-28 20:47:25', NULL),
	(36, NULL, 165, 0, 'Liquidación final de caja chica fuera del plazo establecido, debido a demora en el levantamiento de las observaciones, demora en el depósito T6, problemas con los aplicativos: SIGA- Caja Chica, SGD, SIAF.', NULL, 'Riesgo', 4, NULL, NULL, 4, 4, 16, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-02-28 20:50:16', '2025-02-28 20:50:16', NULL),
	(37, NULL, 92, 0, 'Acta de Conciliación de Bienes y Suministros que ha sido validado o firmado y que cuente con información inconsistente (errores de información no detectada), a causa de errores en la revisión.', NULL, 'Riesgo', 4, NULL, NULL, 4, 4, 16, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-02-28 21:10:23', '2025-02-28 21:10:23', NULL),
	(38, NULL, 92, 0, 'Acta de Conciliación del Marco Legal y Ejecución del Presupuesto que ha sido validado o firmado y que cuente con información inconsistente (errores de información) no detectada, a causa de errores en la revisión.', NULL, 'Riesgo', 4, NULL, NULL, 4, 4, 16, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-02-28 21:11:32', '2025-02-28 21:11:32', NULL),
	(39, NULL, 92, 0, 'Información inconsistente no detectada en el Acta de Conciliación de Cuentas Corrientes y Cuenta Única del Tesoro Púbico (validada o firmada), a causa de errores en la revisión.', NULL, 'Riesgo', 4, NULL, NULL, 4, 4, 16, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-02-28 21:11:59', '2025-02-28 21:11:59', NULL),
	(40, NULL, 92, 0, 'Presentación de los estados financieros y presupuestarios fuera de los plazos establecidos, por información tardía por parte de los órganos o unidades orgánicas que conforman el pliego CGR, así como por deficiencia del módulo cliente y web del aplicativo SIAFSP y del SIAF - Módulo contable.', NULL, 'Riesgo', 4, NULL, NULL, 4, 4, 16, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-02-28 21:12:43', '2025-02-28 21:12:43', NULL),
	(42, NULL, 106, 0, 'Perdida de la certificación por no cumplir con los requisitos de la norma internacional.', NULL, 'Riesgo', 4, 'sin controles', NULL, 4, 6, 24, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-05 19:21:19', '2025-03-13 23:35:26', NULL),
	(43, NULL, 107, 0, 'No cumplir con los lineamientos establecidos por no contar con el soporte documentario, falta de compromiso de la Alta dirección o unidades orgánicas.', NULL, 'Riesgo', 4, NULL, NULL, 4, 6, 24, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-05 19:25:30', '2025-03-24 21:17:17', NULL),
	(44, NULL, 113, 0, 'No cumplir con los lineamientos establecidos en la Norma Técnica a “Implementación de la Gestión por Procesos en las Entidades de la Administración Pública” por no contar con el marco normativo interno actualizado.', NULL, 'Riesgo', 4, NULL, NULL, 4, 8, 32, 'medio', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-05 20:41:44', '2025-03-12 22:28:59', NULL),
	(45, NULL, 114, 0, 'Perdida de la certificación por no cumplir con los requisitos de la norma internacional', NULL, 'Riesgo', 4, NULL, NULL, 4, 6, 24, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-05 21:05:00', '2025-03-05 21:05:00', NULL),
	(47, NULL, 117, 0, 'Sobrerregulación de los procesos debido a una visión centrada en los aspectos funcionales, sin considerar de manera integral el proceso en su totalidad.', NULL, 'Riesgo', 4, NULL, NULL, 4, 8, 32, 'medio', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-05 23:03:32', '2025-03-26 15:56:11', NULL),
	(48, NULL, 219, 0, 'Posible presentación de casos de inelegibilidad de gastos, debido al incumplimiento de procedimiento, instancias, responsabilidades y normas que se debe seguir para la ejecución del proyecto.', NULL, 'Riesgo', 4, NULL, NULL, 4, 4, 16, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-06 14:09:50', '2025-03-06 14:09:50', NULL),
	(49, NULL, 219, 0, 'Posible suspensión en los desembolsos del prestamo BID, debido al incumplimiento de acuerdos contractuales.', NULL, 'Riesgo', 4, NULL, NULL, 4, 4, 16, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-06 14:10:09', '2025-03-06 14:10:09', NULL),
	(50, NULL, 219, 0, 'Posibilidad de no obtener la "no objeción" por parte del banco, debido al incumplimiento de la política para la adquisición de bienes y obras financiados por el BID.', NULL, 'Riesgo', 4, NULL, NULL, 4, 4, 16, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-06 14:10:26', '2025-03-24 22:29:31', NULL),
	(51, NULL, 220, 0, 'Posibilidad de no obtener la "no objeción" por parte del banco, debido al incumplimiento de la pólitica de selección y contratación de consultores financiados por el BID', NULL, 'Riesgo', 4, NULL, NULL, 4, 4, 16, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-06 14:13:22', '2025-03-24 22:29:00', NULL),
	(53, NULL, 219, 0, 'Posible afectación en el cumplimiento de los objetivos de los proyectos de inversión debido a modificaciones normativas sobre inversiones y políticas de gobierno, desactualizada o cambios en la normativa para la fase de ejecución de proyectos de inversión, insuficiente cultura en la gestión de proyectos, cambios en la estructura orgánica de la CGR o nuevos roles y funciones asignados al personal.', NULL, 'Riesgo', 4, NULL, NULL, 8, 8, 64, 'alto', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-06 14:46:41', '2025-03-06 14:46:41', NULL),
	(58, NULL, 30, 0, 'Incumplimiento de los Objetivos Estratégicos Institucionales', NULL, 'Riesgo', 4, NULL, NULL, 4, 6, 24, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-24 21:35:17', '2025-03-24 21:35:17', NULL),
	(59, NULL, 32, 0, 'La Subgerencia de Abastecimiento no pueda iniciar oportunamente el desarrollo del Cuadro de Necesidades', NULL, 'Riesgo', 4, NULL, NULL, 4, 6, 24, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-24 21:42:36', '2025-03-24 21:42:36', NULL),
	(60, NULL, 32, 0, 'Aprobación del Plan Operativo Institucional del siguiente año, fuera del plazo establecido', NULL, 'Riesgo', 4, NULL, NULL, 4, 4, 16, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-24 21:43:08', '2025-03-24 21:43:08', NULL),
	(61, NULL, 32, 0, 'Incumplimiento de elabora el Seguimiento del Plan Operativo dentro de los plazos establecidos', NULL, 'Riesgo', 4, NULL, NULL, 4, 4, 16, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-24 21:43:24', '2025-03-24 21:43:24', NULL),
	(62, NULL, 32, 0, 'Incumplimiento de elaborar la Evaluación del Plan Operativo Institucional a más tardar el siguiente mes de concluido el trimestre', NULL, 'Riesgo', 4, NULL, NULL, 4, 4, 16, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-24 21:43:49', '2025-03-24 21:43:49', NULL),
	(63, NULL, 109, 0, 'Los colaboradores podrían incumplir la Política y Objetivos Antisoborno al no considerar los controles establecidos en los riesgos o procesos dentro del alcance del certificado del Sistema de Gestión Antisoborno.', NULL, 'Riesgo', 4, NULL, NULL, 4, 8, 32, 'medio', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-24 21:47:56', '2025-03-24 21:48:51', NULL),
	...
	(65, NULL, 40, 0, 'La Entidad podría incumplir con la Política Nacional de Integridad al no contar con el compromiso o interés de Alta Dirección y funcionarios que garantice una gestión efectiva y sostenible de la integridad pública.', NULL, 'Riesgo', 4, NULL, NULL, 4, 6, 24, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-24 22:40:52', '2025-03-24 22:40:52', NULL),
	(66, NULL, 40, 0, 'La ejecución de las actividades del Programa de integridad podría incumplirse por falta de compromiso de los responsables de los Órganos o Unidades Orgánicas involucradas en la sostenibilidad de la implementación del modelo de integridad', NULL, 'Riesgo', 4, NULL, NULL, 4, 6, 24, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-24 22:41:13', '2025-03-24 22:41:13', NULL),
	(67, NULL, 276, 0, 'La gestión de las denuncias podría ser realizada fuera del plazo establecido en la normativa.', NULL, 'Riesgo', 4, NULL, NULL, 4, 6, 24, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-24 23:08:56', '2025-03-24 23:08:56', NULL),
	(68, NULL, 276, 0, 'En el marco de la gestión de denuncias, podría vulnerarse la identidad del denunciante y/o la materia de la denuncia y/o las actuaciones derivadas de la misma.', NULL, 'Riesgo', 4, NULL, NULL, 6, 8, 48, 'alto', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-24 23:09:49', '2025-03-24 23:09:49', NULL),
	(69, NULL, 276, 0, 'Especialista de denuncias podría evaluar la solicitud de medida de protección por el denunciante incumpliendo las normas establecidas.', NULL, 'Riesgo', 4, NULL, NULL, 4, 8, 32, 'medio', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-24 23:10:12', '2025-03-24 23:11:15', NULL),
	(70, NULL, 276, 0, 'El denunciante podría verse afectado en el ejercicio de los derechos personales y/o laborales, debido a que no se dé cumplimiento a la medida de protección otorgada.', NULL, 'Riesgo', 4, NULL, NULL, 4, 8, 32, 'medio', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-24 23:10:42', '2025-03-24 23:10:42', NULL),
	(71, NULL, 81, 0, 'No elaborar y/o actualizar la normativa que regule los procesos archivísticos a causa de no haber determinado la responsabilidad y prioridad de tal obligación.', NULL, 'Riesgo', 4, NULL, NULL, 6, 8, 48, 'alto', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-24 23:26:08', '2025-03-24 23:26:08', NULL),
	(73, NULL, 81, 0, 'Proporcionar información confidencial a los usuarios por no contar con controles de seguridad establecidos (documentados).', NULL, 'Riesgo', 4, NULL, NULL, 4, 8, 32, 'medio', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-24 23:29:32', '2025-03-24 23:29:32', NULL),
	(74, NULL, 81, 0, 'Archivo de documentos con series documentales combinadas a causa de escasos mecanismos de difusión y socialización con las unidades de organización.', NULL, 'Riesgo', 4, NULL, NULL, 8, 4, 32, 'medio', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-24 23:30:18', '2025-03-24 23:30:41', NULL),
	(75, NULL, 81, 0, 'Solicitudes de eliminación rechazadas debido a desconocimiento de procedimiento vigente.', NULL, 'Riesgo', 4, NULL, NULL, 4, 6, 24, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-24 23:30:57', '2025-03-24 23:30:57', NULL),
	(76, NULL, 81, 0, 'La degradación de soportes físicos y digitales puede comprometer la integridad y accesibilidad de la información, afectando la eficiencia operativa y la seguridad de la información en la organización.', NULL, 'Riesgo', 4, NULL, NULL, 6, 8, 48, 'alto', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-24 23:34:53', '2025-03-24 23:34:53', NULL),
	(77, NULL, 78, 0, 'Posible incumplimiento de los criterios, actividades y roles asignados en los procedimientos, TUPA y directiva de "Gestión documental", debido a la poca experiencia o desconocimiento por parte del responsable de la actividad correspondiente a los presentes procedimientos.', NULL, 'Riesgo', 4, NULL, NULL, 4, 6, 24, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-25 00:25:50', '2025-03-25 00:25:50', NULL),
	(78, NULL, 78, 0, 'Posible incumplimiento de los requisitos de recepción y errores en las derivaciones de documentos (clasificados como reservados, secretos y confidenciales), debido a la poca experiencia del responsable del proceso.', NULL, 'Riesgo', 4, NULL, NULL, 4, 8, 32, 'medio', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-25 00:26:17', '2025-03-25 00:26:17', NULL),
	(79, NULL, 78, 0, 'Posible incumplimiento de los criterios establecidos en el manual de atención a la ciudadanía, debido al desconocimiento o poca experiencia por parte del responsable de la actividad.', NULL, 'Riesgo', 4, NULL, NULL, 4, 6, 24, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-25 00:27:19', '2025-03-25 00:27:19', NULL),
	(80, NULL, 78, 0, 'Demora por una inadecuada verificación de los requisitos e incorrecto registro de la presentación de la declaración jurada, debido al desconocimiento o errores involuntarios por parte del responsable de la actividad.', NULL, 'Riesgo', 4, NULL, NULL, 4, 6, 24, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-25 00:27:55', '2025-03-25 00:27:55', NULL),
	(81, NULL, 78, 0, 'Posible soborno hacia personal de Gestión Documentaria para proporcionar indebidamente información a favor de terceros para fines personales, debido a la falta de ética del personal que realiza la gestión de recepción de documentos.', NULL, 'Riesgo', 4, NULL, NULL, 4, 8, 32, 'medio', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-25 00:29:06', '2025-03-25 00:29:06', NULL),
	(82, NULL, 118, 0, 'Indisponibilidad de la información respaldada por una falla de software o hardware', NULL, 'Riesgo', 4, NULL, NULL, 4, 6, 24, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-25 00:37:13', '2025-03-25 00:37:13', NULL),
	(83, NULL, 118, 0, 'Demora en el resguardo y recuperación de la información del correo electrónico respaldada por el proveedor debido que los recursos e infraestructura no están bajo el control de CGR', NULL, 'Riesgo', 4, NULL, NULL, 4, 6, 24, 'bajo', NULL, NULL, 'proyecto', NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-03-25 00:37:28', '2025-03-25 00:37:28', NULL);

-- Volcando estructura para tabla kallpaq.riesgo_control
CREATE TABLE IF NOT EXISTS `riesgo_control` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `riesgo_id` bigint(20) unsigned NOT NULL,
  `control_id` bigint(20) unsigned NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `control_riesgo_riesgo_id_foreign` (`riesgo_id`),
  KEY `control_riesgo_control_id_foreign` (`control_id`),
  CONSTRAINT `control_riesgo_control_id_foreign` FOREIGN KEY (`control_id`) REFERENCES `controles` (`id`) ON DELETE CASCADE,
  CONSTRAINT `control_riesgo_riesgo_id_foreign` FOREIGN KEY (`riesgo_id`) REFERENCES `riesgos` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Volcando datos para la tabla kallpaq.riesgo_control: ~0 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `salidas_no_conformes` (
  ...
  `snc_tratamiento` enum('corrección','concesion o aceptación','rechazo','sustitucion') DEFAULT NULL COMMENT 'Tipo de tratamiento aplicado',
  ...
  `snc_estado` enum('identificada','en análisis','en tratamiento','tratada','cerrada','observada') NOT NULL DEFAULT 'identificada',
  `snc_observacion` text DEFAULT NULL,
  ...
  `snc_fecha_fecha_fin_prog` date DEFAULT NULL COMMENT 'Fecha de aplicación del tratamiento',
  `snc_fecha_fin_real` date DEFAULT NULL,
  `snc_fecha_observacion` timestamp NULL DEFAULT NULL,
...
REPLACE INTO `salidas_no_conformes` (`id`, `snc_descripcion`, `snc_cantidad_afectada`, `snc_responsable`, `snc_origen`, `snc_clasificacion`, `snc_tratamiento`, `snc_descripcion_tratamiento`, `snc_costo_estimado`, `snc_estado`, `snc_observacion`, `snc_requiere_accion_correctiva`, `snc_fecha_deteccion`, `snc_fecha_fecha_fin_prog`, `snc_fecha_fin_real`, `snc_fecha_observacion`, `snc_fecha_cierre`, `snc_observaciones`, `snc_archivos`, `snc_evidencias`, `created_at`, `updated_at`, `proceso_id`) VALUES
	(9, 'dsadadssad', 12.00, 'Juan Almeyda', 'cliente', 'crítica', 'concesion o aceptación', 'No aplica por concesión o aceptación', 0.00, 'cerrada', 'No hay entregables', 0, '2026-02-06', '2026-02-13', '2026-02-06', '2026-02-06 20:46:59', '2026-02-06', NULL, NULL, NULL, '2026-02-06 20:09:25', '2026-02-06 20:48:27', 4),
	(10, 'dsadsad', 12.00, 'saSAs', 'auditoría interna', 'crítica', NULL, NULL, NULL, 'identificada', NULL, 0, '2026-02-06', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-02-06 21:42:57', '2026-02-10 14:22:21', 45);

-- Volcando estructura para tabla kallpaq.salida_no_conforme_movimientos
CREATE TABLE IF NOT EXISTS `salida_no_conforme_movimientos` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `salida_no_conforme_id` bigint(20) unsigned NOT NULL,
  `estado` varchar(255) NOT NULL,
  `observacion` text DEFAULT NULL,
  `user_id` bigint(20) unsigned NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `salida_no_conforme_movimientos_salida_no_conforme_id_foreign` (`salida_no_conforme_id`),
  KEY `salida_no_conforme_movimientos_user_id_foreign` (`user_id`),
  CONSTRAINT `salida_no_conforme_movimientos_salida_no_conforme_id_foreign` FOREIGN KEY (`salida_no_conforme_id`) REFERENCES `salidas_no_conformes` (`id`) ON DELETE CASCADE,
  CONSTRAINT `salida_no_conforme_movimientos_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Volcando datos para la tabla kallpaq.salida_no_conforme_movimientos: ~8 rows (aproximadamente)
REPLACE INTO `salida_no_conforme_movimientos` (`id`, `salida_no_conforme_id`, `estado`, `observacion`, `user_id`, `fecha_movimiento`, `created_at`, `updated_at`) VALUES
	(4, 9, 'identificada', 'Salida No Conforme registrada en el sistema', 1, '2026-02-06 20:09:25', '2026-02-06 20:09:25', '2026-02-06 20:09:25'),
	(5, 9, 'en tratamiento', 'Cambio de estado: identificada -> en tratamiento', 1, '2026-02-06 20:09:55', '2026-02-06 20:09:55', '2026-02-06 20:09:55'),
	(6, 9, 'tratada', 'Tratamiento aplicado: concesion o aceptación. Nuevo estado: tratada', 1, '2026-02-06 20:17:30', '2026-02-06 20:17:30', '2026-02-06 20:17:30'),
	(7, 9, 'observada', 'sasSAsaSAsAS', 1, '2026-02-06 20:35:14', '2026-02-06 20:35:14', '2026-02-06 20:35:14'),
	(8, 9, 'tratada', 'Tratamiento aplicado: concesion o aceptación. Nuevo estado: tratada', 1, '2026-02-06 20:42:55', '2026-02-06 20:42:55', '2026-02-06 20:42:55'),
	(9, 9, 'observada', 'No hay entregables', 1, '2026-02-06 20:46:59', '2026-02-06 20:46:59', '2026-02-06 20:46:59'),
	(10, 9, 'tratada', 'Tratamiento aplicado: concesion o aceptación. Nuevo estado: tratada', 1, '2026-02-06 20:48:08', '2026-02-06 20:48:08', '2026-02-06 20:48:08'),
	(11, 9, 'cerrada', 'Salida No Conforme validada y cerrada exitosamente.', 1, '2026-02-06 20:48:27', '2026-02-06 20:48:27', '2026-02-06 20:48:27'),
	(12, 10, 'identificada', 'Salida No Conforme registrada en el sistema', 1, '2026-02-06 21:42:57', '2026-02-06 21:42:57', '2026-02-06 21:42:57');
...
CREATE TABLE IF NOT EXISTS `sugerencias` (
  ...
  `sugerencia_estado` enum('identificada','en progreso','implementada','observada','cerrada') DEFAULT NULL,
...
-- Volcando datos para la tabla kallpaq.sugerencias: ~3 rows (aproximadamente)
REPLACE INTO `sugerencias` (`id`, `sugerencia_clasificacion`, `sugerencia_detalle`, `sugerencia_fecha_ingreso`, `sugerencia_procedencia`, `sugerencia_analisis`, `sugerencia_viabilidad`, `sugerencia_tratamiento`, `sugerencia_observacion`, `sugerencia_fecha_observacion`, `sugerencia_fecha_cierre`, `sugerencia_estado`, `sugerencia_fecha_fin_prog`, `sugerencia_fecha_fin_real`, `proceso_id`, `sugerencia_evidencias`, `created_at`, `updated_at`) VALUES
	(3, 'MP', 'dsadsad dsadsadsad', '2026-02-05', 'fisico', 'dsadsadasd', 'viable', 'Se ha mejora la sugerencia se han consideradi las siguientes acciones', 'Se observa faltan evidencias', '2026-02-06', '2026-02-06', 'cerrada', '2026-02-06', '2026-02-06', 6, '[{"path":"satisfaccion\\/sugerencias\\/6\\/3\\/MmcbNvX7R36C1GRacF3baXzvJEJyZdEa6aC4x22Z.docx","name":"Gesti\\u00f3n de la Innovaci\\u00f3n.docx"}]', '2026-02-05 22:56:48', '2026-02-06 15:49:13'),
	(4, 'MP', 'Nueva sugerencia de prueba', '2026-02-06', 'fisico', 'Sugerencia analizada', 'viable', 'dsadsadsad', NULL, NULL, '2026-02-06', 'cerrada', '2026-02-05', '2026-02-06', 4, '[{"path":"satisfaccion\\/sugerencias\\/4\\/4\\/7pgms0fZ5qRzknKxTRhko1kiZzwGy9mDvhOOly24.xlsx","name":"Analisis concurso 2026-1.xlsx"}]', '2026-02-06 20:50:34', '2026-02-06 20:51:31'),
	(5, 'MF', 'dsadsadsadad', '2026-02-06', 'virtual', NULL, NULL, NULL, NULL, NULL, NULL, 'identificada', NULL, NULL, 45, NULL, '2026-02-06 21:37:02', '2026-02-10 14:21:39');

-- Volcando estructura para tabla kallpaq.sugerencia_movimientos
CREATE TABLE IF NOT EXISTS `sugerencia_movimientos` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `sugerencia_movimientos_sugerencia_id_foreign` (`sugerencia_id`),
  KEY `sugerencia_movimientos_user_id_foreign` (`user_id`),
  CONSTRAINT `sugerencia_movimientos_sugerencia_id_foreign` FOREIGN KEY (`sugerencia_id`) REFERENCES `sugerencias` (`id`) ON DELETE CASCADE,
  CONSTRAINT `sugerencia_movimientos_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Volcando datos para la tabla kallpaq.sugerencia_movimientos: ~8 rows (aproximadamente)
REPLACE INTO `sugerencia_movimientos` (`id`, `sugerencia_id`, `estado`, `observacion`, `user_id`, `fecha_movimiento`, `created_at`, `updated_at`) VALUES
	(1, 3, 'implementada', 'Cambio de estado: observada -> implementada', 1, '2026-02-06 15:46:17', '2026-02-06 15:46:17', '2026-02-06 15:46:17'),
	(2, 3, 'observada', 'Se observa faltan evidencias', 1, '2026-02-06 15:47:13', '2026-02-06 15:47:13', '2026-02-06 15:47:13'),
	(3, 3, 'implementada', 'Cambio de estado: observada -> implementada', 1, '2026-02-06 15:48:25', '2026-02-06 15:48:25', '2026-02-06 15:48:25'),
	(4, 3, 'cerrada', 'Sugerencia validada y cerrada exitosamente.', 1, '2026-02-06 15:49:13', '2026-02-06 15:49:13', '2026-02-06 15:49:13'),
	(5, 4, 'identificada', 'Sugerencia registrada en el sistema', 1, '2026-02-06 20:50:34', '2026-02-06 20:50:34', '2026-02-06 20:50:34'),
	(6, 4, 'implementada', 'Cambio de estado: identificada -> implementada', 1, '2026-02-06 20:51:17', '2026-02-06 20:51:17', '2026-02-06 20:51:17'),
	(7, 4, 'cerrada', 'Sugerencia validada y cerrada exitosamente.', 1, '2026-02-06 20:51:31', '2026-02-06 20:51:31', '2026-02-06 20:51:31'),
	(8, 5, 'identificada', 'Sugerencia registrada en el sistema', 1, '2026-02-06 21:37:02', '2026-02-06 21:37:02', '2026-02-06 21:37:02');
...
REPLACE INTO `users` (`id`, `name`, `email`, `user_cod_personal`, `email_verified_at`, `password`, `force_password_change`, `user_iniciales`, `user_foto_url`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'Juan Manuel Almeyda Requejo', 'jalmeyda@contraloria.gob.pe', '17618', '2023-08-30 15:54:20', '$2y$10$wb1s0IQ6oIR7r/4mXxg/0uTBKptsXG05I62.sIvKz3.rCnCgqT/6q', 0, 'JMAR', 'photo/1768608079_696ad14f6e4f7.png', 'W7ptlP9pfNBFyvKlG8T0QzIbndPzZhvwnlVlZDCObCXKdzrMEcoPGTNHgaea', '2023-05-26 23:01:48', '2026-01-23 15:55:38'),
	(2, 'Manuel Perez Effus', 'manuelperez@contraloria.gob.pe', '64415', '2023-08-25 19:29:29', '$2y$10$wb1s0IQ6oIR7r/4mXxg/0uTBKptsXG05I62.sIvKz3.rCnCgqT/6q', 0, 'MPE', NULL, NULL, '2023-08-26 00:28:38', '2026-01-19 22:12:17'),
	(3, 'Angel Arturo Bendezu Cardenas\r\n', 'abendezuc@contraloria.gob.pe', NULL, '2023-08-25 19:29:29', '$2a$12$UaFP2VL90DuMIzK4uhCpAOfKV4GEzhNe.IMh7iI3EI0huFVEEpN5y', 0, NULL, NULL, NULL, '2023-08-26 00:28:38', '2023-08-26 00:28:38'),
	(4, 'Maria Isabel Hiyo Huapaya\r\n', 'mhiyo@contraloria.gob.pe', NULL, '2023-08-25 19:29:29', '$2a$12$UaFP2VL90DuMIzK4uhCpAOfKV4GEzhNe.IMh7iI3EI0huFVEEpN5y', 0, NULL, NULL, NULL, '2023-08-26 00:28:38', '2023-08-26 00:28:38'),
	(5, 'Ana Elsa Gonzales Napaico\r\n', 'agonzalesn@contraloria.gob.pe', NULL, '2023-08-25 19:29:29', '$2a$12$UaFP2VL90DuMIzK4uhCpAOfKV4GEzhNe.IMh7iI3EI0huFVEEpN5y', 0, NULL, NULL, NULL, '2023-08-26 00:28:38', '2023-08-26 00:28:38'),
	(6, 'Gatsby Loayza Parraga\r\n', 'gloayza@contraloria.gob.pe', NULL, '2023-08-25 19:29:29', '$2a$12$UaFP2VL90DuMIzK4uhCpAOfKV4GEzhNe.IMh7iI3EI0huFVEEpN5y', 0, NULL, NULL, NULL, '2023-08-26 00:28:38', '2023-08-26 00:28:38'),
	(7, 'Gustavo Adolfo Villanueva Salvador\r\n', 'gvillanuevas@contraloria.gob.pe', NULL, '2023-08-25 19:29:29', '$2a$12$UaFP2VL90DuMIzK4uhCpAOfKV4GEzhNe.IMh7iI3EI0huFVEEpN5y', 0, NULL, NULL, NULL, '2023-08-26 00:28:38', '2023-08-26 00:28:38'),
	(8, 'Elias Martin Tresierra Paz\r\n', 'etresierra@contraloria.gob.pe', NULL, '2023-08-25 19:29:29', '$2a$12$UaFP2VL90DuMIzK4uhCpAOfKV4GEzhNe.IMh7iI3EI0huFVEEpN5y', 0, NULL, NULL, NULL, '2023-08-26 00:28:38', '2023-08-26 00:28:38'),
	(9, 'Angel Benny Cordova Filio', 'acordovaf@contraloria.gob.pe', NULL, NULL, '$2y$10$s51D/dM8cAeoDHW8JSekuODBWFBfyZUzlaKQvsKatz2O5UTWWuoCW', 0, 'ABCF', NULL, NULL, '2026-01-18 21:46:35', '2026-01-18 21:46:35'),
	(10, 'Luis Carlos Echeverria Tamayo', 'lecheverria@contraloria.gob.pe', '18877', NULL, '$2y$10$UxJU2AHPal8/sjV/QRyZOuXXvaW7LfThjIjCCHTMw6fbKnkdXDtze', 0, 'LCET', NULL, NULL, '2026-01-18 21:50:18', '2026-01-22 16:43:39'),
	(11, 'Roberto Ruben Soldevilla Garcia', 'rsoldevilla@contraloria.gob.pe', NULL, NULL, '$2y$10$QnayjRSkqtBXZmnmQyDZ7.mgvmm5g.MOETrxKLU8ao1GJfH2ibtNu', 0, 'RRSG', NULL, NULL, '2026-01-18 21:54:33', '2026-01-18 21:54:33'),
	(12, 'David Ricardo Pinto Yoshinari', 'dpinto@contraloria.gob.pe', NULL, NULL, '$2y$10$qDuSM12j75fu7XqpOBLlWO4rCfcxaUsJWjyibNHaJdMVJkl6wvbV2', 0, 'DRPY', NULL, NULL, '2026-01-18 21:55:35', '2026-01-18 21:55:35'),
	(13, 'Luis Alberto Marini Lopez', 'lmarini@contraloria.gob.pe', NULL, NULL, '$2y$10$ZJYFidO1j3BBLlnvGM0koe4BnIu8mq9PTdcAcfcVOiCPMqtVwsB7.', 0, 'LAML', NULL, NULL, '2026-01-18 21:56:19', '2026-01-18 21:56:19'),
	(14, 'Natali Camacho Bartra', 'ncamacho@contraloria.gob.pe', '17586', NULL, '$2y$10$DvfNUKnZ6EG/IBgb7Jzmc.DBhj.LTZlvpVF29r9VzGyeN2ohJjWmG', 0, 'NCB', NULL, NULL, '2026-01-18 22:03:15', '2026-01-18 22:03:15'),
	(15, 'Mónica Jeanette Isique Pérez', 'misique@contraloria.gob.pe', '10519', NULL, '$2y$10$ZyHwJJrAVC7zZnM39rllse8JI1g7OuTqUYpn4kDk0f7FbXw/7oCee', 0, 'MJIP', NULL, NULL, '2026-01-19 21:58:13', '2026-01-19 21:58:13'),
	(16, 'Yvette Ormeño Luna', 'yormeno@contraloria.gob.pe', '65730', NULL, '$2y$10$ftDQamrU7VPIRBsdHBTcw.6qoF1gnxuDoMBNeD0KcALC1WzMMPYWS', 0, 'YOL', NULL, NULL, '2026-01-19 21:58:46', '2026-01-19 21:58:46'),
	(17, 'Mario Lorenzo Salinas Cornejo', 'msalinas@contraloria.gob.pe', '14176', NULL, '$2y$10$DAGrectOSh4UlBZgt2NDceRxB8dvgU/jK3RI1aGmjAwl86Sxl53KW', 0, 'MLSC', NULL, NULL, '2026-01-19 22:10:53', '2026-01-19 22:10:53'),
	(18, 'Jhonny Alfredo Cava Guerra', 'jcava@contraloria.gob.pe', '20026', NULL, '$2y$10$ExnMzr63tQnGWajudFOBUuz1P61zP.LtOx2i7t8lZszfY6htiteB2', 0, 'JACG', NULL, NULL, '2026-01-19 22:11:26', '2026-01-19 22:11:26'),
	(19, 'Joice Fabiola Ponce Cámara', 'joiceponce@contraloria.gob.pe', '64361', NULL, '$2y$10$pbD/VyneLz03/N2quD2Iw.X9GX.LOvIvWpVSIPWZx1EGCEcua..Ii', 0, 'JFPC', NULL, NULL, '2026-01-19 22:11:51', '2026-01-19 22:11:51'),
	(20, 'Jacinto Jorge Paz Ortiz', 'jpaz@contraloria.gob.pe', '18936', NULL, '$2y$10$X5zl9hsO5kvJKLrrMJOpfOiLJ77wkCzuWRxHPe2oTEYkzfaLharqO', 0, 'JJPO', NULL, NULL, '2026-01-19 22:13:23', '2026-01-19 22:13:23'),
	(21, 'Julio Miguel Juárez Torres', 'jjuarez@contraloria.gob.pe', '71008', NULL, '$2y$10$hj0A/8vaf6svnWadND9jOu/f7yQgjUGbBJrAm0NTCrT8cEYiF1HXq', 0, 'JMJT', NULL, NULL, '2026-01-19 22:14:05', '2026-01-19 22:14:05'),
	(22, 'Violeta Marina Vivanco Puente', 'vvivancop@contraloria.gob.pe', '60781', NULL, '$2y$10$xI.3wbX9F9.HCaiaIBj0..7QcCmYcgt5z88GbCvIiVb3XTv/kELdu', 0, 'VMVP', NULL, NULL, '2026-01-19 22:14:33', '2026-01-19 22:14:33'),
	(23, 'Juan Ricardo Torres Torres Prado', 'jtorres@contraloria.gob.pe', '63473', NULL, '$2y$10$ePAgOibBmzMeUwjrw1CzYePb1H.bzlI5eBHl7MSIb9Nmsq1dEgeu2', 0, 'JRTT', NULL, NULL, '2026-01-19 22:26:35', '2026-01-19 22:26:35'),
	(24, 'Joel Enrique Mercado Rojas', 'jmercador@contraloria.gob.pe', '17642', NULL, '$2y$10$xLu9RT1bQipMpFKRb92FE.TBGManUcDMGc7yFEk21T2mTfN53vmSa', 0, 'JEMR', NULL, NULL, '2026-01-19 22:29:56', '2026-01-19 22:29:56'),
	(25, 'Angie Reategui Reategui', 'areateguir@contraloria.gob.pe', '18209', NULL, '$2y$10$bdxVo7vFXYHbC53Jo3s4p.s66lnrxre03/ARGBv.Nr.0KjqCYRdNq', 0, 'ARR', NULL, NULL, '2026-01-19 22:30:21', '2026-01-19 22:30:21'),
	(26, 'Obdulia Isabel Camacho Tavera', 'ocamachot@contraloria.gob.pe', '19407', NULL, '$2y$10$ASfig2sWnBtqhvM8TVmgNOgfpq6EuFjw7crUm5yPrfbwlthTH2.QG', 0, 'OICT', NULL, NULL, '2026-01-19 22:37:35', '2026-01-19 22:37:35'),
	(27, 'Hector Hildeck Maldonado Montalvo', 'hmaldonado@contraloria.gob.pe', '12939', NULL, '$2y$10$harA8WYWHboS.bkIxkybSOrZq39AoT.il9osIF6Z28VlRkQ7GP0Fq', 0, 'HHMM', NULL, NULL, '2026-01-19 22:38:07', '2026-01-19 22:38:07'),
	(28, 'Pedro Luis Vera Barriga', 'pvera@cvontraloria.gob.pe', '64617', NULL, '$2y$10$ChB2pTf0WNXUVMirMRtvbuNbuRFWRNdM5JVZV5.vYoW.xz.XbSlLW', 0, 'PLVB', NULL, NULL, '2026-01-19 22:50:57', '2026-01-19 22:53:48'),
	(29, 'Yndira Sidilia Orellana Tutaya', 'yorellana@contraloria.gob.pe', '18302', NULL, '$2y$10$ChB2pTf0WNXUVMirMRtvbuNbuRFWRNdM5JVZV5.vYoW.xz.XbSlLW', 0, 'YSOT', NULL, NULL, '2026-01-19 22:50:57', '2026-01-19 22:54:06'),
	(30, 'Anna Cecilia Espinoza Panty', 'aespinozap@contraloria.gob.pe', '62243', NULL, '$2y$10$ChB2pTf0WNXUVMirMRtvbuNbuRFWRNdM5JVZV5.vYoW.xz.XbSlLW', 0, 'ACEP', NULL, NULL, '2026-01-19 22:50:57', '2026-01-19 22:54:21'),
	(31, 'Rosa Violeta Quispitongo Vásquez', 'rquispitongo@contraloria.gob.pe', '61096', NULL, '$2y$10$ChB2pTf0WNXUVMirMRtvbuNbuRFWRNdM5JVZV5.vYoW.xz.XbSlLW', 0, 'RVQV', NULL, NULL, '2026-01-19 22:50:57', '2026-01-19 22:54:36'),
	(32, 'Cesar Acosta Valeriano', 'cacosta@contraloria.gob.pe', '61042', NULL, '$2y$10$ChB2pTf0WNXUVMirMRtvbuNbuRFWRNdM5JVZV5.vYoW.xz.XbSlLW', 0, 'CAV', NULL, NULL, '2026-01-19 22:50:57', '2026-01-19 22:53:16'),
	(33, 'Wilder Alex Inga Lopez', 'winga@contraloria.gob.pe', '66389', NULL, '$2y$10$Mo882598gf50zydzb3pmg.lI5DYLKaG2M/DulqzaGnFsF8C0/z48u', 0, 'WAIL', NULL, NULL, '2026-01-21 17:14:46', '2026-01-21 17:14:46'),
	(34, 'Rómulo Bolesman Paoli', 'rbosleman@contraloria.gob.pe', '60239', NULL, '$2y$10$Mo882598gf50zydzb3pmg.lI5DYLKaG2M/DulqzaGnFsF8C0/z48u', 0, 'RBP', NULL, NULL, '2026-01-21 17:14:46', '2026-01-21 17:14:46'),
	(35, 'Henry Paz Melendez', 'hpaz@contraloria.gob.pe', '65398', NULL, '$2y$10$Mo882598gf50zydzb3pmg.lI5DYLKaG2M/DulqzaGnFsF8C0/z48u', 0, 'HPM', NULL, NULL, '2026-01-21 17:14:46', '2026-01-21 17:14:46'),
	(36, 'Jaime Fernando Ramirez Salinas', 'jramirezs@contraloria.gob.pe', '20119', NULL, '$2y$10$Mo882598gf50zydzb3pmg.lI5DYLKaG2M/DulqzaGnFsF8C0/z48u', 0, 'JFRS', NULL, NULL, '2026-01-21 17:14:46', '2026-01-21 17:14:46'),
	(37, 'Vilma Violeta Carrillo Paredes', 'vcarrillo@contraloria.gob.pe', '64489', NULL, '$2y$10$Mo882598gf50zydzb3pmg.lI5DYLKaG2M/DulqzaGnFsF8C0/z48u', 0, 'VVCP', NULL, NULL, '2026-01-21 17:14:46', '2026-01-21 17:14:46'),
	(38, 'Gliria Glenda Rivero Cornejo', 'grivero@contraloria.gob.pe', '62589', NULL, '$2y$10$Mo882598gf50zydzb3pmg.lI5DYLKaG2M/DulqzaGnFsF8C0/z48u', 0, 'GGRC', NULL, NULL, '2026-01-21 17:14:46', '2026-01-21 17:14:46'),
	(39, 'Jose Alexander Avila Zamudio', 'javila@contraloria.gob.pe', '18839', NULL, '$2y$10$Mo882598gf50zydzb3pmg.lI5DYLKaG2M/DulqzaGnFsF8C0/z48u', 0, 'JAAZ', NULL, NULL, '2026-01-21 17:14:46', '2026-01-21 17:14:46'),
	(40, 'Serapio Victor Moreno Vega', 'vmoreno@contraloria.gob.pe', '70146', NULL, '$2y$10$Mo882598gf50zydzb3pmg.lI5DYLKaG2M/DulqzaGnFsF8C0/z48u', 0, 'SVMV', NULL, NULL, '2026-01-21 17:14:46', '2026-01-21 17:14:46'),
	(41, 'Dagmar Kirey Salazar Frias', 'dsalazarf@contraloria.gob.pe', '18435', NULL, '$2y$10$t8kxoullMyMK6QKSsXyx0eE1PnIkZcfXqoaygw3X7pvbxWJ6M6ymO', 0, 'DKSF', NULL, NULL, '2026-01-21 21:49:12', '2026-01-21 21:49:12');
