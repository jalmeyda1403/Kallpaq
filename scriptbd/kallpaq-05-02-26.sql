...
-- Volcando datos para la tabla kallpaq.accion_movimientos: ~9 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `auditoria_agenda` (
  ...
  `aea_requisito` text DEFAULT NULL,
...
-- Volcando datos para la tabla kallpaq.auditoria_checklists: ~55 rows (aproximadamente)
...
REPLACE INTO `auditoria_equipo` (`id`, `ae_id`, `auditor_id`, `aeq_rol`, `aeq_horas_planificadas`, `aeq_horas_ejecutadas`, `created_at`, `updated_at`) VALUES
	(45, 1, 1, 'Auditor Líder', 0.00, -19.00, '2026-01-16 23:06:57', '2026-02-04 21:01:30'),
	(46, 1, 2, 'Auditor Interno', 0.00, -11.00, '2026-01-16 23:06:57', '2026-01-16 23:40:32'),
	(48, 1, 7, 'Auditor Interno', 0.00, -10.00, '2026-01-16 23:35:13', '2026-01-16 23:40:32');
...
REPLACE INTO `auditoria_especifica` (`id`, `pa_id`, `ae_codigo`, `ae_objetivo`, `ae_criterios`, `ae_alcance`, `ae_tipo`, `ae_sistema`, `ae_lugar`, `ae_direccion`, `ae_estado`, `ae_fecha_inicio`, `ae_fecha_fin`, `proceso_id`, `ae_equipo_auditor`, `ae_auditado`, `created_at`, `updated_at`, `ae_cantidad_auditores`, `ae_horas_hombre`, `ae_ciclo`) VALUES
	(1, 1, '2026 - 001 - IN', 'Objetivo', 'ISO 9001, ISO 37001', 'Alcance', 'Interna', '["sgc","sgcm"]', NULL, 'Calle Camilo Carrillo 114, Jesus María', 'Programada', '2026-01-16', '2026-12-31', NULL, NULL, NULL, '2026-01-16 19:07:32', '2026-02-05 02:57:00', NULL, 36.00, 1);
...
-- Volcando datos para la tabla kallpaq.auditoria_informes: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla kallpaq.auditoria_proceso: ~4 rows (aproximadamente)
...
-- Volcando datos para la tabla kallpaq.migrations: ~189 rows (aproximadamente)
...
-- Volcando datos para la tabla kallpaq.model_has_roles: ~42 rows (aproximadamente)
...
-- Volcando datos para la tabla kallpaq.obligacion_evaluacion: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla kallpaq.obligacion_proceso: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla kallpaq.ouo_user: ~32 rows (aproximadamente)
...
-- Volcando datos para la tabla kallpaq.ouo_user_movimientos: ~36 rows (aproximadamente)
...
-- Volcando datos para la tabla kallpaq.procesos_ouo: ~27 rows (aproximadamente)
...
-- Volcando datos para la tabla kallpaq.salidas_no_conformes: ~1 rows (aproximadamente)
REPLACE INTO `salidas_no_conformes` (`id`, `snc_descripcion`, `snc_cantidad_afectada`, `snc_fecha_deteccion`, `snc_responsable`, `snc_origen`, `snc_clasificacion`, `snc_tratamiento`, `snc_descripcion_tratamiento`, `snc_fecha_tratamiento`, `snc_costo_estimado`, `snc_estado`, `snc_requiere_accion_correctiva`, `snc_fecha_cierre`, `snc_observaciones`, `snc_archivos`, `snc_evidencias`, `created_at`, `updated_at`, `proceso_id`) VALUES
	(6, 'Se identificarion registros erroneos', 5.00, '2025-11-19', 'DSAD', 'auditoría interna', 'crítica', 'corrección', 'DSADSADsAD', '2026-02-19', 0.00, 'tratada', 0, '2026-02-05', NULL, NULL, '[{"path":"satisfaccion\\/snc\\/151\\/6\\/CvMG23xFYi1KinucMFObYFjnp261VQBWtM6KhgZO.pdf","name":"Norma Tecnica - Gestion de la Calidad de Servicios_16 11 22[F].pdf.pdf"}]', '2026-01-19 16:56:53', '2026-02-05 19:38:13', 151);
...
REPLACE INTO `sugerencias` (`id`, `sugerencia_clasificacion`, `sugerencia_detalle`, `sugerencia_fecha_ingreso`, `sugerencia_procedencia`, `sugerencia_analisis`, `sugerencia_viabilidad`, `sugerencia_tratamiento`, `sugerencia_observacion`, `sugerencia_fecha_observacion`, `sugerencia_fecha_cierre`, `sugerencia_estado`, `sugerencia_fecha_fin_prog`, `sugerencia_fecha_fin_real`, `proceso_id`, `sugerencia_evidencias`, `created_at`, `updated_at`) VALUES
	(3, 'MP', 'dsadsad dsadsadsad', '2026-02-05', 'fisico', 'dsadsadasd', 'viable', 'dsadsadasd', NULL, NULL, NULL, 'implementada', '2026-02-05', '2026-02-05', 6, NULL, '2026-02-05 22:56:48', '2026-02-05 23:02:21');
