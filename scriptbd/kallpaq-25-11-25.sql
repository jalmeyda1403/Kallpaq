...
REPLACE INTO `encuestas_satisfaccion` (`id`, `proceso_id`, `es_periodo`, `es_numero_periodo`, `es_anio`, `es_nps_score`, `es_score`, `es_cantidad`, `es_informe_path`, `created_at`, `updated_at`) VALUES
	(2, 238, 'Trimestral', 3, 2025, -36.20, 2.75, 58, '{"path":"satisfaccion\\/238\\/lLN3EsTCENFzXOq9b4LqdxE3TaVllHci5o7C3Wtp.pdf","name":"Informe Tecnico de Encuesta DJ 2025-III[F].pdf"}', '2025-11-25 22:10:42', '2025-11-25 22:36:14');
...
REPLACE INTO `encuesta_satisfaccion_detalles` (`id`, `encuesta_id`, `esd_categoria`, `esd_puntaje`, `created_at`, `updated_at`) VALUES
	(111, 2, 'Tiempo', 2.83, '2025-11-25 22:36:14', '2025-11-25 22:36:14'),
	(112, 2, 'Claridad', 2.81, '2025-11-25 22:36:14', '2025-11-25 22:36:14'),
	(113, 2, 'Accesibilidad', 2.64, '2025-11-25 22:36:14', '2025-11-25 22:36:14'),
	(114, 2, 'Relevancia', 2.64, '2025-11-25 22:36:14', '2025-11-25 22:36:14'),
	(115, 2, 'Calidad', 2.81, '2025-11-25 22:36:14', '2025-11-25 22:36:14');
...
-- Volcando datos para la tabla kallpaq.migrations: ~97 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `sugerencias` (
  ...
  `sugerencia_estado` varchar(255) NOT NULL DEFAULT 'abierta',
  `sugerencia_fecha_fin_prog` date DEFAULT NULL,
  `sugerencia_fecha_fin_real` date DEFAULT NULL,
  `proceso_id` bigint(20) unsigned NOT NULL,
  `sugerencia_evidencias` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`sugerencia_evidencias`)),
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
REPLACE INTO `sugerencias` (`id`, `sugerencia_clasificacion`, `sugerencia_detalle`, `sugerencia_fecha_ingreso`, `sugerencia_procedencia`, `sugerencia_analisis`, `sugerencia_viabilidad`, `sugerencia_tratamiento`, `sugerencia_estado`, `sugerencia_fecha_fin_prog`, `sugerencia_fecha_fin_real`, `proceso_id`, `sugerencia_evidencias`, `created_at`, `updated_at`) VALUES
	(1, 'MT', 'Se remitio la mejora', '2025-11-25', 'virtual', 'dsad', 'viable', 'dasdsadsad', 'en progreso', '2025-11-25', '2025-11-25', 2, NULL, '2025-11-25 16:43:35', '2025-11-25 16:58:58');
