...
CREATE TABLE IF NOT EXISTS `acciones` (
  ...
  `accion_descripcion` text DEFAULT NULL,
  `accion_comentario` text DEFAULT NULL,
  `accion_fecha_inicio` date DEFAULT NULL,
  `accion_fecha_fin_planificada` date DEFAULT NULL,
  ...
  CONSTRAINT `FK_acciones_hallazgos` FOREIGN KEY (`hallazgo_id`) REFERENCES `hallazgos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `hallazgos` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `hallazgo_cod` varchar(255) DEFAULT NULL,
  ...
  `hallazgo_descripcion` text DEFAULT NULL,
  `hallazgo_criterio` text DEFAULT NULL,
  `hallazgo_clasificacion` varchar(255) DEFAULT NULL,
  `hallazgo_origen` varchar(255) DEFAULT NULL,
  `hallazgo_tipo_cierre` varchar(255) DEFAULT NULL,
  `hallazgo_evidencia` text DEFAULT NULL,
  `hallazgo_avance` int(11) DEFAULT NULL,
  `hallazgo_estado` varchar(255) DEFAULT NULL,
  ...
  `hallazgo_sig` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`hallazgo_sig`)),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Volcando datos para la tabla kallpaq.hallazgos: ~1 rows (aproximadamente)
REPLACE INTO `hallazgos` (`id`, `created_at`, `updated_at`, `hallazgo_cod`, `informe_id`, `especialista_id`, `auditor_id`, `user_asigna_id`, `hallazgo_resumen`, `hallazgo_descripcion`, `hallazgo_criterio`, `hallazgo_clasificacion`, `hallazgo_origen`, `hallazgo_tipo_cierre`, `hallazgo_evidencia`, `hallazgo_avance`, `hallazgo_estado`, `hallazgo_fecha_identificacion`, `hallazgo_fecha_aprobacion`, `hallazgo_fecha_asignacion`, `hallazgo_fecha_conclusion`, `hallazgo_fecha_cierre`, `hallazgo_sig`) VALUES
	(9, '2024-06-27 16:07:16', '2024-06-27 16:25:44', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
-- Volcando datos para la tabla kallpaq.hallazgos_causas: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla kallpaq.migrations: ~72 rows (aproximadamente)
...
REPLACE INTO `requerimiento_evaluaciones` (`id`, `requerimiento_id`, `num_actividades`, `num_areas`, `num_requisitos`, `nivel_documentacion`, `impacto_requerimiento`, `complejidad_valor`, `complejidad_nivel`, `fecha_evaluacion`, `created_at`, `updated_at`) VALUES
	...
	(4, 16, 1, 1, 2, 3, 4, 11, 'media', '2025-11-10', '2025-11-07 19:10:05', '2025-11-10 17:46:06'),
