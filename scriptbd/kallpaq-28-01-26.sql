...
CREATE TABLE IF NOT EXISTS `acciones` (
  ...
  `obligacion_id` bigint(20) unsigned DEFAULT NULL,
  ...
  `es_control_permanente` tinyint(1) NOT NULL DEFAULT 0,
  ...
  KEY `acciones_obligacion_id_foreign` (`obligacion_id`),
  ...
  CONSTRAINT `acciones_obligacion_id_foreign` FOREIGN KEY (`obligacion_id`) REFERENCES `obligaciones` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Volcando datos para la tabla kallpaq.acciones: ~6 rows (aproximadamente)
REPLACE INTO `acciones` (`id`, `hallazgo_id`, `obligacion_id`, `hallazgo_proceso_id`, `accion_cod`, `accion_tipo`, `accion_descripcion`, `accion_fecha_inicio`, `accion_fecha_fin_planificada`, `accion_fecha_fin_reprogramada`, `accion_fecha_cancelada`, `accion_fecha_fin_real`, `accion_justificacion`, `accion_responsable`, `accion_responsable_correo`, `accion_estado`, `es_control_permanente`, `accion_ciclo`, `created_at`, `updated_at`) VALUES
	(1, 55, NULL, NULL, 'H-87920-001', 'corrección', 'Juan Almeyda', '2025-11-12', '2025-12-25', NULL, NULL, NULL, NULL, 'dasdsad', NULL, 'programada', 0, 1, '2025-11-12 21:45:26', '2026-01-19 06:54:22'),
	(3, 55, NULL, NULL, 'H-87920-002', 'acción correctiva', 'dsadsd', '2025-11-18', '2025-11-29', NULL, NULL, NULL, NULL, 'Juan Almeyda Requejo', NULL, 'programada', 0, 1, '2025-11-18 15:49:02', '2026-01-19 06:54:22'),
	(4, 55, NULL, NULL, 'H-87920-003', 'acción correctiva', 'Test Action Plan', '2025-11-21', '2025-11-22', NULL, NULL, NULL, NULL, 'Test User', NULL, 'programada', 0, 1, '2025-11-21 20:53:22', '2026-01-19 06:54:22'),
	(5, 55, NULL, NULL, 'H-87920-004', 'acción correctiva', 'dsadsad', '2025-11-21', '2025-11-29', NULL, NULL, NULL, NULL, 'dsadsad', NULL, 'programada', 0, 1, '2025-11-21 21:24:30', '2026-01-19 06:54:22'),
	(6, 55, NULL, NULL, 'H-87920-005', 'acción correctiva', 'Acción de prueba final', '2025-11-21', '2025-11-22', '2026-02-06', NULL, NULL, 'dsadsadasd prueba nueva', 'Usuario de Prueba', NULL, 'reprogramada', 0, 1, '2025-11-21 21:38:22', '2026-01-26 23:03:11'),
	(7, 56, NULL, 93, 'H-73160-001', 'corrección', 'ccsdd', '2026-01-26', '2026-02-26', NULL, NULL, NULL, NULL, 'dsadsad', 'dsdsad@dsadd.com', 'programada', 0, 3, '2026-01-26 15:53:06', '2026-01-26 15:53:06');
...
-- Volcando datos para la tabla kallpaq.accion_avances: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla kallpaq.accion_reprogramaciones: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla kallpaq.migrations: ~177 rows (aproximadamente)
