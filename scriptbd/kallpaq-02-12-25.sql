...
-- Volcando datos para la tabla kallpaq.migrations: ~109 rows (aproximadamente)
...
-- Volcando datos para la tabla kallpaq.riesgo_acciones: ~5 rows (aproximadamente)
...
-- Volcando datos para la tabla kallpaq.riesgo_revisions: ~3 rows (aproximadamente)
