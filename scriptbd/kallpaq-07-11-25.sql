...
CREATE TABLE IF NOT EXISTS `hallazgos` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `hallazgo_cod` varchar(18) NOT NULL,
...
-- Volcando datos para la tabla kallpaq.hallazgos_acciones: ~28 rows (aproximadamente)
...
-- Volcando datos para la tabla kallpaq.hallazgos_causas: ~8 rows (aproximadamente)
...
-- Volcando datos para la tabla kallpaq.migrations: ~67 rows (aproximadamente)
...
REPLACE INTO `requerimientos` (`id`, `proceso_id`, `user_asigna_id`, `facilitador_id`, `especialista_id`, `asunto`, `descripcion`, `justificacion`, `comentario`, `estado`, `prioridad`, `complejidad`, `ruta_archivo_desistimacion`, `ruta_archivo_requerimiento`, `fecha_limite`, `fecha_asignacion`, `fecha_inicio`, `fecha_fin`, `updated_at`, `created_at`) VALUES
	...
	(10, 252, 16, 1, NULL, 'Revisión y optimización del Proceso de Logística', 'Incluir el indicador "Porcentaje de satisfacción del usuario" en la Ficha de Proceso de MA-731, con su respectiva fórmula de cálculo.', 'Dar cumplimiento a la observación N° 005-2025 de la auditoría interna de la CGR.', NULL, 'creado', 'baja', 'baja', NULL, 'documentos/ejemplo_requerimiento.pdf', NULL, NULL, NULL, NULL, '2025-08-23 03:02:00', '2025-08-23 03:02:00'),
	...
	(16, 3, NULL, 1, NULL, 'sadasd', 'dsaddasdsad', 'dsadsadasddsaddsad', NULL, 'creado', NULL, 'baja', NULL, 'requerimientos/16/signed_requerimiento/d3arzg9lilvFjLI6kD0PQzQhlqmC6xDJBzGs8qCG.pdf', NULL, NULL, NULL, NULL, '2025-11-08 00:14:42', '2025-11-07 00:59:10');
...
-- Volcando datos para la tabla kallpaq.requerimiento_avances: ~4 rows (aproximadamente)
...
REPLACE INTO `requerimiento_evaluaciones` (`id`, `requerimiento_id`, `num_actividades`, `num_areas`, `num_requisitos`, `nivel_documentacion`, `impacto_requerimiento`, `complejidad_valor`, `complejidad_nivel`, `fecha_evaluacion`, `created_at`, `updated_at`) VALUES
	...
	(4, 16, 1, 1, 1, 1, 1, 5, 'baja', '2025-11-07', '2025-11-07 19:10:05', '2025-11-08 00:14:36');
...
-- Volcando datos para la tabla kallpaq.requerimiento_movimientos: ~45 rows (aproximadamente)
...
-- Volcando datos para la tabla kallpaq.users: ~101 rows (aproximadamente)
