...
-- Volcando datos para la tabla kallpaq.migrations: ~77 rows (aproximadamente)
...
-- Volcando estructura para tabla kallpaq.proceso_facilitador
CREATE TABLE IF NOT EXISTS `proceso_facilitador` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `proceso_facilitador_facilitador_id_foreign` FOREIGN KEY (`facilitador_id`) REFERENCES `facilitadores` (`id`) ON DELETE CASCADE,
  CONSTRAINT `proceso_facilitador_proceso_id_foreign` FOREIGN KEY (`proceso_id`) REFERENCES `procesos` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Volcando datos para la tabla kallpaq.proceso_facilitador: ~2 rows (aproximadamente)
REPLACE INTO `proceso_facilitador` (`id`, `facilitador_id`, `proceso_id`, `created_at`, `updated_at`) VALUES
	(5, 1, 3, NULL, NULL),
	(7, 1, 4, NULL, NULL);
