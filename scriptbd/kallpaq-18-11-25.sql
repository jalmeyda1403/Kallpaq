...
-- Volcando datos para la tabla kallpaq.acciones: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla kallpaq.inventario_procesos: ~4 rows (aproximadamente)
...
-- Volcando datos para la tabla kallpaq.migrations: ~81 rows (aproximadamente)
