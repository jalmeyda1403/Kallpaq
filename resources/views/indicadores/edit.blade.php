    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"> <a href="{{ route('indicadores.listar', $indicador->proceso_id) }}">Gestión de
                        Resultados</a></li>
                <li class="breadcrumb-item active" aria-current="page">Editar Indicador</li>
            </ol>
        </nav>
                        ...
                        <form method="POST" action="{{ route('indicadores.update', $indicador->id) }}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="hidden" name="proceso_id" id="proceso_id"
                                                value="{{ $indicador->proceso_id }}">
                                            <input type="text" class="form-control" id="proceso_nombre"
                                                name="proceso_nombre" value="{{ $indicador->proceso->nombre }}" required
                                                readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="3" class="form-control" id="producto" name="producto" required>{{ $indicador->producto }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="hidden" name="planificacion_sig_id" id="planificacion_sig_id"
                                                value="{{ $indicador->planificacion_sig_id }}">
                                            <input type="text" class="form-control" id="objetivo_nombre"
                                                name="objetivo_nombre" value="{{ $indicador->objetivo->nombre_objetivo }}"
                                                required readonly>
                                            <a href="#" class="btn btn-primary" data-toggle="modal"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="3" class="form-control" id="cliente" name="cliente" required>{{ $indicador->cliente }}</textarea>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <input type="hidden" class="form-control" id="indicador_id" name="indicador_id"
                                    value="{{ $indicador->id }}" required readonly>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="nombre" name="nombre" rows="3" required>{{ $indicador->nombre }}</textarea>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="tipo_indicador" name="tipo_indicador" required>
                                            @foreach ($tiposIndicador as $clave => $valor)
                                                <option value="{{ $clave }}"
                                                    {{ $indicador->tipo_indicador === $clave ? 'selected' : '' }}>
                                                    {{ $valor }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="sentido" name="sentido" required>
                                            @foreach ($sentido as $clave => $valor)
                                                <option value="{{ $clave }}"
                                                    {{ $indicador->sentido === $clave ? 'selected' : '' }}>
                                                    {{ $valor }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="descripcion" name="descripcion" rows="3" required>{{ $indicador->descripcion }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="tipo_agregacion" name="tipo_agregacion"
                                            ...
                                            @foreach ($tiposAgregacion as $clave => $valor)
                                                <option value="{{ $clave }}"
                                                    {{ $indicador->tipo_agregacion === $clave ? 'selected' : '' }}>
                                                    {{ $valor }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="parametro_medida" name="parametro_medida"
                                            ...
                                            @foreach ($parametroMedida as $clave => $valor)
                                                <option value="{{ $clave }}"
                                                    {{ $indicador->parametro_medida === $clave ? 'selected' : '' }}>
                                                    {{ $valor }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="formula" name="formula" rows="2" required readonly>{{ $indicador->formula }}  </textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="frecuencia" class="form-control" id="frecuencia">
                                            @foreach ($frecuencias as $clave => $valor)
                                                <option value="{{ $clave }}"
                                                    {{ $indicador->frecuencia === $clave ? 'selected' : '' }}>
                                                    {{ $valor }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" class="form-control" id="meta"
                                            name="meta" value ="{{ $indicador->meta }}" required>
                                    </div>
                                </div>
                            </div>
                            <!-- Resto de los campos -->
                            <input type="hidden" id="var1" name="var1"
                                value="{{ old('var1', $indicador->var1) }}">
                            <input type="hidden" id="var2" name="var2"
                                value="{{ old('var2', $indicador->var2) }}">
                            <input type="hidden" id="var3" name="var3"
                                value="{{ old('var3', $indicador->var3) }}">
                            <input type="hidden" id="var4" name="var4"
                                value="{{ old('var4', $indicador->var4) }}">
                            <input type="hidden" id="var5" name="var5"
                                value="{{ old('var5', $indicador->var5) }}">
                            <input type="hidden" id="var6" name="var6"
                                value="{{ old('var6', $indicador->var6) }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="var1_definition_modal"
                                            ...
                                            value="{{ old('var1_definition', $indicador->var1) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="var3_definition_modal"
                                            ...
                                            value="{{ old('var3_definition', $indicador->var3) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="var5_definition_modal"
                                            ...
                                            value="{{ old('var5_definition', $indicador->var5) }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="var2_definition_modal"
                                            ...
                                            value="{{ old('var2_definition', $indicador->var2) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="var4_definition_modal"
                                            ...
                                            value="{{ old('var4_definition', $indicador->var4) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="var6_definition_modal"
                                            ...
                                            value="{{ old('var6_definition', $indicador->var6) }}">
    ...
    <script>
        ...
        function displayObjetivos(filteredObjetivos) {
            ...
            filteredObjetivos.forEach(function(objetivo) {
                var html = '<div class="form-check">';
                html += '<input class="form-check-input" type="radio" name="id" data-id="' + objetivo.id + 
                '" data-nombre="' + objetivo.nombre_objetivo + '">';
