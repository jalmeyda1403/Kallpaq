                ...
                <div class="modal-body">
                    ...
                    <div class="form-group small">
                        ...
                        <div class="input-group date" data-target-input="nearest">
                            <input type="text" id="fecha_aprobacion" name= "fecha_aprobacion"
                                wire:model.defer="fecha_aprobacion" class="form-control" required>
                    ...
                    <div class="form-group small">
                        ...
                        <div class="input-group date" data-target-input="nearest">
                            <input type="text" id="fecha_vigencia2" name= "fecha_vigencia"
                                wire:model.defer="fecha_vigencia" class="form-control" required>
                            <div class="input-group-append" data-target="#fecha_vigencia"
                                data-toggle="datetimepicker">
                                <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                            </div>
                        </div>
...
@push('scripts')
    <script>
        ...
        $('#fecha_aprobacion').daterangepicker({
       ...
       $('#fecha_vigencia2').daterangepicker({
            singleDatePicker: true,
            autoApply: true,
            locale: {
                format: 'DD-MM-YYYY',
