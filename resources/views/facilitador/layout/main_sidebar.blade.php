            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                ...
                <li class="nav-item has-treeview {{ request()->is('smp*') ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('smp.index', ['clasificacion' => 'Ncm']) }}" class="nav-link {{ request()->segment(3) == 'Ncm' ? 'active' : '' }}">
                                <i class="nav-icon fas fa-times-circle"></i>
                                <p>No Conformidades</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('smp.index', ['clasificacion' => 'Obs']) }}" class="nav-link {{ request()->segment(3) == 'Obs' ? 'active' : '' }}">
                                <i class="nav-icon fas fa-exclamation-triangle"></i>
                                <p>Observaciones</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('smp.index', ['clasificacion' => 'Odm']) }}" class="nav-link {{ request()->segment(3) == 'Odm' ? 'active' : '' }}">
