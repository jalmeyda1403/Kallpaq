        ...
        <table class="header-table">
            <tr>
                <td style="width: 20%;">
                    ...
                    @else
                        <!-- Placeholder para el logo si no existe -->
                        [LOGO]
                    @endif
                </td>
        ...
        <div class="section">
            ...
            <table class="content-table">
                <tbody>
                    <tr>
                        <th>Proceso</th>
                        <td>{{ $requerimiento->proceso->proceso_nombre ?? 'N/A' }}
                            ({{ $requerimiento->proceso->cod_proceso ?? 'N/A' }})</td>
                    </tr>
                    <tr>
                ...
                <table class="content-table evaluation-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="background-color: #f8f9fa;">{{ $requerimiento->evaluacion->complejidad_valor }}
                            </td>
                        </tr>
                        <tr>
                            <th style="text-align: right;">NIVEL DE COMPLEJIDAD</th>
                            <td style="background-color: #f8f9fa; text-transform: uppercase;">
                                {{ $requerimiento->evaluacion->complejidad_nivel }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
