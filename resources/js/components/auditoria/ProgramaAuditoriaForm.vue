                ...
                <form @submit.prevent="savePrograma">
                    <div class="modal-body p-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" v-model="form.pa_fecha_aprobacion" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea v-model="form.pa_objetivo_general" class="form-control" rows="4" maxlength="1000"
...
onMounted(() => {
    if (modalRef.value) {
        modalRef.value.addEventListener('hidden.bs.modal', () => {
            ...
            // Force cleanup if Bootstrap fails to restore state
