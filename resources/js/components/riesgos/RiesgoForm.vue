                ...
                <div>
                    ...
                    <div class="header-container">
                        <h6 class="mb-0 d-flex align-items-center">
                            ...
                            <span class="text-dark">Información del Riesgo</span>
                        </h6>
                    </div>
                    <div class="text-left mb-4">
                        <h6 class="mb-1" style="font-weight: bold;">INFORMACIÓN DEL RIESGO</h6>
                    ...
                    <form @submit.prevent="saveRiesgo">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <h6 class="text-left"><b>1. Identificación del Riesgo</b></h6>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h6 class="text-left"><b>2. Evaluación y Tratamiento</b></h6>
                                </div>
                            </div>
...
const estrategias = ['reducir', 'aceptar', 'compartir', 'aprovechar'];
