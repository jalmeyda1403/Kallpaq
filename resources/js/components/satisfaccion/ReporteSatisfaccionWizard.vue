    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-light py-2 px-3 rounded mb-3">
                ...
                <li class="breadcrumb-item"><router-link :to="{ name: 'reportes-satisfaccion.index' }">Reportes de Satisfacción</router-link></li>
        ...
        <div class="card shadow-sm">
                ...
                <div class="animate__animated animate__fadeIn">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-4">
                            ...
                            <div class="stepper-item" :class="{ completed: currentStep > 1, active: currentStep === 1 }" @click="goToStep(1)">
                            ...
                            <!-- Step 2: Resultados -->
                            <div class="stepper-item" :class="{ completed: currentStep > 2, active: currentStep === 2 }" @click="goToStep(2)">
                                <div class="step-counter">
                            ...
                            <!-- Step 3: Conclusiones -->
                            <div class="stepper-item" :class="{ completed: currentStep > 3, active: currentStep === 3 }" @click="goToStep(3)">
                                <div class="step-counter">
                            ...
                            <!-- Step 4: Finalización -->
                            <div class="stepper-item" :class="{ completed: currentStep > 4, active: currentStep === 4 }" @click="goToStep(4)">
                                <div class="step-counter">
                        ...
                        <div class="col-md-9">
                            <div class="card card-primary card-outline shadow-sm border-0">
                                <div class="card-body">
                                    ...
                                    <div v-if="isReadonly" class="alert alert-warning border-warning shadow-sm mb-4">
                                        ...
                                        <strong>Modo Solo Lectura:</strong> Este reporte ya está firmado y no puede ser modificado.
                                    </div>
                            ...
                            <div v-if="currentStep === 1" class="step-content animate__animated animate__fadeIn">
                                <div class="step-header mb-4 pb-2 border-bottom">
                                    <h4 class="text-dark"><i class="fas fa-cog text-primary mr-2"></i> Configuración del Reporte</h4>
                                    <p class="text-muted small">Seleccione el periodo y el proceso para el cual desea generar el reporte.</p>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select v-model="form.anio" class="form-control" :disabled="isReadonly">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select v-model="form.trimestre" class="form-control" :disabled="isReadonly">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" :value="procesoNombre" readonly :disabled="isReadonly" placeholder="Seleccione un proceso..." style="background-color: white;">
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-primary" type="button" @click="openProcesoModal" :disabled="isReadonly">
                                                <i class="fas fa-search"></i> Buscar
                                            </button>
                                        </div>
                                    </div>
                                    <small class="text-muted">Utilice el botón de búsqueda para seleccionar el proceso.</small>
                                </div>

                                <div class="text-right mt-4">
                                    <button class="btn btn-primary px-4 shadow-sm" @click="fetchDataAndNext" :disabled="!form.proceso_id || isReadonly">
                            ...
                            <div v-if="currentStep === 2" class="step-content animate__animated animate__fadeIn">
                                <div class="step-header mb-4 pb-2 border-bottom d-flex justify-content-between align-items-center">
                                    <div>
                                        <h4 class="text-dark mb-1"><i class="fas fa-chart-bar text-primary mr-2"></i> Resultados del Trimestre</h4>
                                        <p class="text-muted small mb-0">Revise los datos consolidados del periodo: <strong>{{ periodoTexto }}</strong></p>
                                    </div>
                                    <button @click="refreshQuarterData" class="btn btn-primary btn-sm shadow" :disabled="loading || isReadonly">
                                ...
                                <div class="card mb-3 border-light shadow-sm">
                                    <div class="card-header bg-light"><strong>2.1 Encuestas de Satisfacción</strong></div>
                                    <div class="card-body p-2">
                                        <textarea v-model="form.resumen_encuestas" class="form-control" rows="5" placeholder="Resumen de encuestas..." :disabled="isReadonly"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="card mb-3 border-light shadow-sm">
                                    ...
                                    <div class="card-body p-2">
                                        <textarea v-model="form.resumen_sugerencias" class="form-control" rows="5" placeholder="Resumen de sugerencias..." :disabled="isReadonly"></textarea>
                                    </div>
                                </div>

                                <div class="card mb-3 border-warning shadow-sm" style="border-left: 4px solid #ffc107;">
                                    <div class="card-header bg-white"><strong>2.3 Reclamos (Ingreso Manual)</strong></div>
                                    <div class="card-body p-2">
                                        <textarea v-model="form.reclamos" class="form-control" rows="5" placeholder="Reclamos reportados..." :disabled="isReadonly"></textarea>
                                    </div>
                                </div>

                                <div class="card mb-3 border-light shadow-sm">
                                    <div class="card-header bg-light"><strong>2.4 Salidas No Conformes (SNC)</strong></div>
                                    <div class="card-body p-2">
                                        <textarea v-model="form.resumen_snc" class="form-control" rows="5" placeholder="Resumen de SNCs..." :disabled="isReadonly"></textarea>
                                    </div>
                                </div>
                            ...
                            <div v-if="currentStep === 3" class="step-content animate__animated animate__fadeIn">
                                <div class="step-header mb-4 pb-2 border-bottom d-flex justify-content-between align-items-center">
                                    <div>
                                        <h4 class="text-dark mb-1"><i class="fas fa-lightbulb text-warning mr-2"></i> Conclusiones</h4>
                                        <p class="text-muted small mb-0">Genere oportunidades de mejora y conclusiones utilizando IA.</p>
                                    </div>
                                    <button @click="generateAIAnalysis" class="btn btn-purple btn-sm shadow" :disabled="generatingAI || isReadonly">
                                        <i class="fas fa-magic mr-1"></i> 
                                        {{ generatingAI ? 'Generando...' : 'Generar con IA' }}
                                        <span v-if="generatingAI" class="spinner-border spinner-border-sm ml-1"></span>
                                    </button>
                                </div>

                                <div class="form-group">
                                    <label class="font-weight-bold text-primary">III. Oportunidades de Mejora Identificadas</label>
                                    <textarea v-model="form.oportunidades_mejora" class="form-control" rows="10" placeholder="Escriba las oportunidades de mejora..." :disabled="isReadonly"></textarea>
                                    <small class="text-muted">Use guiones (-) para listas y saltos de línea para separar párrafos</small>
                                </div>

                                <div class="form-group">
                                    <label class="font-weight-bold text-primary">IV. Conclusiones</label>
                                    <textarea v-model="form.conclusiones" class="form-control" rows="10" placeholder="Escriba las conclusiones..." :disabled="isReadonly"></textarea>
                            ...
                            <!-- PASO 4: Confirmación -->
                            <div v-if="currentStep === 4" class="step-content animate__animated animate__fadeIn">
                                <div class="step-header mb-4 pb-2 border-bottom">
                                    <h4 class="text-dark"><i class="fas fa-check-circle text-success mr-2"></i> Finalización</h4>
                                    <p class="text-muted small">Revise la información y genere el reporte oficial.</p>
                                </div>

                                <div class="alert alert-light border shadow-sm">
                                    <h5><i class="fas fa-info-circle text-info mr-2"></i> Resumen del Reporte</h5>
                                    <ul class="mt-2 mb-0">
                                        <li><strong>Proceso:</strong> {{ procesoNombre }}</li>
                                        <li><strong>Periodo:</strong> {{ form.anio }} - Trimestre {{ form.trimestre }}</li>
                                        <li><strong>Encuestas:</strong> {{ form.resumen_encuestas ? 'Registradas' : 'Sin datos' }}</li>
                                        <li><strong>Análisis IA:</strong> {{ form.oportunidades_mejora ? 'Generado' : 'Pendiente' }}</li>
                                    </ul>
                                </div>

                                <div class="text-center py-4">
                                    <button 
                                        v-if="!isReadonly && !reporteSaved" 
                                        @click="saveDraft" 
                                ...
                                <div class="d-flex justify-content-between mt-4 border-top pt-3">
                                    ...
                                    <router-link :to="{ name: 'reportes-satisfaccion.index' }" class="btn btn-outline-secondary">
            ...
            <ModalHijo ref="procesoModal" :fetch-url="procesoFetchUrl" target-id="proceso_id" target-desc="proceso_nombre" @update-target="handleProcesoSeleccionado" />
        </div> <!-- /card -->
    </div> <!-- /container-fluid -->
</template>
...
const downloadWord = async () => {
    ...
    try {
        const response = await fetch(`/api/reportes-satisfaccion/${form.value.id}/download`, {
            method: 'GET',
            headers: {
